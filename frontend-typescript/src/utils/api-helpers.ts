 ...
 * 1. Wait for Firebase Auth to initialize (if not ready)
 * 2. Try to get Firebase ID token (async)
 * 3. If available, send as Authorization: Bearer token
 ...
 * 
 * - First call initializes auth (if not already)
