/**
 * AI Landing Components Stories
 *
 * Visual examples of AI-powered landing page components.
 * These components demonstrate Ferni's "Better than Human" capabilities.
 *
 * @module stories/components/AILanding
 */
...
export const LiveChatWidget: StoryObj = {
...
export const PersonaPreviewCards: StoryObj = {
  ...
  render: () => {
    const personas = {
      ferni: { name: 'Ferni', role: 'Life Coach', color: '#4a6741', traits: ['warm', 'curious', 'insightful'] },
      maya: { name: 'Maya Santos', role: 'Habits Expert', color: '#a67a6a', traits: ['practical', 'patient', 'systematic'] },
      peter: { name: 'Peter John', role: 'Research & Deep Dives', color: '#3a6b73', traits: ['thorough', 'curious', 'analytical'] },
    };
...
export const SmartFAQ: StoryObj = {
  name: 'Smart FAQ',
  parameters: {
    docs: {
      description: {
...
export const MemoryVisualization: StoryObj = {
...
export const VoiceSamples: StoryObj = {
  name: 'Voice Samples',
  parameters: {
    docs: {
      description: {
  ...
  render: () => {
    const samples = [
      { id: 'stress', persona: 'Ferni', color: '#4a6741', question: "I'm feeling really overwhelmed lately", duration: '11s' },
      { id: 'habits', persona: 'Maya', color: '#a67a6a', question: "How do I actually stick to a habit?", duration: '13s' },
      { id: 'decision', persona: 'Peter', color: '#3a6b73', question: "I have a big decision to make", duration: '13s' },
    ];
...
export const HoverPreview: StoryObj = {
  name: 'Hover Preview',
  parameters: {
    docs: {
      description: {
  ...
  render: () => {
    const contexts = [
      { type: 'FAQ', preview: "I'd love to explain this more..." },
      { type: 'Feature', preview: "Let me show you how this works..." },
      { type: 'Testimonial', preview: "Stories like this make me smile..." },
      { type: 'CTA', preview: "No pressure. Just try talking." },
    ];
...
export const SocialProofDynamic: StoryObj = {
  name: 'Social Proof',
  parameters: {
    docs: {
      description: {
  ...
  render: () => {
    const snippets = [
      { type: 'moment', content: "This morning, I reminded someone about a breakthrough they had 4 months ago. They'd forgotten. I hadn't." },
      { type: 'insight', content: 'Someone said "I\'m fine" three times this week. So I gently asked what was really going on. Turns out, a lot.' },
      { type: 'conversation', content: "Someone called at 3am about a decision they couldn't stop thinking about. We worked through it together until the sun came up." },
    ];
...
export const MicroExpressions: StoryObj = {
  ...
  render: () => {
    const expressions = [
      { name: 'Curious', trigger: 'CTA hover', color: '#5a8060', duration: '120ms' },
      { name: 'Interested', trigger: 'Pricing section viewed', color: '#6a9070', duration: '100ms' },
      { name: 'Helpful', trigger: 'FAQ interaction', color: '#5a7751', duration: '150ms' },
      { name: 'Concerned', trigger: 'Fast scrolling', color: '#5a7050', duration: '200ms' },
      { name: 'Warm', trigger: 'Slow reading', color: '#7aa080', duration: '180ms' },
    ];
