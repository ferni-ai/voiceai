const c={connection:`<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,server:`<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,permission:`<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,offline:`<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`},W=e=>{const s=document.createElement("div"),T=c[e.type]||c.connection;return s.innerHTML=`
    ...
    ">
      <div class="illustration" style="
        ...
        ${e.isRecovering?"animation: recoveringPulse 2s ease-in-out infinite;":""}
      ">
        ${T}
      </div>
  ...
  `,s},E={title:"Patterns/Error States",tags:["autodocs"],render:e=>W(e),parameters:{layout:"centered",docs:{description:{component:"Error states that stay warm and helpful. Never blame the user, always provide a path forward."}}}},r={args:{type:"connection",severity:"warning",headline:"Taking a breath.",body:"We lost connection for a moment. Trying to reconnect now...",isRecovering:!0}},t={args:{type:"connection",severity:"error",headline:"We couldn't reconnect.",body:"Something's getting in the way. Check your internet connection and try again.",primaryAction:"Try Again",secondaryAction:"Check Status"}},o={args:{type:"api",severity:"info",headline:"We're taking a moment.",body:"Our servers are catching their breath. This usually resolves quickly.",primaryAction:"Refresh"}},a={args:{type:"api",severity:"error",headline:"Something unexpected happened.",body:"We hit a bump, but we're looking into it. Your data is safe.",primaryAction:"Try Again",secondaryAction:"Contact Support",errorCode:"ERR-500-UNKNOWN"}},n={args:{type:"permission",severity:"warning",headline:"We can't hear you.",body:"Microphone access was denied. You can change this in your browser settings.",primaryAction:"Open Settings",secondaryAction:"Type instead"}},i={args:{type:"offline",severity:"info",headline:"You're offline.",body:"We'll save your progress and sync when you're back."}};var l,d,y;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    type: 'connection',
    severity: 'warning',
...
}`,...(y=(d=r.parameters)==null?void 0:d.docs)==null?void 0:y.source}}};var p,m,h;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    type: 'connection',
    severity: 'error',
...
}`,...(h=(m=t.parameters)==null?void 0:m.docs)==null?void 0:h.source}}};var g,u,v;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    type: 'api',
    severity: 'info',
...
}`,...(v=(u=o.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};var f,x,w;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    type: 'api',
    severity: 'error',
...
}`,...(w=(x=a.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var b,k,A;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    type: 'permission',
    severity: 'warning',
...
}`,...(A=(k=n.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var S,C,R;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    type: 'offline',
    severity: 'info',
...
}`,...(R=(C=i.parameters)==null?void 0:C.docs)==null?void 0:R.source}}};const O=["ConnectionLost","ConnectionFailed","ServerDown","GenericError","PermissionDenied","Offline"];export{t as ConnectionFailed,r as ConnectionLost,a as GenericError,i as Offline,n as PermissionDenied,o as ServerDown,O as __namedExportsOrder,E as default};
