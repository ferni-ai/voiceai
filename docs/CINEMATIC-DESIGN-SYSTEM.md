...
| File | Changes |
|------|---------|
| `frontend-typescript/public/design-system/cinematic.css` | **NEW** - Complete cinematic utilities + Ferni brand variants |
| `frontend-typescript/public/design-system/tokens.css` | Added hero typography tokens |
