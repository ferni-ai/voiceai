...
| File | Purpose |
|------|---------|
| `/brand/FERNI-SCREEN-GUIDELINES.md` | Complete design system (typography, colors, spacing) |
| `/brand/FERNI-BRAND-GUIDELINES.md` | Brand voice, values, personality |
...
| Asset | Path |
|-------|------|
| Brand Guidelines | `/brand/FERNI-SCREEN-GUIDELINES.md` |
