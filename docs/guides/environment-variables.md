...
### Google Calendar ⭐ CRITICAL for Smart Timing

Required for: Calendar integration, smart outreach timing, appointment scheduling
...
| `GOOGLE_CALENDAR_REDIRECT_URI`  | ⚠️       | OAuth callback URL (defaults to correct value) |
...
See [GOOGLE-CALENDAR-SETUP.md](./GOOGLE-CALENDAR-SETUP.md) for detailed setup guide.

**Service Account (for shared/team calendars - optional):**
...
- [ ] `GOOGLE_CALENDAR_CLIENT_ID`, `GOOGLE_CALENDAR_CLIENT_SECRET` (smart timing)
- [ ] `REDIS_URL` (caching)
