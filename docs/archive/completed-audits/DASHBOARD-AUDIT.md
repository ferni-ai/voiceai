...
> **Last Updated:** December 13, 2024 (verified in comprehensive doc audit)
...
- **Brand Guidelines:** `design-system/design-system/docs/brand/FERNI-BRAND-GUIDELINES.md`
- **Screen Guidelines:** `design-system/design-system/docs/brand/FERNI-SCREEN-GUIDELINES.md`
