...
| **Run CLI commands** | [SCRIPTS.md](../SCRIPTS.md) |
...
| Doc | Description |
|-----|-------------|
| [CLEAN-ARCHITECTURE.md](./architecture/CLEAN-ARCHITECTURE.md) | Core system architecture |
| [AGENT-AGNOSTIC-ARCHITECTURE.md](./architecture/AGENT-AGNOSTIC-ARCHITECTURE.md) | Tool and persona patterns |
...
| [frontend-typescript/CLAUDE.md](../frontend-typescript/CLAUDE.md) | Frontend standards |
...
| [brand/FERNI-BRAND-GUIDELINES.md](../brand/FERNI-BRAND-GUIDELINES.md) | Brand guidelines |
| [brand/FERNI-SCREEN-GUIDELINES.md](../brand/FERNI-SCREEN-GUIDELINES.md) | Screen design |
