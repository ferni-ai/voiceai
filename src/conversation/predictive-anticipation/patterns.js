...
// ============================================================================
export const VOICE_STATE_ACKNOWLEDGMENTS = {
...
export const NEED_GUIDANCE = {
    venting: "They need to be heard, not fixed. Listen actively. Use short acknowledgments. Don't offer solutions unless asked.",
    advice: 'They want practical input. After validating, offer concrete suggestions. Ask clarifying questions if needed.',
    validation: 'They need to know their feelings are okay. Normalize their experience. "Of course you feel that way."',
    distraction: "They want to think about something else. Offer to change topics. Don't force them to stay on hard subjects.",
    silence: 'Less is more. Be present without filling space. Short, warm acknowledgments only.',
    energy: "Match their energy! Be enthusiastic. Celebrate with them. Don't dampen their excitement.",
    grounding: "Help them feel stable. Slow your pace. Ask concrete questions. Focus on what's certain.",
