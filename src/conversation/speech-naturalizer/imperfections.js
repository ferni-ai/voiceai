 ...
 */
import { createSeededRandom, createSystemRandom } from '../utils/rng.js';
 ...
 */
export function generateFragment(context) {
    const fragments = {
        trailing: [
            "It's just that...",
            'The thing is...',
 ...
 */
export const MID_THOUGHT_CORRECTIONS = [
 ...
 */
export function generateCourseCorrection(originalThought, correctedThought) {
 ...
 */
export const DOUBT_TO_CONVICTION = [
 ...
 */
export function generateDoubtToConviction(statement) {
 ...
 */
export function generateThinkingOutLoud() {
 ...
 */
export const GRACEFUL_UNCERTAINTY = [
 ...
 */
export function generateGracefulUncertainty(statement) {
 ...
 */
export const SELF_INTERRUPTIONS = [
 ...
 */
export function generateSelfInterruption(statement) {
 ...
 */
export function applyRandomImperfection(text, context) {
    if (!shouldApplyImperfection(context))
        return text;
...
//# sourceMappingURL=imperfections.js.map