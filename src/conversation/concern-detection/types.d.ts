...
export type ConcernType = 'anxiety' | 'sadness' | 'overwhelm' | 'frustration' | 'loneliness' | 'fear' | 'exhaustion' | 'self_doubt' | 'hopelessness' | 'crisis';
...
export type ConcernApproach = 'normal' | 'gentle_presence' | 'validate_first' | 'slow_down' | 'check_in' | 'hold_space' | 'safety_check';
...
export declare const DEFAULT_USER_BASELINE: UserBaseline;
