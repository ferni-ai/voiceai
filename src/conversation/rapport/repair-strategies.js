...
const STRATEGY_CONFIGS = {
    validate_feeling: {
        ...
        priority: 90,
        contextInjection: 'The user may be feeling unheard or disconnected. Lead your next response with validation of their feelings or perspective. Use phrases like "I can see why..." or "That makes sense..." before anything else.',
    ...
    slow_down: {
        ...
        contextInjection: 'Slow down your response pace. Take time to breathe and pause. The user may need more space to process. Keep responses shorter.',
    ...
    check_in: {
        ...
        priority: 70,
        contextInjection: 'Consider gently checking in with the user. You might ask "How are you feeling about this?" or "Is this making sense?" Show genuine curiosity about their state.',
    ...
    give_space: {
        ...
        contextInjection: 'The user may need more space to talk. Keep your responses brief and end with open questions that invite them to share more. Avoid long explanations.',
    ...
    show_interest: {
        ...
        priority: 60,
        contextInjection: 'Show active interest in what the user is saying. Ask follow-up questions, reference specific things they mentioned, and express genuine curiosity about their experiences.',
 ...
 */
export function selectRepairStrategy(score, repairState) {
    const now = Date.now();
    ...
    for (const [type, config] of Object.entries(STRATEGY_CONFIGS)) {
        ...
        // Check decline rate
        if (conditions.minDeclineRate !== undefined &&
 ...
 */
export function getStrategyTtsAdjustments(type) {
    if (type === 'none')
        return undefined;
 ...
 */
export function getStrategyContextInjection(type) {
    if (type === 'none')
        return undefined;
    return STRATEGY_CONFIGS[type]?.contextInjection;
}
//# sourceMappingURL=repair-strategies.js.map