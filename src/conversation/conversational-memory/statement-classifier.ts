...
import type { ConversationCommitment, RecordMessageContext, UserStatement } from './types.js';
...
export class StatementClassifier {
   ...
   */
  assessImportance(text: string, context: { wasPersonal?: boolean; emotion?: string }): number {
