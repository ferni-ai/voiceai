...
class ThinkingPhraseCoordinator {
     ...
     */
    wasPhrasedUsed(sessionId, turnNumber) {
     ...
     */
    getTurnState(sessionId, turnNumber) {
        const key = `${sessionId}:${turnNumber}`;
...
// ============================================================================
let instance = null;
export function getThinkingPhraseCoordinator() {
    if (!instance) {
        instance = new ThinkingPhraseCoordinator();
    }
    return instance;
}
export function resetThinkingPhraseCoordinator() {
    if (instance) {
        instance.destroy();
        instance = null;
    }
 ...
 */
export function requestThinkingPhrase(sessionId, turnNumber, source, personaId, context) {
