...
import { classifyTopicWeight, detectAdviceGiving as sharedDetectAdviceGiving, detectEmotionalContent as sharedDetectEmotionalContent, } from '../utils/detection.js';
// Sub-modules
import { getSelfCorrectionEngine, resetSelfCorrectionEngine, } from './self-correction.js';
import { getDisfluencyEngine, resetDisfluencyEngine, } from './disfluency-injection.js';
import { getPhoneticMirroringEngine, resetPhoneticMirroringEngine, } from './phonetic-mirroring.js';
import { getCatchingYourselfEngine, resetCatchingYourselfEngine, } from './catching-yourself.js';
// Phase 2: Session Dynamics
import { getVocalFatigueEngine, resetVocalFatigueEngine, } from './vocal-fatigue.js';
import { getSessionDynamicsEngine, resetSessionDynamicsEngine, } from './session-dynamics.js';
import { getComfortProgressionEngine, resetComfortProgressionEngine, } from './comfort-progression.js';
// Phase 3: Advanced Listening
import { getVoicePrintEngine, resetVoicePrintEngine, } from './voice-print.js';
import { getAmbientAwarenessEngine, resetAmbientAwarenessEngine, } from './ambient-awareness.js';
// Phase 4: Emotional Leadership
import { getEmotionalLeadingEngine, resetEmotionalLeadingEngine, } from './emotional-leading.js';
import { getBreathingSyncEngine, resetBreathingSyncEngine, } from './breathing-sync.js';
...
import { resetVoicePatternEngine } from './voice-pattern-learning.js';
...
export { getActiveRapportScorerCount, getAvailableStrategies, getRapportScorer, getStrategyContextInjection, getStrategyTtsAdjustments, RAPPORT_CONFIG, RapportScorer, rapportScorer, resetRapportScorer, selectRepairStrategy, } from '../rapport/index.js';
// Voice pattern learning - cross-session preference learning
export { getActiveVoicePatternEngineCount, getCurrentTimeOfDay, getRecommendedAgentWpm, getRecommendedTurnGap, getVoicePatternEngine, getVoicePatterns, initializeVoicePatterns, loadVoicePatterns, persistVoicePatterns, recordVoiceObservation, resetVoicePatternEngine, saveVoicePatterns, voicePatternLearning, VOICE_PATTERN_CONFIG, } from './voice-pattern-learning.js';
// Prosody bridge - connects voice agent audio to humanization
export { cleanupProsodyBridge, getBridgeState, getCrossSessionInsight, getVoiceStateInsight, inferAmbientFromProsody, initProsodyBridge, processProsodyForHumanization, prosodyToBreathPattern, prosodyToVoiceSnapshot, } from './prosody-bridge.js';
// Persistence - save/load humanization state
export { clearHumanizationData, initializeFromPersistence, loadAllHumanizationData, loadComfortState, loadCrossSessionMemory, loadVoicePrint, persistOnSessionEnd, saveAllHumanizationData, saveComfortState, saveCrossSessionMemory, saveVoicePrint, } from './persistence.js';
// Analytics - track humanization performance
export { getHumanizationAnalytics, humanizationAnalytics, resetHumanizationAnalytics, } from './analytics.js';
// Configuration - tunable thresholds and probabilities
export { CONSERVATIVE_CONFIG, DEFAULT_HUMANIZATION_CONFIG, EXPRESSIVE_CONFIG, MINIMAL_CONFIG, getHumanizationConfig, humanizationConfig, resetHumanizationConfig, } from './config.js';
// Voice agent integration - import specific exports to avoid conflicts
export { applyBreathingSync, createVoiceSnapshot, detectVoiceState, getAmbientAcknowledgment, getAmbientContext, getBreathingSyncAdjustments, getConversationPhase, getCrossSessionAcknowledgment, getEmotionalLeadingGuidance, getEngineStates, getPhaseBehavior, getSessionState, humanizeResponse, isBehaviorUnlocked, markCrossSessionAcknowledged, onSessionEnd, onSessionStart, processUserMessage, recordComfortEvent, simulateBreathFromEmotion, } from './voice-agent-integration.js';
...
export class HumanizationOrchestrator {
    ...
    engines;
    config;
    sessionHumanizationCount = 0;
    currentTurn = 0;
    constructor(sessionId, config = {}, userId) {
    ...
    humanize(response, context) {
        ...
        // ========================================================================
        const { text: mirroredText, appliedMirrorings } = this.engines.phoneticMirroring.mirror(result.text);
            ...
            if (shouldTry) {
                ...
                if (selfCorrection) {
                    ...
                    result.skippedFeatures.push({
                        ...
                        reason: this.engines.selfCorrection.getState().usageCount >= 4
                            ? 'Max per session'
                            : 'Did not trigger',
                    });
        ...
        if (appliedThisResponse < this.config.maxPerResponse &&
            ...
            if (shouldTry) {
                ...
                this.engines.catchingYourself.recordAgentResponse(fullContext.responseWordCount, context.recentTopics);
     ...
     */
    recordComfortEvent(event, turnCount) {
     ...
     */
    isBehaviorUnlocked(behaviorName) {
     ...
     */
    getEmotionalLeadingDecision(userState, userMessage) {
        return this.engines.emotionalLeading.decideLeading({ ...userState, negativeSpiralIndicators: 0 }, userMessage, {
 ...
 */
export function getHumanizationOrchestrator(sessionId, config, userId) {
 ...
 */
export function resetHumanization(sessionId, userId) {
 ...
 */
export function resetAllHumanization() {
