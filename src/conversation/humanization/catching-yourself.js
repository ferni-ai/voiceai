...
const CATCHING_YOURSELF_TRIGGERS = [
    ...
    },
    {
        ...
        shouldTrigger: (_state, context) => {
            ...
            return ((context.relationshipStage === 'friend' ||
    ...
    },
    {
        ...
        shouldTrigger: (_state, context) => {
            ...
            const responseHasExcitement = context.responseText.includes('!') ||
...
export class CatchingYourselfEngine {
     ...
     */
    recordAgentResponse(wordCount, topics) {
...
export function getCatchingYourselfEngine(sessionId) {
    if (!engines.has(sessionId)) {
        engines.set(sessionId, new CatchingYourselfEngine());
    }
    return engines.get(sessionId);
}
export function resetCatchingYourselfEngine(sessionId) {
...
export function resetAllCatchingYourselfEngines() {
    engines.clear();
}
export default CatchingYourselfEngine;
//# sourceMappingURL=catching-yourself.js.map