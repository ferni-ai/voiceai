 ...
 */
export type DelightType = 'appreciation' | 'gratitude' | 'noticing_growth' | 'connection' | 'admiration' | 'joy';
...
export interface SelfCriticismDetection {
    ...
    type?: 'harsh_judgment' | 'catastrophizing' | 'minimizing_success' | 'comparing_to_others' | 'perfectionism' | 'imposter_syndrome';
...
export interface ProtectiveResponse {
    ...
    /** Intervention type */
    interventionType?: 'gentle_pushback' | 'reframe' | 'perspective_shift' | 'validation_first' | 'direct_challenge';
    /** Phrase to use */
    phrase?: string;
    /** Placement */
...
export interface TeamHandoffNote {
    ...
    timestamp: Date;
    /** Type of note */
    type: 'observation' | 'impression' | 'concern' | 'compliment' | 'context' | 'warning' | 'suggestion';
    /** The note content */
    content: string;
...
export interface TemporalInsight {
    ...
    shouldMention: boolean;
    /** Type of observation */
    type?: 'energy_comparison' | 'mood_shift' | 'growth_observation' | 'concern_pattern' | 'openness_comparison' | 'openness_growth';
    /** Phrase */
    phrase?: string;
}
/**
...
export interface RelationshipMilestone {
    ...
    date: Date;
    /** Type of milestone */
    type: 'first_vulnerability' | 'first_laugh' | 'trust_breakthrough' | 'session_milestone' | 'topic_depth' | 'emotional_support';
    /** Description */
    description: string;
}
...
export interface MetaRelationshipResult {
    ...
    /** Type of comment */
    type?: 'trust_observation' | 'growth_together' | 'relationship_naming' | 'milestone_acknowledgment';
    /** Phrase */
    phrase?: string;
}
/**
 ...
 */
export type SomaticCueType = 'settling_in' | 'processing_heavy' | 'relief' | 'focus' | 'breath_sync' | 'energy_shift' | 'comfort_offer';
 ...
 */
export type ObservationType = 'linguistic_pattern' | 'behavioral_pattern' | 'emotional_pattern' | 'relationship_pattern' | 'timing_pattern' | 'avoidance_pattern';
