 ...
 */
export function getSpeechModification(config, context) {
 ...
 */
function getPatternPool(type, style) {
    const pools = {
        filler: FILLERS,
        hedge: HEDGES,
 ...
 */
export function addNaturalSpeech(response, config, context = {}) {
 ...
 */
export function generateThinkingMoment(style = 'warm') {
 ...
 */
export function generateSelfCorrection(style = 'warm') {
 ...
 */
export function formatNaturalSpeechGuidance(style = 'warm') {
    return [
...
//# sourceMappingURL=natural-speech.js.map