...
export { captureQuote, extractQuote, findRelevantQuote, formatQuoteForPrompt, markQuoteSurfaced, saveQuote, } from './quote-memory.js';
// Relationship Milestones - Anniversary tracking
export { acknowledgeMilestone, checkMilestones, formatMilestoneForPrompt, getStats, recordBreakthrough, recordConversation, recordGoalAchieved, recordLaugh, } from './relationship-milestones.js';
// Micro-celebrations - Real-time wins
export { detectMicroWin, formatMicroWinForPrompt } from './micro-celebrations.js';
// Natural Speech - Fillers, self-corrections
export { addNaturalSpeech, formatNaturalSpeechGuidance, generateSelfCorrection, generateThinkingMoment, getSpeechModification, } from './natural-speech.js';
// Inside Jokes - Shared humor
export { captureJoke, findRelevantJoke, formatJokeForPrompt, markJokeReferenced, } from './inside-jokes.js';
// Nicknames - Personal touch
export { addNickname, extractNameFromMessage, formatNamingGuidance, getUserNaming, recordNameUsage, setUserName, shouldUseName, updateEndearmentLevel, } from './nicknames.js';
// Story Continuity - People in their life
export { addPersonDetail, extractPerson, findPeopleToAskAbout, formatFollowUpForPrompt, getOrCreatePerson, updateStoryline, } from './story-continuity.js';
...
export { analyzeVulnerabilityDepth, clearVulnerabilityStates, formatVulnerabilityGuidance, getVulnerabilityState, getVulnerabilityStates, recordShareAndMatch, resetSessionVulnerability, } from './vulnerability-matching.js';
// Empathetic Reflections - Structured empathy (now LLM-powered!)
export { clearReflectionStates, formatReflectionGuidance, generateReflection, generateReflectionAsync, } from './empathetic-reflections.js';
// Presence Mode - "Just be here"
export { analyzePresenceNeed, formatPresenceGuidance, getPresencePhrase, shouldAvoidAdvice, } from './presence-mode.js';
// Shared Language - "Our words"
export { addSharedTerm, clearSharedLanguage, extractSharedLanguage, findRelevantTerm, formatSharedLanguageGuidance, getLanguageStates, getSharedTerms, } from './shared-language.js';
// Conversational Rituals - "Our thing"
export { clearRitualStates, createCustomRitual, formatRitualGuidance, getEstablishedRituals, recordRitualPerformed, suggestRitual, } from './conversational-rituals.js';
// Emotional Forecasting - "Tomorrow might be tough"
export { formatForecastGuidance, generateForecast, getForecastAcknowledgment, shouldMentionForecast, } from './emotional-forecasting.js';
// Gentle Challenges - "I love you, and..."
export { detectChallengeOpportunity, formatChallengeGuidance, getSoftChallenge, isGoodTimeToChallenge, } from './gentle-challenges.js';
// Meta-Moments - "This is nice"
export { clearMetaMomentStates, findMetaMoment, formatMetaMomentGuidance, getQuickObservation, } from './meta-moments.js';
// ===========================================================================
 ...
 */
export function clearAllSuperhumanEngines(userId, sessionId) {
 ...
 */
export function clearAllSuperhumanSessionState() {
