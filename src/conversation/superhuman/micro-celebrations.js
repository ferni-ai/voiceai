 ...
 */
export function detectMicroWin(message) {
    for (const [type, config] of Object.entries(WIN_PATTERNS)) {
        ...
        for (const pattern of config.patterns) {
            ...
            if (match) {
                ...
                const celebration = llmContent.source === 'llm' && llmContent.content
                    ? llmContent.content
 ...
 */
export function formatMicroWinForPrompt(win) {
    const lines = [
...
//# sourceMappingURL=micro-celebrations.js.map