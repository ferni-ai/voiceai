 ...
 * Assess topic weight
 */
export function assessTopicWeight(context: BetterThanHumanContext): 'light' | 'medium' | 'heavy' {
  const heavyPatterns = [
 ...
 */
export function assessUserEnergy(message: string): 'high' | 'medium' | 'low' {
 ...
 * Assess recent tone
 */
export function assessRecentTone(context: BetterThanHumanContext): 'heavy' | 'light' | 'neutral' {
 ...
 */
export function hasEmotionalContent(context: BetterThanHumanContext): boolean {
 ...
 * Check for laughter
 */
export function hasLaughter(message: string): boolean {
 ...
 */
export function detectGrowth(message: string): boolean {
 ...
 * Detect concerns
 */
export function detectConcerns(message: string): boolean {
 ...
 */
export function calculateEnergyLevel(message: string): number {
