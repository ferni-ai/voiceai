...
export class ConversationRhythmTracker {
    ...
    ANALYSIS_WINDOW = 5; // Number of turns to analyze
    // Rhythm state
    currentPacing = 'moderate';
    currentPausePattern = 'flowing';
    energyHistory = [];
    constructor() {
    ...
    analyzeRhythm() {
        ...
        const avgPauseCount = recentTurns.reduce((sum, t) => sum + t.pauseCount, 0) / recentTurns.length;
        const avgPauseDuration = recentTurns.reduce((sum, t) => sum + t.avgPauseDuration, 0) / recentTurns.length;
        // Determine pacing
...
// ============================================================================
let instance = null;
export function getConversationRhythmTracker() {
    if (!instance) {
        instance = new ConversationRhythmTracker();
    }
    return instance;
}
export function resetConversationRhythmTracker() {
    if (instance) {
        instance.reset();
    }
    instance = null;
...
//# sourceMappingURL=conversation-rhythm.js.map