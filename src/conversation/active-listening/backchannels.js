...
// ============================================================================
export const PERSONA_BACKCHANNEL_STYLES = {
    'nayan-patel': {
...
// ============================================================================
export const SILENCE_BACKCHANNELS = [
    {
        verbal: 'Mm-hmm.',
...
export const SAD_SILENCE_BACKCHANNELS = [
    {
        verbal: "I'm with you.",
...
export const FERNI_SILENCE_BACKCHANNEL = {
    verbal: 'Sit with it.',
    ssml: '<volume ratio="0.75"/><break time="200ms"/>Sit with it.',
    type: 'encouragement',
    energy: 'low',
};
export const NAYAN_SILENCE_BACKCHANNEL = {
