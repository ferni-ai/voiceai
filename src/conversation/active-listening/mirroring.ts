 ...
 */
export function mirrorUserVocabulary(
  userText: string,
  responseText: string,
  extractedVocabulary: Set<string>
): MirroredPhrase | null {
 ...
 */
export function extractNotableWords(text: string): string[] {
  const commonWords = new Set([
    ...
    'below', 'between', 'i', 'you', 'he', 'she', 'it', 'we', 'they', 'me',
    'him', 'her', 'us', 'them', 'my', 'your', 'his', 'its', 'our', 'their',
    'mine', 'yours', 'hers', 'ours', 'theirs', 'this', 'that', 'these',
    'those', 'what', 'which', 'who', 'whom', 'whose', 'and', 'but', 'or',
    'nor', 'so', 'yet', 'both', 'either', 'neither', 'not', 'no', 'yes',
    'just', 'also', 'very', 'too', 'quite', 'rather', 'about', 'like',
    'really', 'think', 'know', 'get', 'got', 'want', 'going', 'because',
    'when', 'if', 'then', 'than', 'some', 'any', 'all', 'each',
  ]);
...
const EMOTIONAL_ECHOES: Record<string, Record<string, string[]>> = {
  worried: {
 ...
 */
export function generateEmotionalEcho(
  userEmotion: string,
  userText: string,
