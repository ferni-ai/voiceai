 ...
 */
export async function generatePlayfulness(context, mood, signals) {
    ...
    const relationshipBoost = context.relationshipStage === 'trusted_advisor'
        ? 1.4
...
//# sourceMappingURL=playfulness.js.map