 ...
 */
export type HumanizationType = 'mood_signal' | 'spontaneous_thought' | 'physical_presence' | 'running_joke' | 'mind_change' | 'engagement_signal' | 'excitement_interruption' | 'breath_sound' | 'anticipation' | 'contradiction' | 'first_turn_notice' | 'playfulness' | 'live_reaction' | 'none';
/**
 ...
 */
export type HumanizationGenerator = (context: HumanizationContext, mood: ConversationMood, signals: HumanizationSignals) => Promise<GeneratorResult>;
/**
