 ...
 */
export function createExcitementInterruptionEffect(personaId) {
    ...
    return {
        ...
        generate(context) {
            ...
            return {
                ...
                metadata: {
                    category: categoryRoll < 0.4 ? 'excitement' : categoryRoll < 0.7 ? 'capture' : 'agreement',
                },
            };
        },
    };
...
//# sourceMappingURL=excitement-interruption.effect.js.map