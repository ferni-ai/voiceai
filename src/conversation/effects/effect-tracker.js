...
class EffectTrackerImpl {
    ...
    getUsageCount(effectId) {
        return this.usageCounts.get(effectId) ?? 0;
    }
    getLastUsedTurn(effectId) {
 ...
 */
export function getEffectTracker(sessionId) {
 ...
 */
export function resetEffectTracker(sessionId) {
 ...
 * Reset all trackers
 */
export function resetAllEffectTrackers() {
    trackers.clear();
}
