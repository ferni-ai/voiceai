 ...
 */
export type HumanizationCapability = 'presence' | 'attunement' | 'naturalness' | 'reactions' | 'memory' | 'questions' | 'silence';
/**
 * Where the effect content should be placed in the response
 */
export type EffectPlacement = 'prefix' | 'suffix' | 'inline' | 'interrupt' | 'standalone';
/**
...
export interface EffectCoordinator {
    ...
    applyEffects(text: string, ssml: string, effects: HumanizationEffect[], context: EffectContext): Promise<EffectApplicationResult>;
