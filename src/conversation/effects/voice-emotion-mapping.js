 ...
 */
export function getEffectMappingForEmotion(emotion) {
 ...
 */
export function getEffectModifierForEmotion(effectId, emotion) {
 ...
 */
export function processVoiceEmotionForEffects(signal) {
    const mapping = getEffectMappingForEmotion(signal.emotion);
    const voiceQualityAdjustments = {};
...
//# sourceMappingURL=voice-emotion-mapping.js.map