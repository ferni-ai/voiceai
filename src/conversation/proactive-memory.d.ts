 ...
 */
export { ProactiveMemoryEngine, getProactiveMemoryEngine, resetProactiveMemoryEngine, clearProactiveMemoryEngine, hasProactiveMemoryEngine, getActiveProactiveMemoryCount, default, } from './proactive-memory/index.js';
export type { CaptureContext, MemoryType, PatternDetection, ProactiveMemorySuggestion, StoredMemory, SuggestionContext, } from './proactive-memory/index.js';
