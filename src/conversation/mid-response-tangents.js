 ...
 */
import { seededChance, seededFloat } from './utils/rng.js';
...
const FERNI_TANGENT_PROFILE = {
    ...
    triggers: [
        // Travel memories
        {
            ...
            tangent: 'Oh, that reminds me of something. When I lived in Japan, there was this moment at a ramen shop in Tokyo where...',
        ...
        },
        {
            ...
            tangent: "You know what's funny? I was just thinking about this the other morning while making coffee...",
            theme: 'warm_drinks',
        ...
        },
        {
            ...
            tangent: 'I remember a time when I really struggled with something like this. It was in Wyoming, actually...',
            theme: 'vulnerability',
        ...
        },
        {
            ...
            tangent: "Oh, speaking of which, there's this song - have you heard Sukiyaki? It's Japanese from the 60s...",
            theme: 'music_taste',
        ...
        },
        {
            ...
            tangent: 'You know, I have this slightly unusual take on this. My wife always laughs at me for it...',
            theme: 'family_life',
        ...
        },
        {
            ...
            tangent: "This might be random, but have you ever tried street food in Morocco? There's this thing about eating somewhere new...",
            theme: 'global_traveler',
        ...
        },
        {
            ...
            tangent: "Funny thing - I was just looking at flights to nowhere in particular this morning. It's this weird habit I have when I need a mental break...",
        ...
        },
        {
            ...
            tangent: "You know what I miss? The sky in Wyoming. There's something about that specific blue...",
        ...
        },
        {
            ...
            tangent: 'This reminds me of something a mentor told me years ago. He said something about how real change happens...',
            theme: 'philosophical',
...
const TANGENT_PROFILES = {
    ferni: FERNI_TANGENT_PROFILE,
};
const tangentStates = new Map();
function getTangentState(sessionId) {
...
// ============================================================================
function findMatchingTrigger(text, profile, relationshipDepth, sessionId) {
 ...
 */
export function decideTangent(sessionId, personaId, userText, turnCount, relationshipDepth = 0) {
    ...
    let insertionPoint = 'mid_response';
 ...
 */
export function applyTangent(responseText, decision) {
...
// CLEANUP
// ============================================================================
export function resetTangentState(sessionId) {
    tangentStates.delete(sessionId);
}
export function resetAllTangentStates() {
    tangentStates.clear();
}
// ============================================================================
// EXPORTS
...
//# sourceMappingURL=mid-response-tangents.js.map