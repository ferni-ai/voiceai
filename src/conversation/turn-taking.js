 ...
 */
export function getTurnTakingMonitor() {
    if (!defaultMonitor) {
 ...
 */
export function resetTurnTakingMonitor() {
    if (defaultMonitor) {
        defaultMonitor.reset();
    }
    defaultMonitor = null;
}
//# sourceMappingURL=turn-taking.js.map