...
export type BetterThanHumanStage = 'new_acquaintance' | 'getting_to_know' | 'trusted_advisor' | 'old_friend';
/**
 ...
 */
export declare const COMFORT_LEVELS: Record<RelationshipStage, number>;
/**
 * Map relationship stage to Better Than Human format
 */
export declare const RELATIONSHIP_STAGE_MAP: Record<RelationshipStage, BetterThanHumanStage>;
