 ...
 */
export function createDeterministicTrigger(sessionId, personaId) {
    return (turnNumber, feature, probability) => {
 ...
 */
export function applySsmlEnhancements(text, guidance) {
    if (!guidance)
        return text;
    let ssml = text;
    // Add opening break
 ...
 */
export function shouldAddUncertainty(text, context, shouldTrigger) {
