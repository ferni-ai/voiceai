 ...
 */
export declare function parseBody<T = unknown>(req: IncomingMessage): Promise<T>;
/**
 ...
 */
export declare function parseRawBody(req: IncomingMessage, options?: {
    timeoutMs?: number;
    maxBytes?: number;
}): Promise<string>;
/**
 ...
 */
export declare function parseBodyWithSchema<T>(req: IncomingMessage, schema: ZodSchema<T>): Promise<ValidationResult<T>>;
/**
 ...
 * @returns Validation result with typed data or error message
 */
export declare function validateQueryParams<T>(parsedUrl: URL, schema: ZodSchema<T>): ValidationResult<T>;
/**
 ...
 */
export declare function getUserId(req: IncomingMessage, parsedUrl: URL): string | null;
/**
 ...
 */
export declare function requireUserId(req: IncomingMessage, res: ServerResponse, parsedUrl: URL): string | null;
/**
 ...
 */
export declare function getSecureResponseHeaders(origin?: string): Record<string, string>;
/**
 ...
 */
export declare function sendJSONCached(res: ServerResponse, data: unknown, maxAge?: number, status?: number): void;
/**
 ...
 * @param status - HTTP status code
 */
export declare function sendJSONEdgeCached(res: ServerResponse, data: unknown, maxAge?: number, status?: number): void;
/**
 ...
 * ```
 */
export declare function sendApiError(res: ServerResponse, options: {
    status: number;
    message: string;
    code?: string;
    details?: Record<string, unknown>;
 ...
 */
export declare function handleCorsPreflightIfNeeded(req: IncomingMessage, res: ServerResponse): boolean;
/**
 ...
 */
export declare function parsePositiveInt(value: string | null, defaultValue: number, max?: number): number;
/**
 * Standard API route handler signature
 */
export type RouteHandler = (req: IncomingMessage, res: ServerResponse, pathname: string, parsedUrl: URL) => Promise<boolean>;
/**
 * Alias for parseBody - used in some route handlers
 */
export declare const parseRequestBody: typeof parseBody;
/**
 * Alias for parseBody - used for reading request body
 */
export declare const readBody: typeof parseBody;
/**
 * Alias for sendJSON - used in some route handlers
 */
export declare const sendSuccess: typeof sendJSON;
/**
 * Legacy wrapper for sendJSON with (res, status, data) signature.
 * New code should use sendJSON(res, data, status) instead.
 */
export declare function sendJsonResponse(res: ServerResponse, status: number, data: unknown): void;
/**
 ...
 */
export declare function validateAuth(req: IncomingMessage, res: ServerResponse): Promise<string | null>;
 ...
 */
export declare function getSecureUserId(auth: AuthContext, requestedUserId?: string | null): string;
/**
 ...
 */
export declare function verifyAdminAccess(req: IncomingMessage, allowDevMode?: boolean): boolean;
/**
 ...
 * @returns true if request has valid admin credentials
 */
export declare function verifyAdminAccessFromUrl(req: IncomingMessage, parsedUrl: URL, allowDevMode?: boolean): boolean;
/**
