 ...
 */
landingIntelligenceRouter.post('/optimize', asyncHandler(async (req: Request, res: Response) => {
  try {
 ...
 */
landingIntelligenceRouter.get('/demo', asyncHandler(async (req: Request, res: Response) => {
  try {
 ...
 */
landingIntelligenceRouter.post('/chat-greeting', asyncHandler(async (req: Request, res: Response) => {
  try {
 ...
 */
landingIntelligenceRouter.post('/layout', asyncHandler(async (req: Request, res: Response) => {
  try {
 ...
 */
landingIntelligenceRouter.get('/visitor/:visitorId', asyncHandler(async (req: Request, res: Response) => {
  try {
 ...
 */
landingIntelligenceRouter.post('/track', asyncHandler(async (req: Request, res: Response) => {
  try {
 ...
 */
landingIntelligenceRouter.post('/track/end', asyncHandler(async (req: Request, res: Response) => {
  try {
    const { visitorId, sessionId, signals } = req.body;
