...
export function getCorsHeaders(origin) {
    ...
    return {
        ...
        'Access-Control-Allow-Headers': 'Content-Type, X-User-Id, Authorization, X-API-Key, X-Request-Id, X-Admin-Key',
 ...
 */
export function getResponseHeaders(origin) {
    return {
 ...
 */
export function isRequestSizeAllowed(contentLength, type = 'json') {
