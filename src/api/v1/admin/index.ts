...
export async function handleAdminRoutes(
  ...
  // Better Than Human Analytics (superhuman capability effectiveness)
  if (pathname.startsWith(`${BASE_PATH}/bth`)) {
    return handleBTHAnalyticsRoutes(req, res, pathname, parsedUrl);
  }
