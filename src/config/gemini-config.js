...
export const GEMINI_MAX_OUTPUT_TOKENS = parseInt(process.env.GEMINI_MAX_OUTPUT_TOKENS || '1024', 10);
/** Short max tokens for quick responses */
export const GEMINI_MAX_OUTPUT_TOKENS_SHORT = parseInt(process.env.GEMINI_MAX_OUTPUT_TOKENS_SHORT || '500', 10);
/** Long max tokens for detailed responses */
export const GEMINI_MAX_OUTPUT_TOKENS_LONG = parseInt(process.env.GEMINI_MAX_OUTPUT_TOKENS_LONG || '2000', 10);
/** Default language */
...
async function initializeGeminiClient() {
    ...
    try {
        ...
        if (USE_VERTEX_AI && GOOGLE_CLOUD_PROJECT) {
            ...
            log.info({ project: GOOGLE_CLOUD_PROJECT, location: GOOGLE_CLOUD_LOCATION }, '🔷 Gemini client initialized with Vertex AI');
        }
        else {
...
export function getShortLLMTimeout() {
