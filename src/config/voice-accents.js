 ...
 */
export const ACCENT_TO_DIALECT = {
    american: 'us',
    british: 'uk',
    australian: 'au',
    indian: 'in',
 ...
 */
export const ACCENT_DISPLAY_NAMES = {
 ...
 */
export const ACCENT_DESCRIPTIONS = {
 ...
 */
export function detectAccentFromLocale(locale) {
 ...
 */
export function detectAccentFromLocales(locales) {
    let bestMatch = null;
 ...
 */
export function getDialectCode(accent) {
 ...
 */
export function requiresLocalization(accent) {
...
export function isValidAccent(accent) {
    return SUPPORTED_ACCENTS.includes(accent);
}
// =============================================================================
 ...
 */
export function createDefaultVoicePreference(detectedLocale) {
    if (detectedLocale) {
 ...
 */
export function mergeVoicePreference(partial) {
    return {
 ...
 */
export function logAccentSelection(userId, accent, source) {
    log.info({
        userId,
        accent,
...
//# sourceMappingURL=voice-accents.js.map