...
export function getPersonaColor(personaId) {
    return PERSONA_COLORS[personaId] || PERSONA_COLORS.ferni;
}
/**
 * Get persona secondary color with fallback to Ferni
 */
export function getPersonaSecondaryColor(personaId) {
    return PERSONA_SECONDARY_COLORS[personaId] || PERSONA_SECONDARY_COLORS.ferni;
}
/**
 * Get persona glow color with fallback to Ferni
 */
export function getPersonaGlowColor(personaId) {
    return PERSONA_GLOW_COLORS[personaId] || PERSONA_GLOW_COLORS.ferni;
}
// ============================================================================
// STATUS COLORS
// ============================================================================
...
//# sourceMappingURL=brand-colors.js.map