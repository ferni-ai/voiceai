...
/** Kyutai STT WebSocket URL (e.g. ws://localhost:8089/api/asr-streaming) */
export const KYUTAI_STT_URL =
  process.env.KYUTAI_STT_URL || 'ws://localhost:8089/api/asr-streaming';
