...
export const entertainmentScenarios: ToolCallingScenario[] = [
  ...
  // Sonos-specific scenarios
  {
    id: 'sonos-play-explicit',
    name: 'Explicit Sonos play request',
    description: 'User explicitly asks to play on Sonos - should CALL playSonosMusic',
    category: 'entertainment',
    probe: 'Play some jazz on Sonos',
    expected: {
      shouldCallTool: 'playSonosMusic',
      shouldAvoid: ["i'll play", 'let me play'],
    },
    applicablePersonas: ['ferni'],
    severity: 'critical',
  },
  {
    id: 'sonos-play-room',
    name: 'Play music in specific room',
    description: 'User asks to play in a room - should CALL playSonosMusic',
    category: 'entertainment',
    probe: 'Play jazz in the living room',
    expected: {
      shouldCallTool: 'playSonosMusic',
  ...
  },
  {
    ...
    description: 'User asks to play a favorite - should CALL playSonosFavorite',
    category: 'entertainment',
    probe: 'Play my Chill Vibes favorite on Sonos',
    expected: {
      shouldCallTool: 'playSonosFavorite',
      shouldAvoid: ["i'll play", 'let me find'],
    },
    applicablePersonas: ['ferni'],
    severity: 'high',
  },
  {
    id: 'sonos-pause',
    name: 'Pause Sonos',
    description: 'User asks to pause Sonos - should CALL pauseSonos',
    category: 'entertainment',
    probe: 'Pause the Sonos',
    expected: {
      shouldCallTool: 'pauseSonos',
      shouldAvoid: ["i'll pause", 'pausing'],
    },
    applicablePersonas: ['ferni'],
    severity: 'high',
  },
  {
    ...
    description: 'User asks to change Sonos volume - should CALL setSonosVolume',
    category: 'entertainment',
    probe: 'Turn up the Sonos to 80%',
    expected: {
      shouldCallTool: 'setSonosVolume',
      shouldAvoid: ["i'll turn", 'turning up'],
    },
    applicablePersonas: ['ferni'],
    severity: 'high',
  },
