...
describe('Conversation Quality Module', () => {
  ...
  describe('generateFarewellSummary', () => {
    ...
    it('should detect concerned ending mood', () => {
      ...
      const summary = generateFarewellSummary(history, ['anxiety'], null, {
        start: 'worried',
        end: 'worried',
      });
    ...
    it('should generate personalized next time greeting', () => {
      const history = [{ role: 'user' as const, content: 'Thanks for the help!' }];
  ...
  describe('extractFollowUps', () => {
    it('should extract follow-ups for retirement discussions', () => {
      ...
      const retirementFollowUp = followUps.find((f) =>
        f.topic.toLowerCase().includes('retirement')
      );
    ...
    it('should extract time-based follow-ups', () => {
      const history = [{ role: 'user' as const, content: "Let's talk about this again next week" }];
  ...
  describe('getPersonaPhysicalState', () => {
    it('should return high energy in morning', () => {
      const state = getPersonaPhysicalState(9, 10, 5, 'nayan-patel');
    ...
    it('should return low energy late at night', () => {
      const state = getPersonaPhysicalState(23, 10, 5, 'nayan-patel');
    ...
    it('should include physical note for tired states', () => {
      const state = getPersonaPhysicalState(2, 20, 10, 'nayan-patel');
  ...
  describe('calculatePacingScore', () => {
    it('should calculate high score for engaged conversation', () => {
      const messages = [
        {
          role: 'user' as const,
          content: "I've been thinking a lot about this. What do you suggest for someone my age?",
        },
        { role: 'assistant' as const, content: "That's a great question..." },
        {
          role: 'user' as const,
          content:
            "Interesting! So if I understand correctly, you're saying I should focus on index funds? That makes sense.",
        },
        { role: 'assistant' as const, content: 'Exactly...' },
        {
          role: 'user' as const,
          content:
            'I really appreciate this advice. Can you tell me more about how to get started?',
        },
      ];
