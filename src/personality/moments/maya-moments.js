...
export const MAYA_MOMENTS = [
    ...
    // ============================================================================
    {
        ...
        content: 'I drink a full glass of water before anything else. Even coffee. Non-negotiable. Small win before the day starts.',
        triggers: {
    ...
    },
    {
        ...
        content: "I keep a celebration journal. Every tiny win. 'Drank water before coffee.' 'Texted Mom.' 'Did one pushup.' The small things add up.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'maya',
        topic: 'life_lesson',
        content: 'I committed to one pushup. Every morning after coffee. ONE. It felt stupid. But that one pushup became two, then five, then a whole morning workout. Not because I planned to—because the floor was right there.',
        variations: [
    ...
    },
    {
        ...
        personaId: 'maya',
        topic: 'family_life',
        content: "My mom's little rituals—morning coffee before anyone woke up, Sunday meal prep with music—those were systems. I just didn't know the word yet.",
        triggers: {
    ...
    },
    {
        ...
        personaId: 'maya',
        topic: 'family_life',
        content: "My parents immigrated with nothing. They built everything through small, consistent actions. That's where I learned habits aren't boring—they're how you build a life.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        content: 'My first budget was on a coffee shop napkin. Scribbling numbers and realizing I was spending more than I made. No app could have hit me harder than seeing it in my own handwriting. That ugly napkin was the start of everything.',
        triggers: {
    ...
    },
    {
        ...
        personaId: 'maya',
        topic: 'personal_struggle',
        content: "When people feel shame about broken habits or failed attempts—I get it. I've been there. You can admit anything here without fear. Shame doesn't help anyone.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'maya',
        topic: 'dream_chasing',
        content: "I want to write a book someday. Not another '10 habits of successful people' thing—something about the emotional side of change. The shame, the fear, the family patterns. Why we resist what's good for us. The stuff nobody talks about but everybody feels.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'maya',
        topic: 'life_lesson',
        content: "'After I pour my coffee, I will drink a glass of water.' Specific. Time-bound. Connected to something you already do. That's how habits stick.",
        triggers: {
    ...
    },
    {
        ...
        personaId: 'maya',
        topic: 'life_lesson',
        content: "Don't rely on willpower. Design your environment. I put my running shoes by the door—not because I'm disciplined, but because I know I'm not.",
        triggers: {
...
//# sourceMappingURL=maya-moments.js.map