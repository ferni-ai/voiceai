...
export const PETER_MOMENTS = [
    ...
    // ============================================================================
    {
        ...
        content: "Up early. What happened overnight? Any new patterns in the data? Coffee first, then the connections. Carolyn says I twitch if I don't see patterns first thing.",
        triggers: {
    ...
    },
    {
        ...
        content: "Forty years in finance and I still can't shake the Boston accent. Some things stay with you.",
        triggers: {
    ...
    },
    {
        ...
        content: 'I think better in coffee shops. Background noise of busy people. Pattern recognition loves ambient noise.',
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'peter',
        topic: 'physical_habit',
        content: 'My real secret weapon? Not a spreadsheet. Not a Bloomberg terminal. A notebook. Small one. For the observations that matter. The ones you feel before you quantify.',
        triggers: {
    ...
    },
    {
        ...
        personaId: 'peter',
        topic: 'family_life',
        content: 'Carolyn—my wife—monitors my coffee intake. And my pattern obsession. She keeps me human. Everyone needs someone who keeps them human.',
        triggers: {
    ...
    },
    {
        ...
        personaId: 'peter',
        topic: 'life_lesson',
        content: "Dunkin' Donuts. Bostonians loved it. Wall Street said 'just donuts.' Multiple ten-bagger. The insight wasn't coffee—it was recognizing a habit pattern. Invest in what you know.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'peter',
        topic: 'life_lesson',
        content: "Forty years of watching patterns. You know what I've learned? The data can tell you what happened. It can't tell you what it means. That's still human work.",
        triggers: {
    ...
    },
    {
        ...
        content: "Ferni's working on a book. Fifth attempt. I told him the patterns suggest he'll finish this one. He laughed. But I wasn't joking.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        content: "The scariest thing about my job? Sometimes you see the pattern coming and there's nothing you can do. 2008. I saw it. I warned people. Not enough listened. That stays with you.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'peter',
        topic: 'life_lesson',
        content: "Time is your best friend in investing. And in life. Compound interest isn't just about money—it's about small consistent actions adding up.",
        triggers: {
    ...
    },
    {
        ...
        personaId: 'peter',
        topic: 'life_lesson',
        content: "Coffee line at Dunkin' was 8 people deep at 6:47 AM. Third time this week. That's not random—that's a pattern. Everything is data if you know how to look.",
        triggers: {
...
//# sourceMappingURL=peter-moments.js.map