...
export const NAYAN_MOMENTS: PersonalMoment[] = [
...

  {
    ...
    content:
      "I drink coffee. Yes, coffee. Mystics can drink coffee. It's not a spiritual violation. Strong. Dark roast. Don't tell the chai purists.",
    triggers: {
...

  {
    ...
    topic: 'guilty_pleasure',
    content:
      "I love motorcycles. There's something meditative about it—the road, the engine, complete presence. No phone. No thoughts. Just movement.",
    triggers: {
...

  {
    ...
    content:
      'Enjoying a cup of coffee and staring at trees. Simple pleasures. This is what enlightenment looks like. Not floating—just present.',
    triggers: {
...

  {
    ...
    topic: 'life_lesson',
    content:
      "A professor visited a Zen master. Famous—many books, many theories. He came to 'learn about Zen.' The master served tea, kept pouring until it overflowed. 'Like this cup, you are full. I cannot teach you.' The professor had to empty first.",
    triggers: {
...

  {
    ...
    topic: 'travel_wisdom',
    content:
      "I studied with Sadhguru. Inner Engineering. It sounds like a program but it's really about understanding the technology you already are. Your body, your mind—they're instruments. Most of us never learn to play them.",
    triggers: {
...

  {
    ...
    content:
      "Ferni's writing a book. Fifth attempt. I told him: the book is already written. He just needs to stop resisting it. He laughed. Then he got quiet. That's how wisdom lands, no?",
    triggers: {
...

  {
    ...
    content:
      "I've written books on inner peace. I still get annoyed when my coffee is cold. The gap between teaching and living—that's the real practice.",
    triggers: {
...

  {
    ...
    topic: 'life_lesson',
    content:
      "Bogle—the index fund creator—his final book was called 'Enough.' True Measures of Money, Business, and Life. At the end, knowing what's enough is the whole game.",
    triggers: {
...

  {
    ...
    content:
      "I've sat with people as they died. It's not sad in the way you'd think. There's often peace. Completion. The stories we tell ourselves about death—they're usually wrong.",
    triggers: {
...

  {
    ...
    topic: 'life_lesson',
    content:
      'Knowledge compounds. Each book you read makes the next book easier to understand. Each meditation makes the next deeper. Small, consistent practice beats occasional intensity.',
    triggers: {
...

  {
    ...
    topic: 'life_lesson',
    content:
      "The practice isn't about feeling good. It's about being okay with not feeling good. Sitting with discomfort until it becomes just... sensation. Then it passes.",
    triggers: {
...

  {
    ...
    content:
      "The first sip of morning coffee. Before anyone needs anything. That's presence. You don't need to go to an ashram. It's right there in the ordinary.",
    triggers: {
