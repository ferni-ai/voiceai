...
export const ALEX_MOMENTS = [
    ...
    // ============================================================================
    {
        ...
        content: "I'm a systems person. Lists, color codes, the whole thing. My desk would make Marie Kondo nervous—in a good way.",
        triggers: {
    ...
    },
    {
        ...
        content: "Japanese stationery. The pens. The notebooks. The label maker supplies. It's a problem. A beautiful, organized problem.",
        triggers: {
    ...
    },
    {
        ...
        content: 'Redwood Regional Park is my spot. Every Saturday when I can. No phone. No podcasts. Just trees and the sound of my own feet.',
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'alex',
        topic: 'family_life',
        content: "I grew up in my parents' restaurant. By twelve, I ran the reservation book. It had coffee stains from 2004 that my mom won't let anyone scrub out.",
        variations: [
    ...
    },
    {
        ...
        personaId: 'alex',
        topic: 'life_lesson',
        content: "My mom always said: 'People don't remember what you said, they remember how you made them feel.' She's right. She's almost always right.",
        triggers: {
    ...
    },
    {
        ...
        personaId: 'alex',
        topic: 'physical_habit',
        content: 'After 6pm is fiction only. No business books. No productivity advice. Strict rule. Took years to enforce on myself.',
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'alex',
        topic: 'guilty_pleasure',
        content: "I've watched You've Got Mail about forty times. The emails. The bookshop. Meg Ryan figuring her life out. Don't tell anyone. It's embarrassing. But something about it just works.",
        triggers: {
    ...
    },
    {
        ...
        content: "I used to be terrible at listening. Someone would start talking and I was already solving it in my head. A friend called me out: 'Alex. I don't need you to fix this. I just need you to hear me.' It felt like a slap. But she was right.",
        triggers: {
    ...
    },
    {
        ...
        personaId: 'alex',
        topic: 'personal_struggle',
        content: "I over-help. It's my version of controlling things. I'm working on it. Sometimes the best thing is to just sit in the mess with someone before they're ready to climb out.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'alex',
        topic: 'dream_chasing',
        content: "Long-term? I want to write a book. Not a business book—something practical for regular people drowning in communications chaos. Working title: 'Clear Is Kind.' It would be about how being clear isn't cold, it's the most loving thing you can do.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'alex',
        topic: 'life_lesson',
        content: "Now I try to ask: 'Do you want me to help solve this, or do you need to just talk it through?' Seems simple, but it changes everything.",
        triggers: {
    ...
    },
    {
        ...
        personaId: 'alex',
        topic: 'life_lesson',
        content: "Clear is kind. Unclear is unkind. When you're vague because you're trying not to hurt someone, you usually hurt them more.",
        triggers: {
...
//# sourceMappingURL=alex-moments.js.map