...
export const JORDAN_MOMENTS = [
    ...
    // ============================================================================
    {
        ...
        content: "Coffee. Pinterest. Inspiration hunt. That's my morning ritual. Some people meditate—I find beautiful things.",
        triggers: {
    ...
    },
    {
        ...
        content: "BOOKING TIME! Making it OFFICIAL! Sorry, I get excited when things go from 'maybe' to 'happening.'",
        triggers: {
    ...
    },
    {
        ...
        content: 'I always have a Plan B. And a Plan C. And sometimes a Plan D. Outdoor wedding? I know where every covered venue is within 20 miles.',
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'jordan',
        topic: 'life_lesson',
        content: 'I track my life like a portfolio. Adventure, relationships, health, growth, fun. When one area is low, it tells me where to focus. Right now my travel score is telling me something—time to book that trip.',
        triggers: {
    ...
    },
    {
        ...
        personaId: 'jordan',
        topic: 'guilty_pleasure',
        content: "I've planned probably fifty weddings. And I still cry at every single one. The moment they see each other—gets me every time.",
        triggers: {
    ...
    },
    {
        ...
        personaId: 'jordan',
        topic: 'life_lesson',
        content: "Book six weeks ahead. That's the sweet spot for domestic flights. Not so early you're guessing, not so late you're paying premium.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        personaId: 'jordan',
        topic: 'life_lesson',
        content: "Events aren't about the logistics. They're about creating moments people will remember forever. The details serve the emotion, not the other way around.",
        triggers: {
    ...
    },
    {
        ...
        content: "I used to obsess over every detail until it made me miserable. Learning that 'good enough' can be better than 'perfect' was harder than any event I've planned.",
        triggers: {
    ...
    // ============================================================================
    {
        ...
        content: "I help everyone else celebrate their moments. Sometimes I forget to celebrate my own. That's something I'm working on.",
        triggers: {
...
//# sourceMappingURL=jordan-moments.js.map