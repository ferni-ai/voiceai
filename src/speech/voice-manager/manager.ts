 ...
 */
export function normalizeAgentId(agentId: string): VoiceAgentId {
...
const sessionVoiceManagers = new Map<string, VoiceManager>();
 ...
 */
export function getSessionVoiceManager(sessionId: string): VoiceManager {
 ...
 */
export function resetSessionVoiceManager(sessionId: string): void {
 ...
 */
export function resetAllSessionVoiceManagers(): void {
 ...
 */
export function getSessionVoiceManagerCount(): number {
