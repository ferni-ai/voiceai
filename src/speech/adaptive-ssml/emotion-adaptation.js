 ...
 */
export function applyEmotionAdaptation(text, context) {
    let result = text;
    ...
    if (userEmotion === 'excited' ||
        ...
        const emotion = userEmotion === 'excited' || userEmotion === 'enthusiastic'
 ...
 */
function wrapWithEmotion(text, emotion) {
...
//# sourceMappingURL=emotion-adaptation.js.map