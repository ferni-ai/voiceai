 ...
 */
export function applyAudioSmoothing(text, options = {}) {
 ...
 */
export function hasAudioSmoothing(text) {
    // Check for our specific micro-pause patterns
    const hasLeadingMicroPause = /<break time="(2[0-9]|3[0-9]|4[0-9])ms"\/>/i.test(text.substring(0, 100));
 ...
 */
export function removeAudioSmoothing(text) {
...
//# sourceMappingURL=audio-smoothing.js.map