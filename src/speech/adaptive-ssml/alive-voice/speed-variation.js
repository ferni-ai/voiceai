 ...
 */
export const SPEED_VARIATION_PATTERNS = [
    // Slow down for emphasis
    {
        pattern: /\b(really |truly |deeply |genuinely |absolutely )(important|matter|care|love|proud|grateful)\b/gi,
    ...
    {
        pattern: /\b(what (?:do you think|matters|would you)|how (?:do you feel|does that|would you))\b/gi,
 ...
 * Creates natural pacing like human speech.
 */
export function applySpeedVariation(text, context) {
...
//# sourceMappingURL=speed-variation.js.map