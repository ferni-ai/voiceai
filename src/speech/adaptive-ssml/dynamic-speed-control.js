 ...
 * ```
 */
export function calculateDynamicSpeed(context, config = DEFAULT_SPEED_CONFIG) {
    const { userEngagement, contentComplexity, emotionalIntensity, baseSpeed, userWPM, topicWeight = 'medium', turnNumber = 0, } = context;
    const reasons = [];
    ...
    const addExtraPauses = contentComplexity > 0.6 || emotionalIntensity > 0.6 || topicWeight === 'heavy';
 ...
 */
export function applyDynamicSpeedSsml(text, result) {
    let ssml = text;
 ...
 */
export function getSpeedControlSession(sessionId) {
 ...
 */
export function recordSpeedDecision(sessionId, result) {
 ...
 */
export function getSpeedTrend(sessionId) {
    const session = getSpeedControlSession(sessionId);
 ...
 */
export function resetSpeedControlSession(sessionId) {
    sessions.delete(sessionId);
}
/**
 * Reset all sessions
 */
export function resetAllSpeedControlSessions() {
    sessions.clear();
}
// ============================================================================
// EXPORTS
...
//# sourceMappingURL=dynamic-speed-control.js.map