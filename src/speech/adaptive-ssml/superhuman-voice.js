 ...
 *
 * NOTE: This file has been split into a subdirectory for maintainability.
 * All exports are re-exported from ./superhuman-voice/index.js
 *
 * @module speech/adaptive-ssml/superhuman-voice
 */
// Re-export everything from the subdirectory
export * from './superhuman-voice/index.js';
export { default } from './superhuman-voice/index.js';
