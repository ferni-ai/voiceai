...
// ============================================================================
export const PERSONA_CATCHPHRASES = {
    ferni: {
        phrases: [
            "You've got this.",
        ...
        emphasis: 'normal',
        ssmlWrapper: (phrase) => `${breakTag('250ms')}<emotion value="affectionate">${phrase}</emotion>${breakTag('300ms')}`,
    },
    'nayan-patel': {
        phrases: [
            'Stay the course.',
        ...
        emphasis: 'slow',
        ssmlWrapper: (phrase) => `${breakTag('300ms')}<speed ratio="0.78"><emotion value="affectionate">${phrase}</emotion></speed>${breakTag('400ms')}`,
    },
    'peter-john': {
        phrases: [
        ...
        emphasis: 'excited',
        ssmlWrapper: (phrase) => `${breakTag('200ms')}<speed ratio="1.05"><emotion value="curious">${phrase}</emotion></speed>${breakTag('300ms')}`,
    },
    'maya-santos': {
        phrases: [
    ...
    'jordan-taylor': {
        ...
        emphasis: 'excited',
        ssmlWrapper: (phrase) => `${breakTag('200ms')}<speed ratio="1.08"><emotion value="surprised">${phrase}</emotion></speed>${breakTag('250ms')}`,
    },
    'alex-chen': {
 ...
 */
export function getCatchphraseWithSsml(personaId) {
...
//# sourceMappingURL=catchphrases.js.map