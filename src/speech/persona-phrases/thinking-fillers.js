 ...
 */
function getThinkingFillerInternal(personaId) {
 ...
 */
export function getThinkingFiller(personaId) {
 ...
 */
export function getContextAwareThinkingFiller(personaId, options) {
    const { type = 'thinking', weight = 'medium', forDeadAirPrevention = false, ...rest } = options || {};
...
//# sourceMappingURL=thinking-fillers.js.map