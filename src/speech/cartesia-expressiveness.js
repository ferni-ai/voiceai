 ...
 */
export function getEmotionForMood(mood) {
 ...
 */
export function getVoiceProfile(moment) {
 ...
 */
export function voiceProfileToSsml(profile) {
    let ssml = '';
 ...
 */
export function wrapWithProfile(text, profileName) {
 ...
 */
export function getEmotionInProgression(progression, position, total) {
 ...
 */
export function applyPersonaVoiceFingerprint(text, personaId, options) {
    ...
    if (emotion) {
        const intensityPrefix = options?.intensity === 'strong'
            ? 'very '
 ...
 */
export function getRandomPersonaEmotion(personaId) {
    const profile = getEmotionProfile(personaId);
 ...
 */
export function isEmotionInPersonaRange(personaId, emotion) {
    const profile = getEmotionProfile(personaId);
 ...
 */
export function getPersonaAppropriateEmotion(personaId, requestedEmotion) {
    const profile = getEmotionProfile(personaId);
 ...
 */
export function applyContextualEmotion(text, personaId, context) {
    const profile = getEmotionProfile(personaId);
...
//# sourceMappingURL=cartesia-expressiveness.js.map