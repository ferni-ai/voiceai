 ...
 */
export function getInterruptState(sessionId) {
 ...
 */
export function resetInterruptState(sessionId) {
 ...
 */
export function addCushioning(text) {
    const breakPoints = [];
    const chunks = [];
 ...
 */
export function senseInterrupt(sessionId, partialText, isAgentSpeaking) {
    if (!isAgentSpeaking) {
 ...
 */
export function getTrailingSsml(sessionId) {
    const state = getInterruptState(sessionId);
    if (state.hasTrailed) {
 ...
 */
export function getRecoverySsml(sessionId, options) {
    const state = getInterruptState(sessionId);
    ...
    const acknowledgment = Math.random() < 0.2 // Only 20% of the time
 ...
 */
export function endRecovery(sessionId) {
    const state = getInterruptState(sessionId);
 ...
 */
export function wrapWithInterruptAwareness(sessionId, text, options) {
    const state = getInterruptState(sessionId);
    let result = text;
...
// =============================================================================
export { wrapSpeechWithInterruptAwareness, createInterruptAwareTransform, markRecoveryComplete, isInRecoveryPhase, } from './speech-wrapper.js';
// =============================================================================
// EXPORTS
// =============================================================================
export default {
