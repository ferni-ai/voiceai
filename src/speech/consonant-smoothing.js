 ...
 */
export function applyConsonantSmoothing(text, options = {}) {
 ...
 */
export function detectDifficultClusters(text) {
    const detected = [];
 ...
 */
export function getClusterStats(text) {
...
// EXPORTS
// ============================================================================
export { CLUSTER_PATTERNS };
export default {
    applyConsonantSmoothing,
    detectDifficultClusters,
    getClusterStats,
};
//# sourceMappingURL=consonant-smoothing.js.map