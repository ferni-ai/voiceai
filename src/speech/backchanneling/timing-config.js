 ...
 */
export const HEAVY_TOPIC_ADJUSTMENT = {
 ...
 */
export const LIGHT_TOPIC_ADJUSTMENT = {
 ...
 */
export const DEFAULT_BREATH_PAUSE_CONFIG = {
 ...
 */
export function getTimingForMode(mode) {
    switch (mode) {
        case 'standard':
 ...
 */
export function adjustTimingForTopic(baseTiming, topicWeight) {
    ...
    if (topicWeight === 'heavy') {
        ...
        timing.minSpeechDuration = Math.max(1000, timing.minSpeechDuration + (LIGHT_TOPIC_ADJUSTMENT.minSpeechDuration ?? 0));
        timing.pauseTriggerDuration = Math.max(200, timing.pauseTriggerDuration + (LIGHT_TOPIC_ADJUSTMENT.pauseTriggerDuration ?? 0));
        timing.cooldownPeriod = Math.max(2000, timing.cooldownPeriod + (LIGHT_TOPIC_ADJUSTMENT.cooldownPeriod ?? 0));
 ...
 */
export function mergeTimingConfig(base, custom) {
    return {
...
//# sourceMappingURL=timing-config.js.map