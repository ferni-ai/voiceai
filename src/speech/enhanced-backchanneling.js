...
import { BACKCHANNEL_LIBRARY as _BACKCHANNEL_LIBRARY, PERSONA_BACKCHANNEL_STYLE as _PERSONA_BACKCHANNEL_STYLE, } from './persona-phrases.js';
 ...
 */
export function getEnhancedBackchannelingEngine(sessionId) {
 ...
 */
export function resetEnhancedBackchannelingEngine(sessionId) {
 ...
 */
export function getQuickBackchannel(userDistressLevel, personaId) {
    let type;
...
//# sourceMappingURL=enhanced-backchanneling.js.map