...
export class IntentPredictor {
    ...
    predict(text) {
        ...
        if (bestMatch && bestMatch.confidence >= 0.5) {
            ...
            log.debug({ intent: bestMatch.intent, confidence: bestMatch.confidence.toFixed(2) }, '🎯 Intent predicted');
            return bestMatch;
        }
        return this.unknownIntent();
    }
     ...
     */
    calculateConfidence(text, regex, pattern) {
...
//# sourceMappingURL=intent-predictor.js.map