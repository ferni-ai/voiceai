 ...
 */
export type IntentCategory = 'greeting' | 'farewell' | 'question' | 'help_request' | 'emotional_share' | 'celebration' | 'complaint' | 'gratitude' | 'affirmation' | 'unknown';
/**
 ...
 */
export type EmotionalTrajectory = 'rising_excitement' | 'rising_concern' | 'falling_sadness' | 'building_frustration' | 'seeking_support' | 'sharing_vulnerability' | 'expressing_gratitude' | 'joking_playful' | 'stable_neutral';
/**
 ...
 * Default options
 */
export declare const DEFAULT_ANTICIPATION_OPTIONS: AnticipationOptions;
