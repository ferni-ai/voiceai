...
export const LAUGHTER_PATTERNS = [
  /you know/i, /that is funny/i, /ha ha/i, /heh/i, /chuckle/i,
  /laugh/i, /that is great/i, /that is wonderful/i, /that is amazing/i,
  /good one/i, /nice one/i, /i love that/i, /that reminds me/i,
  /oh boy/i, /oh my/i, /can you believe/i, /imagine that/i,
  /isn't that something/i, /that is something/i,
];

export const SIGH_PATTERNS = [
  /that is heavy/i, /i understand/i, /that hurts/i,
  /difficult/i, /hard to hear/i,
];
