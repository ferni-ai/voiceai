 ...
 */
export function calculateCognitiveSpeechAdjustments(baseCharacteristics, context) {
    const adjustments = {
        speedMultiplier: 1.0,
        pauseMultiplier: 1.0,
 ...
 */
export function applyCognitiveAdjustments(base, adjustments) {
    return {
        ...base,
 ...
 */
export function getPauseDuration(duration) {
    switch (duration) {
        case 'short':
            return '200ms';
        case 'medium':
 ...
 */
export function buildPauseSSML(pause) {
 ...
 */
export function getCognitiveThinkingSound(reasoningStyle, confidence) {
    const sounds = {
...
//# sourceMappingURL=cognitive-speech.js.map