...
import { getAcknowledgmentPrefix, getCatchphraseWithSsml, getContextAwareThinkingFiller, normalizePersonaId, } from '../persona-phrases.js';
import { hasVoiceDataLoaded, loadPersonaVoiceData } from '../persona-voice-loader.js';
import { processPartialTranscript as sesameProcessPartial, getPreparedResponse, } from '../sesame-inspired/index.js';
const log = createLogger({ module: 'SpeechOrchestrator' });
// ============================================================================
// DEFAULT OPTIONS
// ============================================================================
const DEFAULT_HUMANIZATION_OPTIONS = {
...
export class SpeechOrchestrator {
     ...
     */
    async humanize(text, context, options = {}) {
    ...
    mapFullResult(result, processingTimeMs) {
        return {
    ...
    mapQuickResult(result, processingTimeMs) {
        return {
            emotionalUndercurrent: {
                primary: 'neutral',
                intensity: 0.5,
    ...
    // PRIVATE HELPERS
    // ==========================================================================
    shouldAddAcknowledgment(context) {
    ...
    shouldAddCatchphrase(context) {
        ...
        if (context.userEmotion?.primary === 'joy' &&
    ...
    determineAcknowledgmentMood(context) {
 ...
 */
export function getOrchestrator(sessionId, personaId = 'ferni') {
 ...
 */
export function resetOrchestrator(sessionId) {
