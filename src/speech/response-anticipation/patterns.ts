...
export const CACHED_PATTERNS: CachedPattern[] = [
  ...
  // System prompt has detailed guidance: share like a person, not a product pitch
  {
    ...
    variables: [],
    contextHint:
      'User asking about you. Share yourself like a person would - Wyoming, Japan, life coach. Not a product pitch.',
  },
  ...
  // NEVER say generic "I'm doing well, thanks for asking"
  {
    ...
    variables: [],
    contextHint:
      'User asked how you are. Be REAL - not the polished version. Draw from your life. NEVER say "I\'m doing well, thanks for asking."',
  },
