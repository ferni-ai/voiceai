 ...
 */
export type { AnticipatedResponse, CachedPattern, CacheStats, IntentCategory, PrefetchContext, } from './types.js';
export { CACHED_PATTERNS, predictIntent } from './patterns.js';
export { generatePrefetchContext } from './prefetch.js';
export { getActiveResponseAnticipationCount, getResponseAnticipationService, resetResponseAnticipationService, ResponseAnticipationService, } from './service.js';
