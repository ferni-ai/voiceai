 ...
 */
export function calculateBandEnergies(magnitudes, frequencies, sampleRate) {
    const bands = {
    ...
    const maxEnergy = Math.max(bands.subBass.energy, bands.bass.energy, bands.lowMid.energy, bands.mid.energy, bands.highMid.energy, bands.presence.energy, bands.brilliance.energy);
    if (maxEnergy > 0) {
        for (const band of Object.values(bands)) {
 ...
 */
export function analyzeSpectrum(samples, sampleRate = 16000) {
...
//# sourceMappingURL=spectral-analysis.js.map