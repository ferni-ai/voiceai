 ...
 */
function detectEnergyBurst(current, previous) {
 ...
 */
export function analyzeLaughterSpectral(spectrum, previousSpectrum) {
    ...
    const laughterScore = (1 - hnr) * 0.3 + // Less harmonic
...
//# sourceMappingURL=laughter.js.map