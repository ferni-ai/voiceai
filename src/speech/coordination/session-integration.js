 ...
 */
export function initializeSpeechCoordination(ctx) {
 ...
 */
export function cleanupSpeechCoordination(sessionId) {
 ...
 */
export function isCoordinationInitialized(sessionId) {
 ...
 */
export async function routeSpeech(sessionId, text, options = {}) {
    const state = sessionStates.get(sessionId);
 ...
 */
export async function routeToolResult(sessionId, toolId, resultText, options = {}) {
    const state = sessionStates.get(sessionId);
    if (!state) {
 ...
 */
export async function speakToolAcknowledgment(sessionId, toolId) {
    const state = sessionStates.get(sessionId);
    if (!state) {
        return { accepted: false, id: 'no-session' };
    }
 ...
 */
export async function speakBackchannel(sessionId, text) {
    const coordinator = getSpeechCoordinator();
 ...
 */
export function recordEchoDetected(sessionId, delayAfterSpeechMs) {
    const coordinator = getSpeechCoordinator();
 ...
 */
export function getAdaptiveEchoWindow(lastUtteranceDurationMs, userTranscript) {
    const coordinator = getSpeechCoordinator();
 ...
 */
function getPriorityForSource(source) {
    switch (source) {
        case 'backchannel':
 ...
 */
export function getSessionForCoordination(sessionId) {
    const state = sessionStates.get(sessionId);
 ...
 */
export function coordinatedSay(sessionId, text, options) {
