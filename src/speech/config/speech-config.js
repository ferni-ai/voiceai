 ...
 */
export function getBackchannelConfig(mode) {
    if (mode === 'adaptive') {
 ...
 */
export function adjustTimingForTopicWeight(baseConfig, topicWeight) {
    if (topicWeight === 'heavy') {
        return {
            ...baseConfig,
            cooldownPeriod: baseConfig.cooldownPeriod * BACKCHANNELING_CONFIG.heavyTopicMultiplier.cooldown,
            pauseTriggerDuration: baseConfig.pauseTriggerDuration * BACKCHANNELING_CONFIG.heavyTopicMultiplier.pauseTrigger,
        };
    }
    if (topicWeight === 'light') {
        return {
            ...
            pauseTriggerDuration: baseConfig.pauseTriggerDuration * BACKCHANNELING_CONFIG.lightTopicMultiplier.pauseTrigger,
        };
    }
    return baseConfig;
}
//# sourceMappingURL=speech-config.js.map