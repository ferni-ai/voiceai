 ...
 */
export function detectTrajectory(partial) {
    ...
    if (partial.tone === 'excited')
        return 'rising';
    if (partial.tone === 'sad' || partial.tone === 'frustrated')
        return 'falling';
    // Check speech rate
    if (partial.userSpeechRate === 'fast')
        return 'rising';
    if (partial.userSpeechRate === 'slow')
        return 'falling';
    return 'stable';
}
/**
 ...
 */
export function detectTrajectoryType(text) {
 ...
 */
export function anticipateResponse(partial) {
    ...
    if ((partial.tone === 'excited' && trajectoryType.includes('excitement')) ||
    ...
    if ((partial.userSpeechRate === 'fast' && trajectoryType.includes('excitement')) ||
 ...
 */
export function shouldAnticipate(partial) {
 ...
 */
export function getImmediateMicroReaction(text, tone) {
    const lowerText = text.toLowerCase();
 ...
 */
export function getAnticipatorySession(sessionId) {
 ...
 */
export function updateAnticipation(sessionId, partial, anticipation) {
 ...
 */
export function getLastAnticipation(sessionId) {
    return sessions.get(sessionId)?.lastAnticipation ?? null;
}
/**
 * Reset session state
 */
export function resetAnticipatorySession(sessionId) {
    sessions.delete(sessionId);
}
/**
 * Get active session count (for monitoring)
 */
export function getActiveAnticipatorySessionCount() {
    return sessions.size;
}
//# sourceMappingURL=anticipatory-prosody.js.map