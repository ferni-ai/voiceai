...
import { anticipateResponse, shouldAnticipate, updateAnticipation, } from './anticipatory-prosody.js';
import { getSessionProsodyRecommendation, updateConversationState, } from './conversation-prosody.js';
 ...
 */
export function processPartialTranscript(sessionId, partial) {
 ...
 */
export function getPreparedResponse(sessionId) {
 ...
 */
export function enhanceResponseWithSesame(sessionId, text, detectedEmotion, turnNumber) {
 ...
 */
export function quickEnhance(sessionId, text, emotion) {
 ...
 */
function combineSpeed(anticipated, conversation) {
 ...
 */
function combineVolume(anticipated, conversation) {
    const combined = (anticipated + conversation) / 2;
 ...
 * Reset session state
 */
export function resetSesamePipeline(sessionId) {
    sessions.delete(sessionId);
}
/**
 * Get active session count
 */
export function getActiveSesamePipelineSessionCount() {
 ...
 */
export function getSesamePipelineMetrics(sessionId) {
    const session = sessions.get(sessionId);
    if (!session) {
        return {
...
//# sourceMappingURL=pipeline-integration.js.map