 ...
 */
export function getDisfluenciesForEmotion(emotion) {
 ...
 */
export function selectWeightedDisfluency(patterns) {
 ...
 */
export function getRandomSsmlPattern(pattern) {
 ...
 */
export function findInjectionPoints(text) {
    const points = [];
 ...
 */
export function injectDisfluency(text, emotion, probability = 0.2) {
    // Roll for injection
 ...
 */
export function addThinkingStart(text) {
 ...
 */
export function addRealizationMoment(text) {
    const realizations = [
 ...
 */
export function addTrailingOff(text) {
    const trailOffs = [
 ...
 */
export function addExcitedInterruption(text) {
    const interruptions = [
 ...
 */
export function getDisfluencySession(sessionId) {
 ...
 */
export function smartInjectDisfluency(sessionId, text, emotion, turnNumber) {
 ...
 * Reset session
 */
export function resetDisfluencySession(sessionId) {
    sessions.delete(sessionId);
}
/**
 * Get active session count
 */
export function getActiveDisfluencySessionCount() {
    return sessions.size;
}
//# sourceMappingURL=rich-disfluencies.js.map