...
// Callback detection
export { detectCallbackTriggers, selectCallback, injectCallback, } from './callback-detector.js';
// Behavior loading (async)
export { loadSpeechProfile, clearSpeechProfileCache, preloadAllSpeechProfiles, selectImperfection, selectThinkingSound, selectBackchannel, selectBreathSound, getInjectionConfig, 
// Sync accessors (for use after preloading)
getSpeechProfileSync, areSpeechProfilesPreloaded, selectThinkingSoundSync, selectImperfectionSync, selectBreathSoundSync, 
// Laughter contagion
selectLaughterResponse, selectLaughterResponseSync, 
// Late night pacing
isLateNightHours, getLateNightPacing, getLateNightGreeting, 
// Energy matching
getEnergyMatchedPacing, 
// Callbacks
shouldUseCallback, 
// Celebrations
detectCelebrationIntensity, selectCelebration, selectCelebrationSync, 
// Catchphrases
selectCatchphrase, getPowerfulQuestion, getPartnershipPhrase, CATCHPHRASE_TRIGGERS, 
// Anticipation
getSessionOpeningPhrase, getTopicCallbackPhrase, getFutureLookingPhrase, getContinuityMarker, getPendingItemPhrase, } from './behavior-loader.js';
