 ...
 */
export type CoreImperfectionCategory = 'trailing_off' | 'self_corrections' | 'restarts' | 'filler_sounds' | 'thinking_aloud';
/**
 * Extended imperfection categories for persona-specific behaviors
 */
export type ExtendedImperfectionCategory = 'excitement_overflow' | 'celebration_overflow' | 'genuine_processing' | 'efficient_processing' | 'contemplative_sounds' | 'empathy_sounds' | 'grounding_sounds' | 'overwhelm_support' | 'wisdom_building' | 'gentle_laughter' | 'presence_sounds' | 'vocal_vulnerability' | 'natural_restarts' | 'grandfatherly_processing' | 'research_precision' | 'elderly_warmth' | 'concern_sounds' | 'celebration_warmth' | 'warm_processing';
/**
 ...
 */
export declare const INJECTION_CONFIGS: Record<string, InjectionConfig>;
/**
 * Map persona IDs to their injection config style
 */
export declare const PERSONA_INJECTION_STYLE: Record<string, keyof typeof INJECTION_CONFIGS>;
