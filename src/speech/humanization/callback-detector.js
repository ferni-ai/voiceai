 ...
 */
export function detectCallbackTriggers(userText, personaId) {
 ...
 */
export function selectCallback(triggers, personaId, conversationCount, usedCallbacks) {
    if (triggers.length === 0) {
        return null;
    }
    const profile = getSpeechProfileSync(personaId);
 ...
 */
export function injectCallback(text, callback) {
...
//# sourceMappingURL=callback-detector.js.map