/**
 * Team Huddle Recording
 *
 * Records observations from conversation turns for cross-persona coordination.
 * What Maya notices about habits can inform Peter's research suggestions
 * or Jordan's milestone planning.
 *
 * Extracted from turn-processor.ts for maintainability.
 *
 * @module agents/processors/team-huddle-recording
 */
