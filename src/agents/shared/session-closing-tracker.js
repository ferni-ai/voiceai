 ...
 */
export function markSessionClosing(sessionId) {
 ...
 */
export function isSessionClosing(sessionId) {
 ...
 */
export function clearSessionClosing(sessionId) {
    if (closingSessions.has(sessionId)) {
 ...
 */
export function getClosingSessionCount() {
    return closingSessions.size;
}
//# sourceMappingURL=session-closing-tracker.js.map