 ...
 */
export type AgentRelationship = 'grandmother' | 'grandfather' | 'parent' | 'mother' | 'father' | 'sibling' | 'brother' | 'sister' | 'spouse' | 'partner' | 'child' | 'friend' | 'best_friend' | 'mentor' | 'teacher' | 'coach' | 'therapist' | 'public_figure' | 'historical_figure' | 'self' | 'fictional' | 'other';
/**
 * Privacy level for the agent
 */
export type AgentPrivacy = 'private' | 'shared' | 'public';
/**
 * Status of the agent
 */
 ...
 * Voice source type
 */
export type VoiceSource = 'cloned' | 'selected' | 'generated';
/**
...
export type { CustomAgentType as AgentType, AgentRelationship as Relationship, AgentPrivacy as Privacy, AgentStatus as Status, };
