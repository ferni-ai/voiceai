 ...
 */
export const FOUNDERS_FUND_NAMES = {
    free: 'Community',
...
export const TIER_CONFIGS = {
    ...
    friend: {
        ...
        stripePriceId: process.env.STRIPE_PRICE_FOUNDING_MEMBER ||
            process.env.STRIPE_PRICE_FRIEND ||
            process.env.STRIPE_FRIEND_PRICE_ID ||
            null,
        stripeAnnualPriceId: process.env.STRIPE_PRICE_FOUNDING_MEMBER_ANNUAL ||
    ...
    partner: {
        ...
        stripePriceId: process.env.STRIPE_PRICE_FOUNDING_PATRON ||
            process.env.STRIPE_PRICE_PARTNER ||
            process.env.STRIPE_PARTNER_PRICE_ID ||
            null,
        stripeAnnualPriceId: process.env.STRIPE_PRICE_FOUNDING_PATRON_ANNUAL ||
 ...
 */
export function getTierPrice(tier, frequency) {
 ...
 */
export function getStripePriceId(tier, frequency) {
    const config = TIER_CONFIGS[tier];
    if (frequency === 'annual') {
 ...
 */
export function getAnnualSavingsPercent(tier) {
    const config = TIER_CONFIGS[tier];
 ...
 */
export function formatPrice(cents, frequency = 'monthly', locale = 'en-US', currency) {
 ...
 */
export function formatPriceUSD(cents, frequency = 'monthly') {
 ...
 */
export function calculateUsageStatus(subscription) {
 ...
 */
function getSoftCapMessage(category, variables) {
 ...
 */
export function getLimitMessage(category, variables) {
