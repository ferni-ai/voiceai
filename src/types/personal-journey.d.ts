...
export type RhythmMilestoneType = 'first_conversation' | 'conversation_10' | 'conversation_25' | 'conversation_50' | 'conversation_100' | 'conversation_250' | 'conversation_500' | 'streak_3' | 'streak_7' | 'streak_14' | 'streak_30' | 'streak_60' | 'streak_100' | 'one_week' | 'one_month' | 'three_months' | 'six_months' | 'one_year' | 'two_years';
...
export type JourneyMomentType = 'rhythm_milestone' | 'rhythm_acknowledgment' | 'seasonal_memory' | 'seasonal_pattern' | 'chapter_transition' | 'chapter_reflection' | 'growth_mirror' | 'social_insight' | 'world_awareness' | 'community_wisdom';
/**
...
export type PersonalJourneyInjectionType = 'milestone' | 'rhythm' | 'seasonal' | 'chapter' | 'growth' | 'wisdom';
