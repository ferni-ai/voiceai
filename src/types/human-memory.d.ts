...
export interface ImportantDate {
    id: string;
    /** Type of date */
    type: 'birthday' | 'anniversary' | 'loss_anniversary' | 'milestone' | 'recurring' | 'celebration' | 'custom';
...
export interface HumorProfile {
    ...
    appreciates: Array<'wordplay' | 'self_deprecating' | 'absurdist' | 'dry' | 'warm' | 'sarcastic' | 'dad_jokes' | 'dark' | 'observational'>;
...
export interface ComfortPattern {
    ...
    type: 'validation' | 'problem_solving' | 'distraction' | 'presence' | 'encouragement' | 'perspective' | 'humor' | 'practical_help' | 'space';
...
export interface StressTrigger {
    ...
    trigger: string;
    /** Category of trigger */
    category: 'work' | 'financial' | 'health' | 'relationships' | 'time' | 'uncertainty' | 'social' | 'seasonal' | 'other';
...
export interface Dream {
    ...
    description: string;
    /** Category */
    category: 'career' | 'family' | 'creative' | 'travel' | 'learning' | 'lifestyle' | 'legacy' | 'relationship' | 'health' | 'other';
...
export interface SeasonalPattern {
    ...
    pattern: string;
    /** When it occurs */
    timing: 'spring' | 'summer' | 'fall' | 'winter' | 'holidays' | 'tax_season' | 'school_year' | 'quarterly' | 'monthly' | 'weekly' | 'custom';
