 ...
 */
export function parseNaturalDateTime(input, referenceDate = new Date()) {
 ...
 */
function parseDay(input, reference) {
    // Check for "today"
 ...
 */
function parseTime(input, _reference) {
 ...
 */
export function containsDateTime(input) {
    const normalizedInput = input.toLowerCase();
    return (DAY_PATTERNS.today.test(normalizedInput) ||
