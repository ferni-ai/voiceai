...
const NOT_NAME_WORDS = new Set([
  ...
  'here', 'hear', 'there', 'their', 'theyre', 'they', 'and', 'the', 'but',
  'bought', 'brought', 'thought', 'got', 'going', 'gonna', 'wanna', 'gotta',
  'kinda', 'sorta', 'yeah', 'yep', 'nope', 'well', 'like', 'just', 'really',
  'very', 'actually', 'basically', 'literally', 'probably', 'maybe', 'perhaps',
  'anyway', 'also', 'still', 'even', 'always', 'never', 'sometimes', 'often',
  'usually', 'today', 'tomorrow', 'yesterday', 'now', 'then', 'when', 'where',
  'what', 'which', 'who', 'whom', 'whose', 'why', 'how', 'this', 'that',
  'these', 'those', 'some', 'any', 'every', 'each', 'both', 'few', 'many',
  'much', 'more', 'most', 'other', 'another', 'such', 'same', 'different', 'own',
  // Common verbs
  'said', 'says', 'told', 'asked', 'called', 'went', 'came', 'made', 'took',
  'gave', 'had', 'has', 'have', 'been', 'being', 'was', 'were', 'are', 'is',
  'will', 'would', 'could', 'should', 'might', 'must', 'shall', 'can', 'may',
  // Interjections and fillers
  'oh', 'ah', 'um', 'uh', 'hmm', 'wow', 'ooh', 'oops', 'thing', 'things',
  'stuff', 'something', 'nothing', 'everything', 'someone', 'anyone', 'everyone',
  'nobody', 'somewhere', 'anywhere', 'everywhere', 'nowhere',
]);
