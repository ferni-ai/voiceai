    ...
    async playSound(url, volume = 0.5) {
        ...
        try {
            ...
            this.currentPlayHandle
                ...
                log.debug({ url, error: String(err), elapsedMs }, '🔊 Sound effect waitForPlayout error (non-fatal, sound likely played)');
...
// SINGLETON INSTANCE
// ============================================================================
let soundEffectsPlayerInstance = null;
/**
 * Get the singleton sound effects player instance
 */
export function getSoundEffectsPlayer() {
 ...
 */
export async function initializeSoundEffectsPlayer(room, session) {
 ...
 */
export function resetSoundEffectsPlayer() {
    if (soundEffectsPlayerInstance) {
...
//# sourceMappingURL=sound-effects-player.js.map