 ...
 */
const PERSONA_TRANSITION_PHRASES = {
    ferni: [
 ...
 */
function getPersonaPhrases(personaId, phrases) {
    // Try exact match
 ...
 */
export function getOutroPhrase(context) {
 ...
 */
export function getTransitionPhrase(personaId) {
 ...
 */
export function getDropPhrase(context) {
    const { track, personaId } = context;
 ...
 */
export function getMomentPhrase(momentType, personaId) {
 ...
 */
export function getCheckInPhrase(personaId) {
 ...
 */
function buildInterjectionPrompt(context, moment) {
 ...
 */
export async function generateLLMInterjection(context, moment) {
 ...
 */
export async function prewarmInterjectionCache(context) {
    // Pre-generate for common moments in background
    const moments = ['track_start', 'track_end', 'appreciation'];
 ...
 */
export function clearInterjectionCache() {
 ...
 */
export async function getInterjection(context, moment) {
    // Try LLM first
...
//# sourceMappingURL=dj-speech-engine.js.map