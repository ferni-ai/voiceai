...
export const boundaryCaptureDefinition = {
    id: 'capture_boundary',
    ...
    handler: async (extractedArgs, context) => {
        ...
        // Determine severity
        let severity = 'only_if_they_bring_up';
        if (severityIndicator.includes('never') ||
        ...
        try {
            ...
            log.info({ topic, severity, category, userId: context.userId }, 'Captured boundary from conversation');
...
//# sourceMappingURL=boundary.capture.js.map