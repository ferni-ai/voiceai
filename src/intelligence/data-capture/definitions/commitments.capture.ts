...
export const commitmentCaptureDefinition: DataCaptureDefinition = {
  ...
  handler: async (
    ...
    let commitmentType: 'intention' | 'promise' | 'decision' = 'intention';
    ...
    try {
      ...
      log.info(
        { commitment: cleanCommitment, type: commitmentType, userId: context.userId },
        'Captured commitment from conversation'
      );
