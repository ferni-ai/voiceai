...
function detectRelationshipType(name, context) {
...
export const relationshipCaptureDefinition = {
    ...
    handler: async (extractedArgs, context) => {
        const { personName } = extractedArgs;
        ...
        try {
            ...
            log.info({ name: cleanName, relationship, sentiment, userId: context.userId }, 'Captured relationship mention from conversation');
...
//# sourceMappingURL=relationships.capture.js.map