...
export const conflictCaptureDefinition = {
    id: 'capture_conflict',
    ...
    handler: async (extractedArgs, context) => {
        ...
        const relationship = String(extractedArgs.relationship || '')
            .toLowerCase()
            .trim() || 'other';
        ...
        try {
            ...
            log.info({ person, conflictType, userId: context.userId }, 'Captured conflict from conversation');
...
//# sourceMappingURL=conflict.capture.js.map