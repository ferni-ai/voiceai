...
function classifyDreamType(text) {
...
export const dreamCaptureDefinition = {
    id: 'capture_dream',
    name: 'Dream Capture',
    ...
    handler: async (extractedArgs, context) => {
        ...
        try {
            ...
            log.info({ dream: cleanDream, type: dreamType, userId: context.userId }, 'Captured dream from conversation');
...
//# sourceMappingURL=dreams.capture.js.map