...
// Phase 2: User Trigger Profile Types
export type {
  SignificantDateType,
  SignificantDate,
  RelationshipType,
...
// Phase 3: Temporal Intelligence Types
export type {
  DayOfWeek,
  TimeOfDayBucket,
  TriggerFiringEvent,
...
export {
  ...
  type TriggerContext as SessionTriggerContext,
...
// Phase 5: Anticipatory Trigger Types
export type {
  AnticipatedOutcomeType,
  VoiceProsodyCue,
  AnticipatorySignal,
  AnticipationEvent,
  AnticipationSafeguards,
  AnticipatoryIntelligence,
} from './user-trigger-profile.types.js';

export {
  DEFAULT_ANTICIPATION_SAFEGUARDS,
...
export {
  ...
  type AnticipatoryEngineConfig,

  // Response templates
  DEFAULT_RESPONSE_TEMPLATES,
  type AnticipatoryResponseTemplate,
  type AvatarCue,
