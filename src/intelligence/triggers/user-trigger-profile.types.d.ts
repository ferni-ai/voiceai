 ...
 */
export type SignificantDateType = 'anniversary' | 'birthday' | 'loss' | 'milestone' | 'medical' | 'trauma' | 'celebration' | 'custom';
/**
 ...
 */
export type RelationshipType = 'family' | 'romantic' | 'friend' | 'colleague' | 'mentor' | 'mentee' | 'pet' | 'deceased' | 'estranged' | 'other';
/**
 * Emotional valence of a relationship
 */
export type EmotionalValence = 'very_positive' | 'positive' | 'neutral' | 'complicated' | 'negative' | 'very_negative';
/**
 ...
 */
export type TimeOfDayBucket = 'late_night' | 'early_morning' | 'morning' | 'afternoon' | 'evening' | 'night';
/**
 ...
 */
export type AnticipatedOutcomeType = 'vulnerability' | 'distress' | 'request' | 'celebration' | 'processing' | 'avoidance' | 'unknown';
/**
 ...
 */
export declare const DEFAULT_ANTICIPATION_SAFEGUARDS: AnticipationSafeguards;
/**
 * Default anticipatory intelligence for new users
 */
export declare const DEFAULT_ANTICIPATORY_INTELLIGENCE: AnticipatoryIntelligence;
/**
 ...
 */
export declare const DEFAULT_TEMPORAL_INTELLIGENCE: TemporalIntelligence;
/**
 * Default empty profile for new users
 */
export declare const DEFAULT_USER_TRIGGER_PROFILE: Omit<UserTriggerProfile, 'userId'>;
/**
...
//# sourceMappingURL=user-trigger-profile.types.d.ts.map