 ...
 */
export function checkUpcomingDates(humanMemory, daysAhead = 7) {
    ...
    for (const date of humanMemory.importantDates) {
        ...
        const daysUntil = Math.floor((thisYearDate.getTime() - todayStart.getTime()) / (1000 * 60 * 60 * 24));
 ...
 */
function generateDateInsight(date, daysUntil) {
...
//# sourceMappingURL=date-awareness.js.map