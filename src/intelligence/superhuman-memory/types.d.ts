 ...
 */
import type { ComfortPattern } from '../../types/human-memory.js';
/**
 * A proactive memory insight ready to be surfaced
 */
export interface ProactiveInsight {
    id: string;
    type: 'date_reminder' | 'growth_celebration' | 'comfort_application' | 'topic_absence' | 'inside_joke' | 'seasonal_awareness' | 'voice_pattern';
