 ...
 */
export function analyzeVoiceSignals(context) {
    const signals = {
    ...
    if (context.currentTopic && context.previousTopic) {
        ...
        if (topicSimilarity < 0.3) {
            ...
            log.debug({ current: context.currentTopic, previous: context.previousTopic }, 'Voice signal: Topic change detected');
        }
    }
 ...
 */
export function getAnticipatedNeed(signals) {
    const needs = [];
 ...
 */
export function initializeVoiceTracking(sessionId) {
 ...
 */
export function recordVoiceTurn(sessionId, transcript, options = {}) {
 ...
 */
export function buildSignalContext(sessionId, currentTranscript, options = {}) {
 ...
 */
export function getVoiceSignalsForTurn(sessionId, currentTranscript, options = {}) {
 ...
 */
export function clearVoiceHistory(sessionId) {
