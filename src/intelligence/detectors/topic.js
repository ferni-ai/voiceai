...
export class TopicTracker {
    topics = new Map();
    topicStack = []; // Stack of active topic IDs
    lastTopic = null;
    /**
    ...
    extract(text) {
        ...
        const isTopicShift = detected.length > 0 && this.lastTopic !== null && !detected.includes(this.lastTopic);
        // Update last topic
     ...
     */
    getNeglectedTopics(thresholdMinutes = 10) {
 ...
 */
export function getTopicTracker() {
    if (!defaultTracker) {
