...
// ============================================================================
const EMOTION_TO_COGNITIVE_MAP = {
 ...
 */
export function processVoiceEmotion(signals) {
 ...
 */
export function applyVoiceEmotionToContext(context, signals) {
 ...
 */
export function shouldOverrideStyle(defaultStyle, adjustment) {
 ...
 */
export function getCombinedCognitiveStyle(personaDefaultStyle, voiceAdjustment) {
 ...
 */
export function generateVoiceAwareGuidance(signals) {
    const guidance = [];
    const adjustment = processVoiceEmotion(signals);
...
const sessionVoiceStates = new Map();
/**
 * Track voice emotion over session
 */
export function trackSessionVoiceEmotion(sessionId, signals) {
 ...
 */
export function getSessionVoiceState(sessionId) {
    return sessionVoiceStates.get(sessionId) || null;
}
/**
 * Clear session voice state
 */
export function clearSessionVoiceState(sessionId) {
...
//# sourceMappingURL=voice-emotion-cognitive.js.map