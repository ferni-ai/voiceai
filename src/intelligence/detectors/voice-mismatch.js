...
import { recordInsight } from '../../services/cross-persona-insights.js';
 ...
 */
function calculateHybridConfidence(voiceEmotion, userText, textEmotion) {
...
export function detectMismatch(userText, voiceEmotion, textEmotion) {
    ...
    if (isNeutralEmotion(textPrimary) &&
 ...
 */
export async function recordMismatchInsight(userId, personaId, mismatch) {
 ...
 */
export function buildMismatchGuidance(mismatch) {
...
//# sourceMappingURL=voice-mismatch.js.map