 ...
 */
export function verifyTopicThreading(conversationHistory, topicsToCircleBack) {
    ...
    const circledBackTopics = [];
    const missedTopics = [];
    for (const topic of topicsToCircleBack) {
        const topicLower = topic.toLowerCase();
        const found = assistantMessages.some((msg) => msg.includes(`you mentioned ${topicLower}`) ||
 ...
 */
export function getProactiveGoalReference(profile, currentTopic) {
...
//# sourceMappingURL=topic-management.js.map