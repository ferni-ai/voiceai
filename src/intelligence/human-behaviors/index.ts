...
export {
  ...
  type CulturalMoment,
} from './cultural-moments.js';

export {
  detectUserEngagement,
  type EngagementSignals,
} from './engagement-detection.js';

export {
  getRunningJokeCallback,
  type RunningJoke,
} from './running-jokes.js';

export {
  getSpontaneousThought,
  type SpontaneousThought,
} from './spontaneous-thoughts.js';
...
export const HumanBehaviors = {
  ...
  getRunningJokeCallback: async (
    profile: unknown,
    topic: string,
    personaId?: string
  ) => (await import('./running-jokes.js')).getRunningJokeCallback(profile as import('../../types/user-profile.js').UserProfile | null, topic, personaId),
  ...
  inferUserPreferences: async (msgs: string[], profile: unknown) =>
    (await import('./preference-learning.js')).inferUserPreferences(msgs, profile as import('../../types/user-profile.js').UserProfile | null),
  ...
  getVoiceProsodyResponse: async (voice: unknown) =>
    (await import('./voice-prosody.js')).getVoiceProsodyResponse(voice as Parameters<typeof import('./voice-prosody.js').getVoiceProsodyResponse>[0]),
  ...
  getProactiveGoalReference: async (profile: unknown, topic: string) =>
    (await import('./topic-management.js')).getProactiveGoalReference(profile as import('../../types/user-profile.js').UserProfile | null, topic),
};
