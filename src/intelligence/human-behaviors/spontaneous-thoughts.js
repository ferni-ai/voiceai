...
const FALLBACK_THOUGHTS = {
    ...
    'peter-john': [
        {
            thought: 'I was at the mall yesterday and saw the LONGEST line at a store. You know what that means!',
            trigger: 'random',
        },
        {
    ...
    'alex-chen': [
        ...
        {
            thought: 'My plants are thriving. Turns out they just needed a consistent schedule. Like most things.',
            trigger: 'random',
        },
    ],
};
...
// TIME-BASED THOUGHTS
// ============================================================================
function getTimeBasedThought(personaId) {
 ...
 */
export function getSpontaneousThought(personaId) {
    // Only 5% chance
    if (Math.random() > 0.05)
        return null;
...
//# sourceMappingURL=spontaneous-thoughts.js.map