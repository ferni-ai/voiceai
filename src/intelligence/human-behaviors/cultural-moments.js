...
const FINANCIAL_EVENTS = [
    ...
    },
    {
        ...
        check: (date) => {
            ...
            return ((month === 9 && day === 19) || (month === 2 && day === 9) || (month === 8 && day === 15));
        },
 ...
 */
function isNearHoliday(holiday, date) {
 ...
 */
export async function detectCulturalMoment() {
    const now = new Date();
...
//# sourceMappingURL=cultural-moments.js.map