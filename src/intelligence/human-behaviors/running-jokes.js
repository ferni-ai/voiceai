 ...
 */
export function getRunningJokeCallback(profile, currentTopic, personaId) {
    if (!profile || profile.totalConversations < 2)
        return null;
    // Get persona-specific jokes
    const jokes = personaId && FALLBACK_JOKES[personaId] ? FALLBACK_JOKES[personaId] : FALLBACK_JOKES['ferni'];
...
//# sourceMappingURL=running-jokes.js.map