...
export class HumanizationOrchestrator {
    ...
    // CORE METHODS
    // ============================================================================
    shouldUseFocusedSupportMode(analysis) {
        return Boolean(analysis.guidance.useHighEmotionMode ||
    ...
    buildActiveListeningCues(analysis, focusedSupportMode) {
        const cues = [];
    ...
    buildSpontaneousElements(analysis, persona, turnNumber, sessionCount, relationshipStage) {
        const elements = [];
    ...
    buildToneGuidance(analysis, focusedSupportMode) {
        if (focusedSupportMode) {
    ...
    buildNameUsageGuidance(userName, turnNumber, focusedSupportMode) {
        if (!userName) {
    ...
    buildPromptInjection(params) {
        const { activeListening, emotionalMirror, spontaneousElements, toneGuidance, lengthGuidance, nameUsage, focusedSupportMode, analysis, } = params;
        const sections = [];
...
//# sourceMappingURL=humanization-orchestrator.js.map