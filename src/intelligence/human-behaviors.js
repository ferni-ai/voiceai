 ...
 */
// Re-export everything from the submodule directory
export * from './human-behaviors/index.js';
// Also re-export the default export for backward compatibility
export { default } from './human-behaviors/index.js';
//# sourceMappingURL=human-behaviors.js.map