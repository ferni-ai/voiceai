...
import { HumanizationOrchestrator, } from '../../unified/humanization-orchestrator.js';
...
// CONTEXT BUILDER
// ============================================================================
export const unifiedHumanizingBuilder = {
    ...
    build: async (input) => {
        ...
        const humanizationInput = {
            analysis: {
                emotion: {
                    ...
                    valence: analysis.emotion.valence === 'positive'
                        ? 0.5
                ...
                signals: {
                    ...
                    needsSupport: (analysis.emotion.distressLevel ?? 0) > DISTRESS.MODERATE ||
                ...
                guidance: {
                    ...
                    approach: 'supportive',
                    guidelines: [],
                    useHighEmotionMode: (analysis.emotion.distressLevel ?? 0) >= DISTRESS.HIGH ||
        ...
        if (humanization.promptInjection) {
            if (humanization.focusedSupportMode) {
                ...
                injections.push(createStandardInjection('unified_humanizing', humanization.promptInjection, {
                    category: 'humanizing',
                    confidence: 0.9,
                }));
            }
                ...
                injections.push(createHintInjection('unified_humanizing', humanization.promptInjection, {
                    category: 'humanizing',
                    confidence: 0.8,
                }));
            }
...
function mapRelationshipStage(stage) {
    const stageMap = {
        stranger: 'stranger',
...
function detectPersonalSharing(text, distressLevel) {
...
function detectVenting(text, valence) {
...
//# sourceMappingURL=unified-humanizing.js.map