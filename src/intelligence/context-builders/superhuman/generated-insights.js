...
const recentlySurfaced = new Map();
const SURFACING_COOLDOWN_MS = 5 * 60 * 1000; // 5 minutes
// ============================================================================
// BUILDER
// ============================================================================
export const generatedInsightsBuilder = {
    ...
    build: async (input) => {
        ...
        try {
            ...
            const { getInsightsToSurface, formatInsightsForPrompt, markInsightSurfaced } = await import('../../../services/superhuman/insight-generation/index.js');
 ...
 */
export function clearSurfacingCache() {
...
//# sourceMappingURL=generated-insights.js.map