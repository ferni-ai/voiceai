...
// ============================================================================
export async function computeWisdomMetrics(userId, lifeSynthesis, valuesAlignment) {
    const metrics = {
        lifeIntegration: 50,
        meaningCoherence: 50,
        legacyReadiness: 30,
    ...
    try {
        ...
        const patternBonus = lifeSynthesis.growthPattern === 'integrating'
            ? 30
        ...
        const horizonBonus = lifeSynthesis.timeHorizon === 'long' ? 30 : lifeSynthesis.timeHorizon === 'medium' ? 15 : 0;
        const chapterBonus = ['freedom-seeking', 'creation', 'partnership-building'].includes(lifeSynthesis.lifeChapter)
            ? 20
            : 0;
        ...
        if (moodLogs.length > 0) {
            ...
            metrics.innerPeaceIndex = Math.max(0, Math.min(100, 50 + moodBonus - patternPenalty + conflictCount * -5));
        }
...
//# sourceMappingURL=wisdom-metrics.js.map