...
export function generateDeepQuestions(
  ...
  switch (lifeSynthesis.lifeChapter) {
    ...
    case 'nesting':
      questions.push(
        "What are you building a home for - the person you are or who you're becoming?"
      );
      break;
    case 'partnership-building':
      questions.push(
        'What part of yourself are you bringing to this partnership? What part holding back?'
      );
      break;
    case 'creation':
