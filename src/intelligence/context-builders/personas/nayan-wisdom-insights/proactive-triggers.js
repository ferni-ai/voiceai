...
// ============================================================================
export function detectProactiveTriggers(lifeSynthesis, wisdomMetrics, existentialContext, valuesAlignment) {
    const triggers = [];
    ...
    if (existentialContext.legacyThinking && wisdomMetrics.legacyReadiness < 50) {
        triggers.push({
            type: 'reflection',
            message: 'Legacy thinking emerging but not yet integrated. Help them see how today builds tomorrow.',
            priority: 'medium',
            timing: 'when_ready',
        });
    }
...
//# sourceMappingURL=proactive-triggers.js.map