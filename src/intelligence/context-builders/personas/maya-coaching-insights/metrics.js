...
// ============================================================================
export function computeCoachingMetrics(habitHealth, moodIntelligence) {
    const metrics = {
        consistencyIndex: 0,
        cascadePotential: 0,
        recoverySpeed: 0,
    ...
    const streakRatio = habitHealth.activeHabits > 0 ? (habitHealth.totalStreaks / habitHealth.activeHabits) * 40 : 0;
    ...
    const atRiskRatio = habitHealth.activeHabits > 0 ? 1 - habitHealth.atRiskCount / habitHealth.activeHabits : 1;
    ...
    const trendBonus = moodIntelligence.recentMoodTrend === 'improving'
        ? 30
...
// ============================================================================
export function detectFourTendency(habitHealth) {
