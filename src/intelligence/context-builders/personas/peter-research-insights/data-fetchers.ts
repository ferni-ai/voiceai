...
export async function analyzeSpendingPatterns(userId: string): Promise<string[]> {
...
export async function analyzeGoalTrajectory(userId: string): Promise<string[]> {
  const insights: string[] = [];
...
export async function buildCalendarResearchContext(
  userId: string
