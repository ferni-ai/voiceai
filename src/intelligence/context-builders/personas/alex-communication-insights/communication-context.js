...
// ============================================================================
export function analyzeEmotionalStateForCommunication(emotionalState) {
    const patterns = [];
...
// ============================================================================
export function buildCommunicationContext(handoffContext) {
    const context = {
        pendingFollowUps: [],
    ...
    if (handoffContext.emotionalState) {
        context.communicationPatterns = analyzeEmotionalStateForCommunication(handoffContext.emotionalState);
    }
    return context;
}
//# sourceMappingURL=communication-context.js.map