...
// ============================================================================
export function computeCommunicationMetrics(userState, upcomingPriorities, communicationContext) {
    const metrics = {
    ...
    if (userState.energyLevel === 'high')
        ...
        readinessScore -= 20;
    if (userState.stressLevel === 'low')
        readinessScore += 15;
    else if (userState.stressLevel === 'high')
        readinessScore -= 25;
