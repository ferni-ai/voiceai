...
// PROACTIVE TRIGGERS
// ============================================================================
export function detectProactiveTriggers(userState, metrics, upcomingPriorities, communicationContext) {
    const triggers = [];
    // Follow-up triggers
    ...
    const celebrations = upcomingPriorities.filter((p) => p.type === 'event' && p.description.includes('🎉'));
    ...
    else if (communicationContext.recentDifficultTopics.length > 0 &&
