...
// FAILURE FORMATTER
// ============================================================================
function formatFailureForLLM(failures) {
    if (failures.length === 0)
        return '';
    const parts = ['[TOOL FAILURE - ACKNOWLEDGE HONESTLY]'];
...
// CONTEXT BUILDER
// ============================================================================
async function buildToolFailureAwareness(input) {
...
// REGISTRATION
// ============================================================================
export const toolFailureAwarenessBuilder = {
...
//# sourceMappingURL=tool-failure-awareness.js.map