...
import { createInjection, registerContextBuilder, } from '../index.js';
...
const CORE_CAPABILITIES = [
    {
        ...
        whenToUse: 'TRIGGERS: "play some music", "play [artist]", "play [song]", "I\'m stressed", "help me relax", "put on something [mood]", user seems anxious/overwhelmed. → Brief DJ intro then call playMusic.',
    },
    {
        id: 'weather',
        emoji: '🌤️',
        ...
        whenToUse: 'TRIGGERS: "what\'s the weather", "is it going to rain", "should I bring umbrella", "how cold/hot is it", "weather forecast". → Ask for location if unclear.',
    },
    {
        id: 'search',
        emoji: '🔍',
        ...
        whenToUse: 'TRIGGERS: "look up", "search for", "what is [X]", "who is [X]", "when did [X]", "can you find", any factual question you\'re unsure about. → Don\'t guess facts, search instead.',
    },
    {
        id: 'news',
        emoji: '📰',
        ...
        whenToUse: 'TRIGGERS: "what\'s in the news", "what\'s happening", "current events", "any news about [topic]".',
    },
    {
        id: 'memory',
        emoji: '🧠',
        ...
        whenToUse: 'TRIGGERS: User shares important personal info (name, family, job, goals), "what do you remember about me", "do you know my [X]".',
    },
    {
        id: 'games',
        emoji: '🎮',
        ...
        whenToUse: 'TRIGGERS: "play a game", "I\'m bored", "name that tune", "tic tac toe", "desert island discs", lighter moments, lulls in conversation.',
    },
    {
        id: 'cameo',
        emoji: '🎬',
        ...
        whenToUse: 'TRIGGERS: Topic in someone\'s domain but doesn\'t need full handoff, "what would [name] say", want to celebrate (Jordan!), quick wisdom (Nayan), introduce a team member.',
    },
];
/**
...
const TEAM_CAPABILITIES = [
    {
        ...
        whenToUse: 'TRIGGERS: "budget", "spending", "habits", "saving money", "track expenses", "financial goals". → Call immediately, don\'t speak first.',
    },
    {
        id: 'team-alex',
        emoji: '📅',
        ...
        whenToUse: 'TRIGGERS: "calendar", "schedule", "email", "meeting", "appointment", "time management". → Call immediately, don\'t speak first.',
    },
    {
        id: 'team-peter',
        emoji: '📈',
        ...
        whenToUse: 'TRIGGERS: "stocks", "investments", "portfolio", "market", "research [company]", "should I buy/sell". → Call immediately, don\'t speak first.',
    },
    {
        id: 'team-jordan',
        emoji: '🎉',
        ...
        whenToUse: 'TRIGGERS: "wedding", "birthday party", "graduation", "anniversary", "planning an event", "celebration". → Call immediately, don\'t speak first.',
    },
    {
        id: 'team-nayan',
        emoji: '🧘',
        ...
        whenToUse: 'TRIGGERS: "meaning of life", "philosophy", "wisdom", "why am I here", "existential", "deeper questions". → Call immediately, don\'t speak first.',
    },
];
// ============================================================================
// CONTEXT BUILDER
 ...
 */
function buildCapabilitiesSection(availableTools, personaId) {
    const lines = [];
...
export const toolCapabilitiesBuilder = {
    ...
    build: async (input) => {
        ...
        log.debug({ personaId, turnCount, toolCount: availableTools.size }, '🛠️ Injecting tool capabilities section');
        return [
...
//# sourceMappingURL=tool-awareness.js.map