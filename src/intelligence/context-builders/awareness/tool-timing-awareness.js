...
const sessionToolTimings = new Map();
/**
 * Record a tool execution timing for context injection.
 * Call this when a tool completes.
 */
export function recordToolTiming(sessionId, toolName, durationMs, userEmotion) {
 ...
 */
export function getRecentToolTimings(sessionId) {
    const timings = sessionToolTimings.get(sessionId) || [];
 ...
 */
export function clearToolTimings(sessionId) {
 ...
 */
function generateFramingHint(timing) {
    ...
    const emotionNote = userEmotion === 'anxious' || userEmotion === 'stressed' ? ' Be warm and reassuring.' : '';
 ...
 */
function generateTimingContext(timings) {
...
// CONTEXT BUILDER
// ============================================================================
export const toolTimingContextBuilder = {
...
//# sourceMappingURL=tool-timing-awareness.js.map