...
// DATA LOADERS
// ============================================================================
async function loadCapturedData(userId) {
...
// CONTEXT BUILDER
// ============================================================================
function formatCapturedDataContext(data) {
    const parts = [];
    // Contacts
...
async function buildCapturedDataAwareness(input) {
...
// REGISTRATION
// ============================================================================
export const capturedDataAwarenessBuilder = {
...
//# sourceMappingURL=captured-data-awareness.js.map