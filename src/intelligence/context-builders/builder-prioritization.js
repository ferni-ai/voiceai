...
export function setPrioritizationConfig(newConfig) {
    config = { ...config, ...newConfig };
}
export function getPrioritizationConfig() {
    return { ...config };
}
// ============================================================================
 ...
 */
function calculateBuilderRelevance(builder, input) {
 ...
 */
export function prioritizeBuilders(builders, input) {
 ...
 */
export function recordPrioritizationResult(result) {
    metrics.totalRuns++;
 ...
 */
export function getPrioritizationMetrics() {
    return { ...metrics };
}
/**
 * Reset prioritization metrics (for testing).
 */
export function resetPrioritizationMetrics() {
    metrics.totalRuns = 0;
...
//# sourceMappingURL=builder-prioritization.js.map