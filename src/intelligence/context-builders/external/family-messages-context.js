 ...
 */
export const familyMessagesContextBuilder = {
    ...
    build: async (input) => {
        ...
        try {
            ...
            injections.push(createStandardInjection('family_messages_pending', `[FAMILY MESSAGES - DELIVER NATURALLY]
...
The messages will be marked as delivered after this conversation.`, {
            ...
            injections.push(createStandardInjection('family_messages_data', `[FAMILY MESSAGE DATA]
${JSON.stringify(pendingMessages.map((m) => ({
                id: m.id,
                from: m.fromName,
...
//# sourceMappingURL=family-messages-context.js.map