...
import { hasBiometricsConnected, getCurrentBiometrics, generateBiometricInsight, generateSuperhumanMoment, } from '../../../services/biometrics/index.js';
...
const recentMoments = new Map(); // sessionId -> last moment timestamp
 ...
 */
export const biometricsBuilder = {
    name: 'biometrics',
    ...
    build: async (input) => {
        ...
        if (insight) {
            ...
            log.debug({ userId, type: insight.type, confidence: insight.confidence }, 'Biometrics context injected');
        }
