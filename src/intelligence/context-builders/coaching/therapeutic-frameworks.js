...
import { buildTherapeuticContext, } from '../../../services/therapeutic-frameworks/index.js';
 ...
 */
async function buildTherapeuticFrameworksContext(input) {
    ...
    for (const part of result.contextParts) {
        ...
        const isHighPriority = result.primaryRecommendation === 'dbt_skill' || (analysis?.emotion?.intensity || 0) > 0.7;
...
//# sourceMappingURL=therapeutic-frameworks.js.map