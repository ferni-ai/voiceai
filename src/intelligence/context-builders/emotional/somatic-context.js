...
import { selectExercise, detectNervousSystemState, } from '../../../services/somatic-intelligence/index.js';
...
const recentSuggestions = new Map();
// ============================================================================
// CONTEXT BUILDER
// ============================================================================
/**
 ...
 */
async function buildSomaticContext(input) {
    ...
    const shouldSuggestSomatic = checkSomaticTriggers(lowerText, analysis?.emotion?.primary, analysis?.emotion?.intensity);
    ...
    const injection = buildSomaticInjection(exercise, nervousSystemState, analysis?.emotion?.intensity || 0.5);
 ...
 */
function checkSomaticTriggers(text, emotion, emotionIntensity) {
 ...
 */
function buildSomaticInjection(exercise, state, intensity) {
    const lines = [];
...
//# sourceMappingURL=somatic-context.js.map