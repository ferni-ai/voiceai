 ...
 */
export function analyzeVoiceEmotionIntelligence(voiceEmotion, textEmotion, _turnCount = 0) {
 ...
 */
function getDeliveryAdjustments(voice, priority) {
 ...
 */
function createAlignedResponse(voice, text) {
 ...
 */
function createVoiceOnlyResponse(voice) {
 ...
 */
export function formatVoiceIntelligenceForPrompt(intelligence) {
...
//# sourceMappingURL=voice-emotion-intelligence.js.map