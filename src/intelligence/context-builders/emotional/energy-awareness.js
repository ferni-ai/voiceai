 ...
 */
const PERSONA_ENERGY_EXPRESSIONS = {
    ferni: {
        low: [
...
// ============================================================================
async function buildEnergyAwareness(input) {
    ...
    switch (timeEnergy.level) {
        ...
        case 'declining':
            expression =
                personaExpressions.declining[Math.floor(Math.random() * personaExpressions.declining.length)];
            break;
    }
    ...
    if (expression) {
        ...
        getLogger().debug({ personaId, energyLevel: timeEnergy.level, expression }, 'Energy awareness injected');
    }
    return injections;
}
// ============================================================================
...
//# sourceMappingURL=energy-awareness.js.map