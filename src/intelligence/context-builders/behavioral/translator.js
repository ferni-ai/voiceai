 ...
 */
export function translateContextToSignals(contextString, source = 'legacy') {
    const signals = {
        source,
 ...
 */
export function translateContextsToSignals(contexts) {
 ...
 */
export function wrapLegacyBuilder(legacyBuild, builderName) {
    return async (input) => {
        try {
 ...
 */
export function sanitizeContextForSafety(contextString) {
