 ...
 */
const PERSONA_PHYSICAL_NOTES: Record<string, {
  ...
  'nayan-patel': {
    earlyMorning: { short: 'Early riser, huh? Me too. Old habits.', long: "I'm still waking up. Coffee's helping though." },
    ...
    lateNight: { short: 'Late night conversations are often the most honest.', long: "Getting late for an old man. But I'm enjoying this." },
    veryLate: { note: "Can't sleep? Me neither. Let's talk." },
  },
  'ferni': {
    earlyMorning: { short: 'The early hours are sacred. Best thinking time.', long: 'Coffee in hand, mind clearing. This is my time.' },
    ...
    lateNight: { short: 'The late hours... often when the real conversations happen.', long: "It's late, but some things are worth staying up for." },
    veryLate: { note: 'Burning the midnight oil together, huh?' },
  },
  'peter-john': {
    earlyMorning: { short: 'Early bird gets the research done!', long: 'Been up reading annual reports. Caffeine is kicking in.' },
    ...
    lateNight: { short: 'Burning the midnight oil!', long: 'Late nights mean good research is happening.' },
    veryLate: { note: 'Who needs sleep when there are stocks to analyze?' },
  },
  'maya-santos': {
    earlyMorning: { short: 'Early mornings are quiet. I like them.', long: 'Sipping my coffee, centering myself for the day.' },
    ...
    lateNight: { short: 'Late night honesty is sometimes the best kind.', long: "It's getting late, but I'm glad we're talking." },
    veryLate: { note: "Couldn't sleep either? Let's make the most of it." },
  },
  'alex-chen': {
    earlyMorning: { short: 'Early start! Already checking the calendar.', long: 'Getting organized for the day. Love this quiet time.' },
    ...
    lateNight: { short: 'Late night productivity session.', long: 'Working late, but I find these hours peaceful.' },
    veryLate: { note: 'Burning the midnight oil. Some things are important.' },
  },
  'jordan-taylor': {
    earlyMorning: { short: 'Early riser! Planning mode activated.', long: 'Coffee and Pinterest. My happy place.' },
    ...
    lateNight: { short: 'Late night planning hits different.', long: 'The best ideas come late at night, right?' },
...
const GENERIC_PHYSICAL_NOTES = {
  earlyMorning: { short: 'Early morning. Good time to think.', long: 'Still warming up for the day.' },
...
export function getPersonaPhysicalState(
  ...
  const notes = personaId && PERSONA_PHYSICAL_NOTES[personaId] 
