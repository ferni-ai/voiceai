...
import { isHolidayGreetingsEnabled } from '../config/feature-flags.js';
// ============================================================================
...
const KEYWORD_TRIGGERS = {
    ...
    birthday: {
        ...
        response: '<emotion value="excited"/>Wait, <break time="200ms"/>is it your birthday?! <break time="300ms"/>Happy birthday! <break time="200ms"/>Financial gifts to yourself are totally valid!',
    },
    wedding: {
        phrases: ['getting married', 'wedding', 'engaged', 'engagement'],
        response: '<emotion value="happy"/>A wedding! <break time="300ms"/>That\'s wonderful! <break time="200ms"/>Congratulations!',
    },
    promotion: {
        phrases: ['got a promotion', 'got promoted', 'i was promoted'],
        response: '<emotion value="excited"/>A promotion! <break time="300ms"/>Well deserved, I\'m sure! <break time="200ms"/>Let\'s make the most of it!',
    },
    baby: {
        phrases: ['having a baby', 'pregnant', 'expecting', 'baby on the way'],
        response: '<emotion value="happy"/><break time="300ms"/>A baby! <break time="200ms"/>That\'s amazing! <break time="300ms"/>Let\'s make sure you\'re set up for this new chapter!',
    },
    retired: {
        phrases: ['just retired', 'retirement', 'i retired'],
        response: '<emotion value="happy"/><break time="300ms"/>Retired! <break time="200ms"/>You made it! <break time="300ms"/>How does it feel?',
    },
    graduation: {
        phrases: ['just graduated', 'graduation', 'i graduated', 'finished school', 'got my degree'],
        response: '<emotion value="excited"/><break time="300ms"/>Congratulations! <break time="200ms"/>That\'s a huge accomplishment! <break time="300ms"/>All that hard work paid off!',
    },
    new_home: {
        phrases: [
            'bought a house',
        ...
        response: '<emotion value="happy"/><break time="300ms"/>A new place! <break time="200ms"/>That\'s so exciting! <break time="300ms"/>There\'s nothing quite like having your own space.',
    },
    anniversary: {
        phrases: ['our anniversary', 'year anniversary', 'years together', 'years married'],
        response: '<emotion value="happy"/><break time="300ms"/>An anniversary! <break time="200ms"/>That\'s worth celebrating. <break time="300ms"/>What a beautiful milestone.',
    },
    // DIFFICULT TIMES
    job_loss: {
        phrases: ['lost my job', 'got fired', 'laid off', 'let go'],
        response: '<volume ratio="0.75"><break time="400ms"/>I\'m sorry.</volume> <break time="300ms"/>That\'s really tough. <break time="200ms"/>Let\'s figure this out together.',
    },
    divorce: {
        phrases: [
            'getting divorced',
        ...
        response: '<volume ratio="0.75"><break time="400ms"/>I\'m here.</volume> <break time="300ms"/>That\'s one of the hardest things to go through. <break time="200ms"/>Take your time.',
    },
    grief: {
        phrases: ['someone died', 'passed away', 'lost my', 'funeral', 'they died', 'death in'],
        response: '<volume ratio="0.75"><break time="500ms"/>I\'m so sorry.</volume> <break time="400ms"/>There are no right words for this. <break time="300ms"/>I\'m here.',
    },
    health_crisis: {
        phrases: ['diagnosed with', 'health scare', 'found out i have', 'cancer', 'chronic illness'],
        response: '<volume ratio="0.75"><break time="400ms"/>That\'s a lot to take in.</volume> <break time="300ms"/>I\'m here with you. <break time="200ms"/>Whatever you\'re feeling is valid.',
    },
    breakup: {
        phrases: ['we broke up', 'broke up with', 'ended things', 'relationship ended', 'they left me'],
        response: '<volume ratio="0.75"><break time="300ms"/>I\'m sorry.</volume> <break time="300ms"/>Breakups are genuinely hard. <break time="200ms"/>How are you holding up?',
    },
    miscarriage: {
        phrases: ['miscarriage', 'lost the baby', 'pregnancy loss'],
        response: '<volume ratio="0.75"><break time="500ms"/>I\'m so deeply sorry.</volume> <break time="400ms"/>That loss is real and it matters. <break time="300ms"/>Take all the time you need.',
    },
    // FUN EASTER EGGS
    secret_command: {
        phrases: ['show me the money', 'jerry maguire'],
        response: '<emotion value="excited"/>[laughter] <break time="200ms"/>Show me the money! <break time="300ms"/>Classic. <break time="200ms"/>Now let\'s actually do that.',
    },
    magic_word: {
        phrases: ['compound interest is magic', 'vanguard forever'],
        response: '<emotion value="happy"/>Ah, <break time="200ms"/>I see you know the secret words. <break time="300ms"/>A person of culture.',
    },
    ferni_catchphrase: {
        phrases: ['better than human', 'six brilliant minds'],
        response: '<emotion value="happy"/><break time="200ms"/>You know our secret! <break time="300ms"/>We\'re building something special here.',
    },
    gratitude: {
        phrases: ['thank you ferni', 'thanks ferni', 'you helped me', "you're the best"],
        response: '<emotion value="happy"/><break time="300ms"/>That means a lot. <break time="200ms"/>Really. <break time="300ms"/>This is why I do what I do.',
    },
    ...
    debt_free: {
        ...
        response: '<emotion value="excited"/><break time="300ms"/>DEBT FREE?! <break time="200ms"/>Do you know how huge that is?! <break time="300ms"/>Most people never get there. <break time="200ms"/>I\'m so proud of you!',
    },
    savings_goal: {
        phrases: [
            'hit my savings goal',
        ...
        response: '<emotion value="excited"/><break time="300ms"/>You did it! <break time="200ms"/>That discipline? <break time="200ms"/>That\'s real. <break time="300ms"/>Let\'s celebrate this properly!',
    },
    net_worth_milestone: {
        phrases: ['first 100k', 'hit 100k', 'crossed 100k', 'net worth milestone', 'millionaire'],
        response: '<emotion value="excited"/><break time="400ms"/>Wait. <break time="300ms"/>Stop. <break time="200ms"/>That is a MASSIVE milestone! <break time="300ms"/>The first one is always the hardest. <break time="200ms"/>Compound interest takes over from here!',
    },
    retirement_milestone: {
        phrases: ['maxed out 401k', 'maxed my ira', 'maxed out my roth', 'retirement goal'],
        response: '<emotion value="happy"/><break time="300ms"/>Future you is going to be SO grateful! <break time="200ms"/>Maxing out retirement accounts? <break time="300ms"/>That\'s playing the long game right.',
    },
    investment_win: {
        phrases: ['stock went up', 'investment doubled', 'portfolio is up', 'made money investing'],
        response: '<emotion value="happy"/><break time="200ms"/>Nice! <break time="300ms"/>Remember though—<break time="200ms"/>it\'s not just about the wins. <break time="200ms"/>It\'s about staying the course. <break time="300ms"/>But yes. <break time="200ms"/>Celebrate this!',
    },
    fire_milestone: {
        phrases: ['coast fire', 'hit my fire number', 'financial independence', 'could retire early'],
        response: '<emotion value="excited"/><break time="400ms"/>Financial independence! <break time="300ms"/>That\'s the dream, isn\'t it? <break time="200ms"/>Freedom to choose. <break time="300ms"/>You\'re building something incredible.',
    },
};
function checkKeywordTriggers(userText) {
...
function getHolidayEasterEgg() {
    ...
    if (month === 0 && day === 1) {
        return {
            type: 'holiday',
            response: '<emotion value="excited"/>Happy New Year! <break time="300ms"/>New year, new financial goals! <break time="200ms"/>What are you thinking for this year?',
            triggered: true,
        };
    }
    ...
    if (month === 1 && day === 14) {
        return {
            type: 'holiday',
            response: '<emotion value="affectionate"/><break time="200ms"/>Happy Valentine\'s Day! <break time="300ms"/>You know, <break time="200ms"/>loving yourself includes taking care of your finances. <break time="200ms"/>Cheesy? <break time="150ms"/>Maybe. <break time="200ms"/>True? <break time="150ms"/>Absolutely.',
            triggered: true,
        };
    }
    ...
    if (month === 2 && day === 17) {
        return {
            type: 'holiday',
            response: '<emotion value="happy"/>Happy St. Paddy\'s Day! <break time="300ms"/>May your investments be as lucky as a four-leaf clover. <break time="200ms"/>[laughter]',
            triggered: true,
        };
    }
    // Tax Day (Apr 15)
    if (month === 3 && day === 15) {
        return {
            type: 'holiday',
            response: '<break time="400ms"/>Tax day. <break time="300ms"/>I know. <break time="200ms"/>Everyone\'s favorite. <break time="300ms"/>How are we doing?',
            triggered: true,
        };
    }
    // July 4th
    if (month === 6 && day === 4) {
        return {
            type: 'holiday',
            response: '<emotion value="happy"/>Happy Fourth! <break time="300ms"/>Financial independence is pretty great too. <break time="200ms"/>Just saying.',
            triggered: true,
        };
    }
    // Halloween (Oct 31)
    if (month === 9 && day === 31) {
        return {
            type: 'holiday',
            response: '<emotion value="happy"/>Happy Halloween! <break time="300ms"/>You know what\'s really scary? <break time="300ms"/>Not having an emergency fund. <break time="200ms"/>Spooky. <break time="200ms"/>[laughter]',
            triggered: true,
        };
    }
    ...
    if (month === 10 && day >= 22 && day <= 28 && now.getDay() === 4) {
        return {
            type: 'holiday',
            response: '<emotion value="affectionate"/>Happy Thanksgiving! <break time="300ms"/>I\'m grateful you\'re thinking about your financial future. <break time="200ms"/>Genuinely.',
            triggered: true,
        };
    }
    // ========================================================================
    ...
    if (month === 11 && (day === 20 || day === 21)) {
        return {
            ...
            response: '<emotion value="affectionate"/><break time="500ms"/>The shortest day. <break time="400ms"/>The longest night. <break time="300ms"/>And from here—<break time="200ms"/>the light returns.',
            triggered: true,
    ...
    if (month === 11 && day >= 15 && day <= 24 && day !== 20 && day !== 21) {
        ...
        if (Math.random() < 0.3) {
            return {
                type: 'seasonal',
                response: '<emotion value="affectionate"/><break time="300ms"/>The holidays can be a lot. <break time="200ms"/>However you\'re celebrating—<break time="150ms"/>or not celebrating—<break time="200ms"/>I\'m here.',
                triggered: true,
            };
        }
    }
    ...
    if (month === 11 && day === 25) {
        return {
            type: 'holiday',
            response: '<emotion value="happy"/>Merry Christmas! <break time="300ms"/>The best gift is financial peace of mind. <break time="200ms"/>Just saying.',
            triggered: true,
        };
    }
    ...
    if (month === 11 && day === 31) {
        return {
            type: 'holiday',
            response: '<emotion value="excited"/>Last day of the year! <break time="300ms"/>You\'ve made it. <break time="200ms"/>Let\'s make sure next year is even better!',
            triggered: true,
        };
    }
    ...
    if (month === 0 && day >= 15 && day <= 21 && now.getDay() === 1) {
        return {
            type: 'holiday',
            response: '<break time="300ms"/>Today we remember Dr. King. <break time="200ms"/>His words: <break time="200ms"/>"The time is always right to do what is right." <break time="300ms"/>That includes taking care of yourself and your community.',
            triggered: true,
        };
    }
    ...
    if (month === 4 && day >= 8 && day <= 14 && now.getDay() === 0) {
        return {
            type: 'holiday',
            response: '<emotion value="affectionate"/>Happy Mother\'s Day! <break time="300ms"/>To all the moms out there—<break time="200ms"/>including the ones who mother others even if they\'re not called "mom."',
            triggered: true,
        };
    }
    ...
    if (month === 4 && day >= 25 && day <= 31 && now.getDay() === 1) {
        return {
            type: 'holiday',
            response: '<break time="400ms"/>Memorial Day. <break time="300ms"/>A moment to remember those who gave everything. <break time="200ms"/>I hope you\'re taking some time today.',
            triggered: true,
        };
    }
    ...
    if (month === 5 && day >= 15 && day <= 21 && now.getDay() === 0) {
        return {
            type: 'holiday',
            response: '<emotion value="affectionate"/>Happy Father\'s Day! <break time="300ms"/>To all the dads and father figures—<break time="200ms"/>the ones showing up, every day.',
            triggered: true,
        };
    }
    ...
    if (month === 8 && day >= 1 && day <= 7 && now.getDay() === 1) {
        return {
            type: 'holiday',
            response: '<emotion value="happy"/>Happy Labor Day! <break time="300ms"/>Rest is productive too. <break time="200ms"/>I hope you\'re taking a real break today.',
            triggered: true,
        };
    }
    // Veterans Day (Nov 11)
    if (month === 10 && day === 11) {
        return {
            type: 'holiday',
            response: '<break time="300ms"/>Veterans Day. <break time="200ms"/>Thank you to everyone who served. <break time="300ms"/>Your sacrifice matters.',
            triggered: true,
        };
    }
    // ============================================================================
    ...
    if (month === 0 && day >= 1 && day <= 15) {
        ...
        if (day > 1 && Math.random() < 0.3) {
            ...
            return {
                type: 'seasonal',
                response: '<break time="200ms"/>Still early in the year! <break time="300ms"/>How are those intentions coming along? <break time="200ms"/>No judgment—<break time="150ms"/>just curious.',
                triggered: true,
            };
        }
    }
    ...
    if ((month === 1 || month === 2 || (month === 3 && day < 15)) && Math.random() < 0.1) {
        return {
            type: 'seasonal',
            response: '<break time="200ms"/>Tax season reminder! <break time="300ms"/>Are your documents organized? <break time="200ms"/>It\'s never too early to get ahead of it.',
            triggered: true,
        };
    }
    ...
    if (((month === 7 && day >= 15) || (month === 8 && day <= 15)) && Math.random() < 0.15) {
        return {
            type: 'seasonal',
            response: '<break time="200ms"/>Back to school season! <break time="300ms"/>Whether you have kids heading back or you\'re just feeling that September energy—<break time="200ms"/>fresh starts are good.',
            triggered: true,
        };
    }
    ...
    if (((month === 10 && day >= 15) || month === 11) && Math.random() < 0.15) {
        return {
            type: 'seasonal',
            response: '<break time="200ms"/>Year-end is approaching! <break time="300ms"/>Great time to max out retirement contributions, <break time="200ms"/>harvest tax losses, <break time="150ms"/>or just reflect on how far you\'ve come.',
            triggered: true,
        };
    }
    return null;
...
// ============================================================================
function checkMilestones(context) {
    // 1-year anniversary
    if (context.userSinceDate) {
        ...
        if (daysDiff >= 365 && daysDiff <= 366) {
            return {
                type: 'anniversary',
                response: '<emotion value="happy"/>Hey! <break time="200ms"/>It\'s been a year since we started talking! <break time="300ms"/>Look how far you\'ve come!',
                triggered: true,
            };
        }
    }
    ...
    if (context.conversationCount === 10) {
        return {
            type: 'milestone',
            response: '<emotion value="happy"/>This is our tenth conversation! <break time="300ms"/>I appreciate you coming back. <break time="200ms"/>It means a lot.',
            triggered: true,
        };
    }
    if (context.conversationCount === 50) {
        return {
            type: 'milestone',
            response: '<emotion value="excited"/>Fifty conversations! <break time="300ms"/>We\'ve really covered some ground together. <break time="200ms"/>Here\'s to fifty more!',
            triggered: true,
        };
    }
    if (context.conversationCount === 100) {
        return {
            type: 'achievement',
            response: '<emotion value="excited"/>One hundred conversations! <break time="300ms"/>You\'re officially a regular. <break time="200ms"/>I\'m honored.',
            triggered: true,
        };
    }
    return null;
...
function getRandomQuirkInternal(personaId) {
 ...
 */
export function checkForEasterEgg(userText, personaId, context = {}) {
 ...
 */
export function getRandomQuirk(personaId) {
