 ...
 */
export const ALL_CANONICAL_IDS = Object.values(CANONICAL_IDS);
// ============================================================================
 ...
 */
export const CANONICAL_TO_FRONTEND = {
    ferni: 'ferni',
...
export function isCanonicalId(id) {
    return ALL_CANONICAL_IDS.includes(id);
}
/**
 ...
 */
export function toCanonical(id, strict = false) {
 ...
 */
export function fromFrontend(frontendId) {
 ...
 */
export function assertCanonical(id, context) {
    if (!isCanonicalId(id)) {
        const canonical = toCanonical(id);
 ...
 */
export function validateAndLog(id, context) {
    const canonical = toCanonical(id);
    if (id !== canonical) {
 ...
 */
export function isSamePersona(id1, id2) {
...
//# sourceMappingURL=persona-ids.js.map