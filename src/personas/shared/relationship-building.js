 ...
 */
export function generateCallback(profile) {
 ...
 */
export function getDeepeningQuestion(stage) {
    switch (stage) {
 ...
 */
export function getAcknowledgment(type) {
    switch (type) {
        case 'personal':
 ...
 */
export function getNameUsage(name, context) {
    const patterns = {
        greeting: [
