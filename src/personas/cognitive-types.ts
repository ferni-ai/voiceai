...
// ============================================================================
// REASONING STYLE - How the persona processes information
// ============================================================================
...
// ============================================================================
// ATTENTION PATTERNS - What the persona naturally notices
// ============================================================================
...
export type AttentionFocus =
  | 'emotions' // Feelings, emotional undertones
  | 'patterns' // Data patterns, recurring themes
  | 'relationships' // People, connections, dynamics
  | 'systems' // Processes, structures, organization
  | 'meaning' // Purpose, why, significance
  | 'actions' // What to do, next steps
  | 'possibilities' // Options, alternatives, futures
  | 'history' // Past, context, how we got here
  | 'details' // Specifics, numbers, facts
  | 'big_picture' // Overview, strategy, vision
  | 'risks' // What could go wrong
  | 'opportunities'; // What could go right

// ============================================================================
// THEORY OF MIND - Modeling what the user knows
// ============================================================================
...
// ============================================================================
// COGNITIVE BIASES - Humanizing blind spots
// ============================================================================
...
export type CognitiveBiasType =
  | 'optimism_bias' // Tends to see the positive (Ferni)
  | 'data_over_feeling' // Prioritizes numbers over emotions (Peter)
  | 'efficiency_tunnel' // Over-focuses on optimization (Alex)
  | 'empathy_projection' // Assumes others feel as they would (Maya)
  | 'planning_fallacy' // Underestimates complexity (Jordan)
  | 'hindsight_clarity' // "It was obvious in retrospect" (Nayan)
  | 'action_bias' // Prefers doing over waiting
  | 'analysis_paralysis' // Over-thinks before acting
  | 'novelty_seeking' // Prefers new approaches
  | 'status_quo_bias' // Prefers proven methods
  | 'confirmation_seeking' // Notices supporting evidence more
  | 'recency_weighting'; // Over-weights recent events
...
// ============================================================================
// INFORMATION PROCESSING - Dual process theory
// ============================================================================
