 ...
 */
export function addHabitVocabulary(text, _emotion) {
    let result = text;
    const habitTerms = [
 ...
 */
export function addEncouragementWarmth(text, emotion) {
    let result = text;
 ...
 */
export function addPracticalWisdomCadence(text, _emotion) {
    let result = text;
    const wisdomIntros = [
 ...
 */
export function addVulnerabilityAuthenticity(text, _emotion) {
    let result = text;
 ...
 */
export function addMetricEmphasis(text, emotion) {
    let result = text;
    ...
    result = result.replace(/\b(\d+)\s*(day|week|month)s?\s*(streak|in a row|straight|consecutive)\b/gi, (match) => {
    ...
    result = result.replace(/\b(\d+)\s*%?\s*(better|improvement|increase|more|growth)\b/gi, (match) => {
 ...
 */
export function addActiveListening(text, emotion) {
    let result = text;
 ...
 */
export function addGentleChallenge(text, _emotion) {
    let result = text;
 ...
 */
export function addCulturalWarmth(text, _emotion) {
    let result = text;
 ...
 */
export function addActiveListeningInjection(text, emotion) {
    let result = text;
 ...
 */
export function addSoftPresence(text, _emotion) {
    let result = text;
 ...
 */
export function addCelebrationInterrupts(text, emotion) {
    let result = text;
 ...
 */
export function addGrandmotherWisdom(text, _emotion) {
    let result = text;
 ...
 */
export function addProgressNotice(text, emotion) {
    let result = text;
 ...
 */
export function addDynamicEnergyBuilds(text, _emotion) {
    let result = text;
 ...
 */
export function applyMayaSantosSpeechTraits(text, emotion, _baseSpeed, _laughterCount) {
    let processedText = text;
    // TIER 0: CONTEXT-SENSITIVE PRESENCE
    // Check for struggle content first - apply slowest speeds
    const isStruggleContent = /\b(struggling|rock bottom|lowest|fell off|gave up|can['']t do|failed|overwhelmed|shame)\b/i.test(text);
    ...
    const isLateNightContent = /\b(late|can['']t sleep|what['']s keeping you up|no rush)\b/i.test(text);
