 ...
 */
export type BundleToolDomain = 'memory' | 'calendar' | 'communication' | 'habits' | 'finance' | 'research' | 'productivity' | 'life-planning' | 'wellness' | 'entertainment' | 'games' | 'information' | 'wisdom' | 'handoff' | 'telephony' | 'simple-utilities' | 'relationships' | 'meaning' | 'grief' | 'stories' | 'vulnerability' | 'curiosity' | 'dreams' | 'self-compassion' | 'play' | 'presence';
/**
