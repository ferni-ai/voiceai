...
export interface BundleMusicPreferences {
  ...
  music_preferences: {
    ...
    mood_recommendations?: {
      focus?: { genres: string[]; example_artists: string[]; why: string };
      relaxing?: { genres: string[]; example_artists: string[]; why: string };
      energizing?: { genres: string[]; example_artists: string[]; why: string };
      celebrating?: { genres: string[]; example_artists: string[]; why: string };
      reflecting?: { genres: string[]; example_artists: string[]; why: string };
    };
    personal_favorites?: Array<{ song: string; artist: string; why: string }>;
