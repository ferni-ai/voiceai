 ...
 */
import type { BundleGreetings, BundleGoodbyes, BundleBehaviors } from './content.js';
...
export declare function isGoodbyesV2(goodbyes: string[] | BundleGoodbyes | BundleGoodbyesV2 | undefined): goodbyes is BundleGoodbyesV2;
...
export declare function isEntrancesV2(entrances: string[] | BundleEntrancesV2 | undefined): entrances is BundleEntrancesV2;
...
export declare function isGreetingsV2(greetings: BundleGreetings | BundleGreetingsV2 | undefined): greetings is BundleGreetingsV2;
...
export interface MisunderstandingConfig {
    when_persona_misunderstood?: {
        response: string;
        alternatives?: string[];
    };
    when_user_misunderstood_persona?: {
        response: string;
        alternatives?: string[];
    };
}
...
export interface BundleSuperhumanInsights {
    ...
    cross_session_arc_tracking?: {
        long_term_growth?: string[];
        unseen_progress?: string[];
    };
    superhuman_memory_flex?: {
        phrases?: string[];
    };
}
