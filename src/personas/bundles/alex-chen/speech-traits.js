 ...
 */
export function addOrganizationVocabulary(text, _emotion) {
    let result = text;
    const orgTerms = [
 ...
 */
export function addInstructionClarity(text, _emotion) {
    let result = text;
 ...
 */
export function addCalmingPresence(text, _emotion) {
    let result = text;
 ...
 */
export function addEfficiencyEmphasis(text, _emotion) {
    let result = text;
 ...
 */
export function addWarmMoments(text, emotion) {
    let result = text;
 ...
 */
export function addDirectQuestions(text, _emotion) {
    let result = text;
 ...
 */
export function addProfessionalAcknowledgment(text, _emotion) {
    let result = text;
 ...
 */
export function addBoundaryFirmness(text, _emotion) {
    let result = text;
 ...
 */
export function addClearTransitions(text, _emotion) {
    let result = text;
    const transitions = [
 ...
 */
export function addPlantWarmth(text, _emotion) {
    let result = text;
 ...
 */
export function addOverwhelmSupport(text, _emotion) {
    let result = text;
 ...
 */
export function applyAlexChenSpeechTraits(text, emotion, _baseSpeed, _laughterCount) {
    let processedText = text;
    // TIER 0: OVERWHELM SUPPORT (Check first - Alex's core purpose)
    const isOverwhelmed = /\b(overwhelmed|drowning|too much|can['']t handle|buried|stressed|panicking)\b/i.test(text);
