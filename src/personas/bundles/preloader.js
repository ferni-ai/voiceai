...
const PERSONA_IDS = ['ferni', 'peter', 'alex', 'maya', 'jordan', 'nayan'];
 ...
 */
export async function preloadAllBundles() {
...
async function doPreload() {
    ...
    await Promise.all(PERSONA_IDS.map(async (personaId) => {
 ...
 */
export function areBundlesPreloaded() {
