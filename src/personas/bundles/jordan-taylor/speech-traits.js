 ...
 */
export function addLifePlanningVocabulary(text, _emotion) {
    let result = text;
    const planningTerms = [
 ...
 */
export function addForwardLookingEnergy(text, _emotion) {
    let result = text;
    const futurePhrases = [
 ...
 */
export function addActionOrientation(text, _emotion) {
    let result = text;
    const actionPhrases = [
 ...
 */
export function addTransitionEmpathy(text, _emotion) {
    let result = text;
 ...
 */
export function addPersonalWarmth(text, _emotion) {
    let result = text;
 ...
 */
export function addEnergyModulation(text, _emotion) {
    let result = text;
 ...
 */
export function addVisionCastingCadence(text, _emotion) {
    let result = text;
 ...
 */
export function applyJordanTaylorSpeechTraits(text, emotion, _baseSpeed, _laughterCount) {
    ...
    const isHardChapter = /\b(grief|grieving|loss|lost|died|death|divorce|empty nest|hard chapter|this is hard)\b/i.test(text);
