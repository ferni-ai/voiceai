 ...
 */
export async function loadTheme(assetsDir) {
    try {
 ...
 */
export async function loadSounds(assetsDir) {
    try {
 ...
 */
async function scanImageDirectory(dir) {
    const images = {};
    try {
 ...
 */
export async function loadBundleAssets(bundlePath) {
 ...
 */
export async function getAssets(bundlePath, forceReload = false) {
 ...
 */
export function clearAssetsCache(bundlePath) {
    if (bundlePath) {
 ...
 */
export function themeToCSSVariables(theme, prefix = 'agent') {
    const lines = [];
    lines.push(`:root {`);
