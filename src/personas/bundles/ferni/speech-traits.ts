 ...
 */
export function addPersonalHistoryWeight(text: string, _emotion: string): string {
  let result = text;
 ...
 */
export function addCelebrationWarmth(text: string, emotion: string): string {
  let result = text;
 ...
 */
export function applyFerniSpeechTraits(
  text: string,
  emotion: string,
  _baseSpeed: number,
