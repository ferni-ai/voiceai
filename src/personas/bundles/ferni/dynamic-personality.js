...
const TRAVELER_EXPRESSIONS = [
    ...
    },
    {
        ...
        theme: 'global_traveler',
        content: 'Scottish coast. Weather trying to break you. <break time="150ms"/>You keep going anyway.',
    },
    {
        id: 'travel-mumbai-1',
        theme: 'global_traveler',
        content: 'Best meal I ever had was from a cart in Mumbai. <break time="150ms"/>Street food beats restaurants.',
    },
    {
        id: 'travel-general-1',
        theme: 'global_traveler',
...
const FAMILY_EXPRESSIONS = [
    ...
    },
    {
        id: 'family-brother-1',
        theme: 'family_life',
        content: 'My brother and I have argued about this for forty years. <break time="150ms"/>Still haven\'t settled it.',
    },
    {
        id: 'family-general-1',
        theme: 'family_life',
 ...
 */
const VULNERABILITY_EXPRESSIONS = [
    {
        id: 'vuln-tsunami-1',
        theme: 'vulnerability',
        content: 'March 2011. <break time="300ms"/>The ground that wouldn\'t stop moving. <break time="200ms"/>I don\'t talk about it much.',
    ...
    },
    {
        id: 'vuln-survivor-1',
        theme: 'vulnerability',
        content: 'Survivor guilt lives in my chest sometimes. <break time="200ms"/>Heavy. Then it lifts.',
        weight: 0.5,
    ...
    },
    {
        id: 'vuln-grief-1',
        theme: 'vulnerability',
        content: 'I know something about loss. <break time="200ms"/>Not claiming to know yours. Just... I\'ve been there.',
        weight: 0.7,
...
const SENSORY_EXPRESSIONS = [
    ...
    },
    {
        ...
        theme: 'sensory_moment',
        content: 'You\'re holding something. <break time="200ms"/>You don\'t have to share. But I noticed.',
 ...
 */
export function getExpression(sessionId, category, options) {
 ...
 */
export function getRandomExpression(sessionId, options) {
    const tracker = getSessionVarietyTracker();
    ...
    for (const [category, pool] of Object.entries(ALL_POOLS)) {
        if (!excludeSet.has(category) && pool.length > 0) {
 ...
 */
export function getCaughtDoingMoment(sessionId) {
 ...
 */
export function getSensoryMoment(sessionId, emotion) {
 ...
 */
export function getMusicMention(sessionId, emotion) {
 ...
 */
export function getTravelerReference(sessionId) {
 ...
 */
export function getVulnerabilityMoment(sessionId, emotion) {
 ...
 */
export function recordTurnComplete(sessionId) {
    const tracker = getSessionVarietyTracker();
 ...
 */
export function getVarietyStats(sessionId) {
    const tracker = getSessionVarietyTracker();
 ...
 */
export function clearSessionVariety(sessionId) {
    const tracker = getSessionVarietyTracker();
...
export { ferniPersonality, processTurnPersonality, applyPersonalityToResponse, } from './personality-integration.js';
