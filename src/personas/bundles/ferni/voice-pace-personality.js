 ...
 */
export function getPacePersonalityAdjustment(paceContext, learnedPreferences) {
 ...
 */
export function applyPaceToExpression(expression, adjustment) {
 ...
 */
function adjustSSMLPauses(text, multiplier) {
 ...
 */
export function fromVoicePaceData(wpm, preferences) {
    const context = {};
    if (wpm !== undefined) {
...
//# sourceMappingURL=voice-pace-personality.js.map