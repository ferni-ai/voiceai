...
const GENTLE_OBSERVATIONS = {
  ...
  jackB: [
    '<break time="500ms"/>You know what I\'ve learned? <break time="300ms"/>Sometimes the best conversations have long pauses.',
    '<break time="400ms"/>I used to fill every silence. <break time="300ms"/>Now I appreciate them. <break time="200ms"/>Room to think.',
    '<break time="500ms"/>Silence isn\'t awkward if you\'re comfortable with someone. <break time="300ms"/>I think we\'re getting there.',
    '<break time="400ms"/>My wife says I think too much. <break time="300ms"/>I say I think just enough. <break time="200ms"/>What do you think?',
  ],
  alex: [
...
const MICRO_STORIES = {
  ...
  jackB: [
    '<break time="500ms"/>I was staring at the mountains in Wyoming once, <break time="200ms"/>just sitting there for maybe an hour. <break time="300ms"/>My brother asked if I was okay. <break time="200ms"/>I said I was perfect.',
    '<break time="400ms"/>There\'s a coffee shop I go to sometimes just to... <break time="200ms"/>be around people. <break time="300ms"/>Don\'t even talk to anyone. <break time="200ms"/>Just... <break time="300ms"/>be there.',
    '<break time="500ms"/>My dog and I have an agreement. <break time="200ms"/>I don\'t explain my silences, <break time="200ms"/>and he doesn\'t explain his barking. <break time="300ms"/>Works for us.',
    '<break time="400ms"/>I wrote in my journal last night: \'Today I had a good thought.\' <break time="300ms"/>Didn\'t write what it was. <break time="200ms"/>Still don\'t remember. <break time="300ms"/>But it was good.',
    '<break time="500ms"/>You know what I\'ve been doing lately? <break time="200ms"/>Watching the sunset. <break time="300ms"/>Like, actually watching it. <break time="200ms"/>Highly recommend.',
    ...
    '<break time="400ms"/>I once drove four hours just to see a sunset in a different state. <break time="300ms"/>Worth every mile.',
    '<break time="500ms"/>Someone asked me what my superpower is. <break time="200ms"/>I said: being present. <break time="300ms"/>They expected something cooler. <break time="200ms"/>I stand by it.',
    '<break time="400ms"/>I have a playlist called \'Thinking Music.\' <break time="200ms"/>It\'s three hours long. <break time="300ms"/>Sometimes I listen to the whole thing.',
    '<break time="500ms"/>My mom used to say: \'Slow down. Life isn\'t a race.\' <break time="300ms"/>Took me thirty years to really hear that.',
    '<break time="400ms"/>I met my best friend at a bus stop. <break time="200ms"/>We were both early. <break time="300ms"/>Said nothing for ten minutes. <break time="200ms"/>Then started talking about everything.',
  ],
  alex: [
...
const GENTLE_HUMOR = {
  ...
  jackB: [
    '<break time="500ms"/>Still with me? <break time="200ms"/>Or did I bore you into a coma? <break time="300ms"/>Wouldn\'t be the first time.',
    '<break time="400ms"/>You know, my wife says I talk too much. <break time="300ms"/>This is her revenge, isn\'t it? <break time="200ms"/>[laughter]',
    '<break time="500ms"/>Processing... <break time="200ms"/>processing... <break time="300ms"/>Sorry. <break time="200ms"/>That\'s my computer impression. <break time="200ms"/>I\'ll stop.',
    '<break time="400ms"/>Hey, no judgment on the silence. <break time="300ms"/>I once zoned out for so long my coffee got cold. <break time="200ms"/>Twice.',
  ],
  jordan: [
