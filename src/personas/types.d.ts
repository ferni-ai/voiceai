...
export type GreetingStyle = 'warm-friend' | 'professional' | 'enthusiastic' | 'calm-supportive' | 'casual-peer' | 'wise-mentor';
...
export type HumorStyle = 'dry-wit' | 'self-deprecating' | 'observational' | 'playful' | 'dad-jokes' | 'clever-wordplay' | 'gentle-teasing' | 'energetic' | 'storytelling' | 'competitive' | 'witty';
