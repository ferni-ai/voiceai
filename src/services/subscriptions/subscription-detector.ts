...
} from '../stores/subscription-store.js';
...
export class SubscriptionDetector {
   ...
   */
  async importDetectedSubscriptions(
    ...
    for (const sub of detected) {
      ...
      try {
        ...
        log.error(
          { error: String(error), merchantName: sub.merchantName },
...
const instances: Map<string, SubscriptionDetector> = new Map();

export function getSubscriptionDetector(userId: string): SubscriptionDetector {
...
export function resetSubscriptionDetector(userId: string): void {
