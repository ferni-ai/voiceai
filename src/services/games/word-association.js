 ...
 */
function isValidAssociation(previousWord, newWord) {
    // Clean up words
 ...
 */
function getAIAssociation(word) {
...
function getAITurnMessage(aiWord, chainLength) {
    const intros = [
        `${aiWord}!`,
...
function getInvalidWordMessage() {
    const messages = [
...
//# sourceMappingURL=word-association.js.map