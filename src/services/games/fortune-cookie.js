...
const FORTUNES = [
    ...
    {
        text: 'Everyone you meet is fighting a battle you know nothing about.',
        category: 'relationships',
    },
    ...
    // Purpose
    {
        text: "Your purpose is not something you find. It's something you become.",
        category: 'purpose',
    },
...
function getReflectionPrompt(fortune) {
 ...
 */
export function getSessionFortunes(state) {
    return state.fortunesSeen;
}
//# sourceMappingURL=fortune-cookie.js.map