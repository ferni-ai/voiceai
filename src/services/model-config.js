 ...
 */
export function setDefaultGeminiConfig(config, updatedBy) {
 ...
 */
export function getPersonaModelConfig(personaId) {
    const store = getConfigWithCache();
 ...
 */
export function setPersonaModelConfig(personaId, config, updatedBy) {
    const store = getConfigWithCache();
 ...
 */
export function deletePersonaModelConfig(personaId) {
    const store = getConfigWithCache();
 ...
 */
export function setDefaultToolConfig(config, updatedBy) {
    const store = getConfigWithCache();
    store.toolDefaults = {
        ...store.toolDefaults,
        ...config,
 ...
 */
export function getToolConfig(personaId) {
    return getPersonaModelConfig(personaId).tools;
}
/**
 * Set tool configuration for a persona
 */
export function setToolConfig(personaId, config, updatedBy) {
 ...
 */
export function getEffectiveSystemPromptOverride(personaId) {
 ...
 */
export function setPersonaSystemPrompt(personaId, systemPrompt, enabled, updatedBy) {
    setPersonaModelConfig(personaId, {
 ...
 */
export function validateGeminiConfig(config) {
    const errors = [];
 ...
 */
export function getModelForPersona(personaId) {
    if (personaId) {
