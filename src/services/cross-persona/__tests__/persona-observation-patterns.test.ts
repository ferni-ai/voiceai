  ...
  describe('analyzeTextForPersona', () => {
    ...
    describe('Peter patterns', () => {
      ...
      it('should detect financial topics', () => {
        const matches = analyzeTextForPersona(
          'peter',
          'I need to budget better and save more money'
        );
    ...
    describe('Jordan patterns', () => {
      it('should detect goal discussions', () => {
        const matches = analyzeTextForPersona(
          'jordan',
          'I want to achieve my fitness goal this month'
        );
    ...
    describe('Nayan patterns', () => {
      ...
      it('should detect legacy reflections', () => {
        // Use "impact" and "contribution" keywords which are specific to legacy domain
        const matches = analyzeTextForPersona(
          'nayan',
          'I want my impact to be remembered for generations'
        );
    ...
    describe('confidence adjustment', () => {
      it('should increase confidence with multiple keyword matches', () => {
        ...
        expect(multiMatch[0].adjustedConfidence).toBeGreaterThanOrEqual(
          singleMatch[0].adjustedConfidence
        );
      });
      ...
      it('should cap confidence at 0.95', () => {
        const matches = analyzeTextForPersona(
          'ferni',
          'I feel stuck and lost and confused and need help',
          1.0
        );
