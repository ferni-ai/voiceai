 ...
 */
export async function getMeetingPatterns(userId) {
    // Check cache
 ...
 */
export async function learnMeetingPatterns(userId) {
 ...
 */
export async function getOptimalMeetingTimes(userId, durationMinutes, meetingType) {
 ...
 */
export async function isOptimalMeetingTime(userId, dateTime, durationMinutes) {
    const patterns = await getMeetingPatterns(userId);
...
function analyzeEventPatterns(events) {
    ...
    let focusTimePreference = 'variable';
    ...
    const clusteringPreference = 'variable';
    return {
        preferredStartTimes,
        avoidDays,
        avoidHours,
...
//# sourceMappingURL=meeting-pattern-learning.js.map