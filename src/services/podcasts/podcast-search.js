 ...
 */
export async function getPodcastEpisodes(podcastId, limit = 10) {
    ...
    try {
        ...
        const episodes = episodeResults.map((r) => ({
            id: `itunes:${r.trackId}`,
            showId: podcastId,
            showName,
 ...
 */
export async function getTopPodcasts(genre, limit = 10) {
 ...
 */
export async function getPodcastRecommendations(interests, mood, limit = 5) {
 ...
 */
export async function isPodcastApiAvailable() {
    try {
...
//# sourceMappingURL=podcast-search.js.map