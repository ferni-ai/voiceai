...
const deliveredPrompts = new Map(); // userId -> promptIds
// ============================================================================
// PROMPT GENERATION
// ============================================================================
/**
 ...
 */
export function generatePrompts(context, count = 3) {
    const prompts = [];
 ...
 */
function selectCategories(context) {
    const categories = [];
 ...
 */
function generateFromCategory(category, context) {
 ...
 */
function determineDifficulty(category, context) {
    // Deep categories
 ...
 */
function wasRecentlyDelivered(userId, promptId) {
 ...
 */
function markDelivered(userId, promptId) {
 ...
 */
function updatePatterns(userId) {
 ...
 */
export function getBestPrompt(context) {
 ...
 */
export function getPromptsForCategory(userId, category, count = 3) {
    const templates = TEMPLATES[category];
    if (!templates)
        return [];
 ...
 */
export function getJournalingPatterns(userId) {
    return userPatterns.get(userId) || null;
}
/**
 * Generate prompt for specific situation
 */
export function generateSituationalPrompt(userId, situation) {
    const prompts = {
        morning_routine: {
 ...
 */
export function formatPromptForVoice(prompt) {
    const intros = [
 ...
 */
function promptContextToQuestionContext(context, personaId = 'ferni') {
    return {
        personaId,
        userId: context.userId,
        ...
        emotionalState: context.currentEmotion
            ...
            : undefined,
        hourOfDay: context.timeOfDay === 'morning'
            ? 8
 ...
 */
export async function generateDynamicPrompt(context, category, personaId = 'ferni') {
 ...
 */
export async function generateDynamicPrompts(context, count = 3, personaId = 'ferni') {
...
//# sourceMappingURL=journaling-prompts.js.map