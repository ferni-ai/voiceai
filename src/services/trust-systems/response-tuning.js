 ...
 */
export function calculateResponseStyle(context) {
 ...
 */
function applyAdjustments(style, adjustments, intensity) {
 ...
 */
export function generateTuningGuidance(context) {
 ...
 */
function generateSuggestions(style, context) {
    const suggestions = [];
 ...
 */
function generateAvoidances(style, context) {
    const avoidances = [];
    if (style.directness < 0.4) {
 ...
 * Generate tone words
 */
function generateToneWords(style) {
    const words = [];
    // Warmth scale
    if (style.warmth > 0.7) {
 ...
 */
function generateExamplePhrases(style, context) {
    const phrases = [];
    // Opening phrases
    if (style.warmth > 0.8) {
 ...
 */
export function formatGuidanceForLLM(guidance) {
    const sections = [];
 ...
 */
export function checkResponseAlignment(response, guidance) {
    const issues = [];
...
//# sourceMappingURL=response-tuning.js.map