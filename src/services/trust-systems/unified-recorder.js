...
import { recordPersonaInteraction } from './persona-specific-learning.js';
 ...
 */
async function writeThroughTrustMoment(userId, momentType, data) {
 ...
 */
export async function recordTrustMoment(userId, moment) {
 ...
 */
export async function recordConversationTurn(data) {
    ...
    try {
        ...
        if (analysis?.emotion) {
            try {
                recordEmotionalSnapshot(userId, {
                    primaryEmotion: analysis.emotion.primary,
                    secondaryEmotions: (analysis.emotion.secondaryEmotions || []),
        ...
        log.debug({ userId, hasTopic: !!analysis?.topic, hasEmotion: !!analysis?.emotion }, '📝 Conversation turn recorded');
    }
    catch (error) {
...
export async function recordSessionEnd(data) {
    ...
    try {
        ...
        if (personaId) {
            try {
                recordPersonaInteraction(userId, personaId, sessionDurationMinutes, topicsDiscussed || []);
            }
            catch (e) {
        ...
        log.info({ userId, durationMinutes: sessionDurationMinutes, turnCount }, '✅ Session end recorded');
    }
    catch (error) {
 ...
 */
export async function recordWinMoment(data) {
 ...
 */
export async function recordBoundary(data) {
 ...
 */
export async function recordJournalResponse(data) {
    ...
    try {
        ...
        if (emotionBeforeWriting) {
            try {
                recordEmotionalSnapshot(userId, {
                    primaryEmotion: emotionBeforeWriting,
                    secondaryEmotions: [],
                    intensity: 0.6,
        ...
        if (emotionAfterWriting) {
            try {
                recordEmotionalSnapshot(userId, {
                    primaryEmotion: emotionAfterWriting,
                    secondaryEmotions: [],
                    intensity: 0.6,
                    source: 'self_reported',
                });
 ...
 */
export async function recordMediaInteractionUnified(data) {
 ...
 */
export async function recordCelebrationReception(userId, winId, reception) {
    try {
...
//# sourceMappingURL=unified-recorder.js.map