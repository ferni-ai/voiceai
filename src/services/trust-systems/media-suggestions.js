 ...
 */
export function recordSuggestionFeedback(userId, suggestionId, feedback) {
 ...
 */
export function updateMusicPreferences(userId, preferences) {
    const prefs = getOrCreatePreferences(userId);
 ...
 */
export function generateSuggestions(userId, context) {
    const prefs = getOrCreatePreferences(userId);
    const suggestions = [];
 ...
 */
function selectMediaTypes(context) {
    const types = [];
 ...
 */
function getSuggestionsForType(type, context, prefs) {
 ...
 */
function determineIntent(context) {
 ...
 */
function prioritizeSuggestions(suggestions, prefs, context) {
    return suggestions.sort((a, b) => {
        // Check if either has been effective before
        const aEffective = prefs.effectiveSuggestions.find((e) => e.suggestionId === a.id && e.mood === context.currentMood);
        const bEffective = prefs.effectiveSuggestions.find((e) => e.suggestionId === b.id && e.mood === context.currentMood);
 ...
 */
export function getBestSuggestion(userId, context) {
 ...
 * Get suggestions for a specific type
 */
export function getSuggestionsForMood(userId, mood, type) {
 ...
 */
export function formatSuggestionForVoice(suggestion) {
    const typeIntros = {
 ...
 */
export function getMediaPreferences(userId) {
...
//# sourceMappingURL=media-suggestions.js.map