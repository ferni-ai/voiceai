...
// IN-MEMORY STORAGE
// ============================================================================
const learningProfiles = new Map();
// ============================================================================
// PROFILE MANAGEMENT
// ============================================================================
/**
 ...
 */
export function detectStyleSignals(text) {
    const signals = [];
    // Processing signals
 ...
 */
export function recordLearningSignals(userId, text, context) {
 ...
 */
function detectLearningPatterns(profile) {
    const patterns = [];
    // Processing pattern
 ...
 */
export function generateDeliveryGuidance(userId) {
    const profile = getOrCreateProfile(userId);
    // Format guidance
    const format = {
        ...
        lengthPreference: profile.structure.style === 'detailed'
            ? 'detailed'
            : profile.structure.style === 'big_picture'
                ? 'brief'
                : 'moderate',
 ...
 */
export function formatGuidanceForLLM(userId) {
 ...
 */
export function recordAdaptationReception(userId, adaptation, reception, context) {
    const profile = getOrCreateProfile(userId);
 ...
 */
export function getStyleSummary(userId) {
    const profile = learningProfiles.get(userId);
    if (!profile || profile.confidence < 0.3)
        return null;
    const parts = [];
...
//# sourceMappingURL=learning-style.js.map