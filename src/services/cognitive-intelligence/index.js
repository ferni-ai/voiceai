 ...
 */
export function buildCognitiveIntelligenceContext(userId, text, context = {}) {
...
export function generateWeeklyInsights(pattern) {
    ...
    if (pattern.topicTriggers && pattern.topicTriggers.size > 0) {
        ...
        insights.push(`Work-related thoughts seem to trigger these patterns, especially around ${topTopic}.`);
    }
    return insights;
}
