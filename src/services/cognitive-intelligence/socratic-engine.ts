...
export const SOCRATIC_SEQUENCES: Record<CognitiveDistortion, SocraticSequence> = {
  ...
  personalization: {
    ...
    ferniIntro: "You're taking a lot of responsibility there. Let's look at what was actually in your control...",
  ...
  magnification: {
    ...
    mayaApproach: "Strong feelings can magnify things. What would this look like in a calmer moment?",
  },
...
export function selectSocraticQuestion(context: SocraticContext): SocraticQuestion {
  ...
  const unaskedQuestions = availableQuestions.filter(
    (q) => !context.questionsAsked.includes(q)
  );
...
export {
  SOCRATIC_SEQUENCES as socraticSequences,
};
