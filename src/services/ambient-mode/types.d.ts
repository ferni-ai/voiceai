 ...
 */
export type NudgeType = 'morning_checkin' | 'evening_reflection' | 'commute_moment' | 'lunch_break' | 'post_meeting' | 'workout_encouragement' | 'bedtime_reminder' | 'weekend_morning' | 'long_absence' | 'celebration' | 'concern' | 'weather_related' | 'location_triggered';
/**
