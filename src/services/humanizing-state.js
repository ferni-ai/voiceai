 ...
 */
export function getHumanizingState(profile) {
    ...
    return {
        ...
        usedGreetings: profile.humanizingState.usedGreetings || [],
        lastGreetingAt: profile.humanizingState.lastGreetingAt,
    };
}
/**
 * Create default humanizing state for new users
 */
function createDefaultHumanizingState() {
    return {
        usedShareTags: [],
 ...
 */
export function mergeHumanizingStateUpdate(existing, update) {
    const now = new Date();
 ...
 */
export function applyHumanizingStateToProfile(profile, state) {
    return {
        ...profile,
        humanizingState: {
 ...
 */
export function getRelationshipDepthScore(state) {
    let score = 0;
 ...
 */
export function logHumanizingStateSummary(state, userId) {
    getLogger().info({
        userId,
 ...
 */
export function hashGreeting(greeting) {
 ...
 */
export function hasGreetingBeenUsed(state, greeting) {
 ...
 */
export function recordGreetingUsage(state, greeting) {
    const hash = hashGreeting(greeting);
    const now = new Date();
 ...
 */
export function getUsedGreetingHashes(state) {
...
//# sourceMappingURL=humanizing-state.js.map