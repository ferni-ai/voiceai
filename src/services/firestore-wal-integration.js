...
import { getWriteAheadLog, initializeWriteAheadLog, shutdownWriteAheadLog, } from './write-ahead-log.js';
 ...
 */
export async function initializeFirestoreWAL() {
    if (initialized)
        return;
    try {
 ...
 */
export async function shutdownFirestoreWAL() {
    if (!initialized)
        return;
    try {
 ...
 */
export function queueUserProfileUpdate(userId, updates, priority = 'normal') {
 ...
 */
export function queueUserProfileSet(userId, profile, priority = 'normal') {
    const wal = getWriteAheadLog();
 ...
 */
export function queueSubcollectionWrite(userId, subcollection, docId, data, options) {
    const wal = getWriteAheadLog();
 ...
 */
export function queueMemoryWrite(userId, memoryId, memory, priority = 'normal') {
 ...
 */
export function queueSessionWrite(userId, sessionId, sessionData, priority = 'normal') {
 ...
 */
export function queueHighPriorityWrite(collection, docId, data, userId) {
    const wal = getWriteAheadLog();
 ...
 */
export function queueDeletion(collection, docId, priority = 'normal', userId) {
    const wal = getWriteAheadLog();
 ...
 */
export function queueAnalyticsEvent(eventId, event, userId) {
    const wal = getWriteAheadLog();
 ...
 */
export async function flushUserWrites(_userId) {
 ...
 */
export function getWALStatistics() {
    const wal = getWriteAheadLog();
    return wal.getStats();
}
/**
...
// ============================================================================
export { getWriteAheadLog } from './write-ahead-log.js';
//# sourceMappingURL=firestore-wal-integration.js.map