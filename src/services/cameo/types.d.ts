 ...
 */
export type CameoTriggerType = 'data_insight' | 'scheduling' | 'habit_check' | 'planning' | 'wisdom' | 'celebration' | 'support' | 'expertise' | 'manual';
/**
 ...
 */
export type CameoEventType = 'cameo_requested' | 'cameo_starting' | 'cameo_started' | 'cameo_ending' | 'cameo_complete' | 'cameo_cancelled' | 'cameo_failed';
/**
...
export interface CameoDataMessage {
    type: 'cameo_starting' | 'cameo_start' | 'cameo_ending' | 'cameo_complete' | 'cameo_cancelled' | 'cameo_failed';
