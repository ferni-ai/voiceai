...
import type { CommunicationMirroringEngine, ConversationAnalysis, ConversationPatternAnalyzer, ConversationState, CrossSessionThreader, DynamicUserContext, EmotionalMemoryEngine, EmotionResult, FinancialJourneyTracker, HumorCalibrationEngine, IntentResult, ProactiveInsightEngine, ResponseQualityTracker, StoryPreferenceEngine, SuperhumanContext, UserLearningEngine, VoicePaceAdapter } from '../intelligence/index.js';
...
export interface SessionServices {
    ...
    getProactiveInsights: () => Promise<InsightGenerationResult & {
        suggestedInsightId?: string;
    }>;
...
export type { ConversationAnalysis, ConversationState, DynamicUserContext, EmotionResult, HumanizingStateUpdate, IntentResult, PromptContext, SpeechContext, UserProfile, };
