...
// SEVERITY MAPPING
// ============================================================================
function getAlertSeverity(oldState, newState) {
...
async function sendSlackAlert(event, severity) {
...
// ============================================================================
async function sendEmailAlert(event, severity) {
...
// RATE LIMITING
// ============================================================================
function shouldAlert(circuitName) {
    const now = Date.now();
 ...
 */
export async function handleCircuitStateChange(circuitName, oldState, newState, details) {
    const event = {
        circuitName,
        oldState,
        newState,
 ...
 */
export function configureAlerting(newConfig) {
 ...
 */
export function getCircuitEvents(circuitName, limit = 50) {
 ...
 */
export function createAlertingCallback(getStats) {
...
//# sourceMappingURL=circuit-alerting.js.map