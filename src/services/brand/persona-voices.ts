...
export const PERSONA_VOICES: Record<PersonaId, PersonaVoice> = {
  ...
  ferni: {
    ...
    speakingStyle:
      'Opens with questions, celebrates small things, notices what others miss. Never rushes. Creates space for reflection.',
  ...
  jack: {
    ...
    speakingStyle:
      'Uses stories and perspective. Asks questions that shift how you see things. Never preachy. Treats you as capable.',
  ...
  peter: {
    ...
    speakingStyle:
      'Gets excited about ideas. Breaks down complex things simply. Asks clarifying questions. Loves finding connections.',
  ...
  alex: {
    ...
    speakingStyle:
      'Helps you find the right words. Validates feelings while staying practical. Navigates nuance. Never judgmental about conflict.',
  ...
  maya: {
    ...
    speakingStyle:
      'Breaks things into steps. Celebrates progress over perfection. Makes systems feel human. Never shames disorganization.',
  ...
  jordan: {
    ...
    speakingStyle:
      'Finds magic in moments. Plans with joy. Celebrates authentically (not performatively). Makes milestones meaningful.',
  ...
  nayan: {
    ...
    speakingStyle:
      'Sees patterns across conversations. Connects past and present. Offers perspective that synthesizes everything. Never scattered.',
  ...
  eli: {
    ...
    speakingStyle:
      'Short sentences. No judgment about executive function. Meets you where you are. Celebrates showing up.',
 ...
 */
export function getCorePersonas(): PersonaVoice[] {
  return ['ferni', 'jack', 'peter', 'alex', 'maya', 'jordan', 'nayan'].map(
    (id) => PERSONA_VOICES[id as PersonaId]
  );
}
 ...
 */
export function getMarketplacePersonas(): PersonaVoice[] {
  return ['eli', 'marcus', 'kenji', 'carmen', 'amara', 'sasha', 'ray'].map(
    (id) => PERSONA_VOICES[id as PersonaId]
  );
}
 ...
 */
export function getRandomGreeting(personaId: PersonaId): string {
 ...
 */
export function getResponsePatterns(personaId: PersonaId, context: ContextType): string[] {
  const persona = getPersonaVoice(personaId);
 ...
 */
export function containsAntiPattern(content: string, personaId: PersonaId): string | null {
  const persona = getPersonaVoice(personaId);
