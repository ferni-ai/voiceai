...
export {
  DEFAULT_THROTTLE_RULES,
  createEmptyRevelationProfile,
  revelationToCategory,
  getRevelationName,
} from './types.js';

// Storage
export {
  loadRevelationProfile,
  saveRevelationProfile,
  recordRevelation,
  hasRevelation,
  getRevelations,
  recordCapabilityUse,
  getCapabilityUseCount,
  getSessionCapabilities,
  recordRevelationResponse,
  getRevelationStats,
  clearRevelationCache,
  clearAllRevelationCache,
} from './storage.js';
...
export {
  ...
  PERMISSION_GRANTED_RESPONSES,
  PERMISSION_DECLINED_RESPONSES,
...
import { containsBlockingSurveillance, getSurveillanceIssues } from './anti-surveillance.js';
...
import { revelationToCategory } from './types.js';
 ...
 */
export async function checkCapabilityUsage(
  userId: string,
  sessionId: string,
 ...
 */
function getFirstRevelationType(capability: CapabilityCategory): RevelationType | null {
  const mapping: Record<CapabilityCategory, RevelationType | null> = {
