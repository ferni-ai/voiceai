 ...
 */
export const SURVEILLANCE_PATTERNS = [
    // DATA REFERENCE
    {
 ...
 */
export function detectSurveillanceLanguage(text) {
    const detections = [];
 ...
 */
export function containsBlockingSurveillance(text) {
 ...
 */
export function getSurveillanceIssues(text) {
    const detections = detectSurveillanceLanguage(text);
    return {
 ...
 */
export function humanizeSurveillanceLanguage(text) {
    ...
    for (const detection of detections) {
        if (!detection.pattern.alternative)
            continue;
 ...
 */
export function getAntiSurveillanceGuidance() {
 ...
 */
export function getAntiSurveillanceReminder(category) {
    const reminders = {
...
//# sourceMappingURL=anti-surveillance.js.map