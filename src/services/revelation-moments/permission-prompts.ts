 ...
 */
export const PERMISSION_PROMPTS: PermissionPrompt[] = [
  // SHARE OBSERVATION
  {
 ...
 */
export function getPermissionPrompt(category: PermissionCategory): string {
...
export function requiresPermission(capability: CapabilityCategory, trustLevel = 0): boolean {
  ...
  const requiresAtTrust: Record<CapabilityCategory, number> = {
...
export function getPermissionGuidance(
  availableCapabilities: CapabilityCategory[],
  trustLevel: number
): string | null {
 ...
 */
export const PERMISSION_GRANTED_RESPONSES: Record<PermissionCategory, string[]> = {
  share_observation: [
    'Okay, here it is...',
 ...
 */
export const PERMISSION_DECLINED_RESPONSES: string[] = [
 ...
 */
export function getPermissionGrantedResponse(category: PermissionCategory): string {
 ...
 */
export function getPermissionDeclinedResponse(): string {
  return PERMISSION_DECLINED_RESPONSES[
    Math.floor(Math.random() * PERMISSION_DECLINED_RESPONSES.length)
  ];
}
