 ...
 */
export function createModeShiftSignal(mode, reason) {
    return {
        type: 'mode_shift',
        mode,
        reason,
 ...
 */
export function createPacingChangeSignal(pacing, reason) {
    return {
        type: 'pacing_change',
        pacing,
        reason,
 ...
 */
export function createHoldSpaceSignal(duration, reason) {
    return {
        type: 'hold_space',
        duration,
        reason,
 ...
 */
export function createProcessingSignal(isStart, expression) {
    return {
...
//# sourceMappingURL=signal-factories.js.map