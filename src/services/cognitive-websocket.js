 ...
 */
export function initCognitiveWebSocket(httpServer) {
    ...
    cognitiveBroadcast.subscribe((event) => {
    ...
    registerInterval('cognitive-websocket-heartbeat', () => {
 ...
 */
export function shutdownCognitiveWebSocket() {
...
//# sourceMappingURL=cognitive-websocket.js.map