 ...
 */
export async function initiateOutreach(options) {
    const outreachId = uuidv4();
    try {
        // Get or create thread
        const thread = await getOrCreateThread(options.userId, options.preferredChannel, options.agentId, {
            triggerType: options.triggerType,
            outreachId,
        });
        // Generate persona-styled message
        const styledMessage = await styleMessageForAgent(options.agentId, options.messageContent, options.preferredChannel);
 ...
 */
export async function mayaHabitOutreach(userId, options) {
    let message;
    let triggerType;
 ...
 */
export async function peterResearchOutreach(userId, options) {
 ...
 */
export async function jordanMilestoneOutreach(userId, options) {
    let message;
    let triggerType;
 ...
 */
export async function alexCommunicationOutreach(userId, options) {
    let message;
 ...
 */
export async function nayanWisdomOutreach(userId, options) {
    return initiateOutreach({
        userId,
 ...
 */
export async function ferniCheckInOutreach(userId, options) {
 ...
 */
async function styleMessageForAgent(_agentId, content, _channel) {
 ...
 */
async function queueForDelivery(outreachId, options) {
...
//# sourceMappingURL=outbound-initiator.js.map