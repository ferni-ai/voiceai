 ...
 */
export async function getEmotionalTrajectory(userId) {
    try {
        ...
        const avgValence = recentWaypoints.reduce((sum, w) => sum + (w.valence || 0), 0) /
...
//# sourceMappingURL=emotional-semantics.js.map