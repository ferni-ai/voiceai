...
async function fetchGrowthData(userId) {
    const growthAreas = [];
    try {
...
// GENERATOR
// ============================================================================
async function generateGrowthInsights(userId, context) {
    const insights = [];
    try {
...
function buildGrowthInsight(data, userId, context) {
...
// REGISTRATION
// ============================================================================
const growthTrajectoryGenerator = {
    category: 'growth_trajectory',
...
//# sourceMappingURL=growth-trajectory.js.map