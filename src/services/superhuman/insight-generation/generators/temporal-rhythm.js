...
import { getHourlyPattern, getDayPattern, getSeasonalPattern, detectAnomaly, } from '../../semantic-intelligence/temporal-patterns.js';
...
async function fetchTemporalData(userId, context) {
    const insights = [];
    try {
...
// GENERATOR
// ============================================================================
async function generateTemporalInsights(userId, context) {
    const insights = [];
    try {
...
function buildTemporalInsight(data, userId) {
...
//# sourceMappingURL=temporal-rhythm.js.map