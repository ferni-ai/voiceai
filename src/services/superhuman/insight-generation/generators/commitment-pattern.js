...
async function analyzeCommitments(userId) {
    try {
        ...
        let insightType = 'overall_growth';
...
function categorizeCommitment(content) {
    const lower = content.toLowerCase();
    if (lower.match(/gym|exercise|health|sleep|eat|meditat|yoga|run|walk/))
        return 'health';
    if (lower.match(/call|friend|family|text|meet|visit|social/))
        return 'social';
    if (lower.match(/work|project|deadline|meeting|email|task/))
        return 'work';
    return 'personal';
}
// ============================================================================
// GENERATOR
// ============================================================================
async function generateCommitmentInsights(userId, _context) {
    const insights = [];
    try {
...
function buildCommitmentInsight(analysis, userId) {
    ...
    return {
        ...
        headline: analysis.insightType === 'struggling'
...
// REGISTRATION
// ============================================================================
const commitmentPatternGenerator = {
    category: 'commitment_pattern',
...
//# sourceMappingURL=commitment-pattern.js.map