...
async function detectMismatch(userId, context) {
...
// GENERATOR
// ============================================================================
async function generateVoiceMismatchInsights(userId, context) {
    const insights = [];
    try {
...
function buildMismatchInsight(data, userId) {
    ...
    return {
        ...
        triggerEmotions: data.mismatchType === 'fine_but_stressed' ? ['fine', 'okay', 'good'] : undefined,
...
// REGISTRATION
// ============================================================================
const voiceContentMismatchGenerator = {
    category: 'voice_content_mismatch',
...
//# sourceMappingURL=voice-content-mismatch.js.map