...
// ============================================================================
export const DISTRESS_TOLERANCE_SKILLS = {
    tipp: {
        id: 'tipp',
        name: 'TIPP',
...
// MINDFULNESS SKILLS
// ============================================================================
export const MINDFULNESS_SKILLS = {
    what_skills: {
        id: 'what_skills',
        name: 'What Skills',
        module: 'mindfulness',
 ...
 */
export function getSkillsByModule(module) {
    return Object.values(ALL_DBT_SKILLS).filter((s) => s.module === module);
}
/**
 * Get skill by ID.
 */
export function getDBTSkill(id) {
    return ALL_DBT_SKILLS[id] || null;
}
// ============================================================================
// SKILL TRACKING
// ============================================================================
const userSkillHistory = new Map();
/**
 * Record DBT skill use.
 */
export function recordSkillUse(userId, skillId, options) {
 ...
 */
export function getMostEffectiveSkills(userId) {
    const history = userSkillHistory.get(userId) || [];
    const ratings = {};
 ...
 */
export function getLearnedSkills(userId) {
    const history = userSkillHistory.get(userId) || [];
 ...
 */
export function buildDBTContext(userId, context) {
...
//# sourceMappingURL=dbt-skills.js.map