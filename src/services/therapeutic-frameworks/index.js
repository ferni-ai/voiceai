...
// ============================================================================
export { buildValuesContext, checkValuesAlignment, completeAction, 
// Values
detectValuesInSpeech, generateValuesPrompt, getPendingActions, getTopValues, getUserValues, getValueExamples, getValuesByDomain, getValuesQuestion, recordCommittedAction, recordValue, VALUE_EXAMPLES, VALUES_QUESTIONS, } from './act-values.js';
export { buildDefusionContext, 
// Defusion
DEFUSION_TECHNIQUES, getAllDefusionTechniques, getDefusionTechnique, getMostEffectiveDefusion, getRecentDefusionTechniques, recordDefusionUse, selectDefusionTechnique, } from './act-defusion.js';
// ============================================================================
// DBT - DIALECTICAL BEHAVIOR THERAPY
// ============================================================================
export { ALL_DBT_SKILLS, buildDBTContext, 
// Skills
DISTRESS_TOLERANCE_SKILLS, EMOTION_REGULATION_SKILLS, getDBTSkill, getLearnedSkills, getMostEffectiveSkills, getSkillsByModule, INTERPERSONAL_SKILLS, MINDFULNESS_SKILLS, recordSkillUse, selectDBTSkill, } from './dbt-skills.js';
// ============================================================================
// MOTIVATIONAL INTERVIEWING
// ============================================================================
export { AFFIRMATIONS, analyzeAmbivalence, 
// Context
buildMIContext, CHANGE_TALK_PATTERNS, 
// Change talk
detectChangeTalk, detectSustainTalk, 
// OARS
generateOARSResponse, getChangeTalkHistory, getStrongestChangeTalk, getTopChangeTalkTopics, OPEN_QUESTIONS, recordChangeTalk, REFLECTION_TEMPLATES, } from './motivational-interviewing.js';
// ============================================================================
// UNIFIED API
// ============================================================================
...
import { buildMIContext, detectSustainTalk, getTopChangeTalkTopics, } from './motivational-interviewing.js';
const log = createLogger({ module: 'TherapeuticFrameworks' });
/**
 * Build complete therapeutic context for a conversation turn.
 */
export function buildTherapeuticContext(userId, userText, context) {
    const { topic, emotion, emotionIntensity = 0.5, relationshipStage = 'building', enableACT = true, enableDBT = true, enableMI = true, } = context || {};
    const contextParts = [];
    const result = {
        hasContext: false,
        frameworks: [],
 ...
 */
export function getTherapeuticSummary(userId) {
