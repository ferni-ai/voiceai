...
// ============================================================================
export const DEFUSION_TECHNIQUES = {
    naming: {
        id: 'naming',
...
export function selectDefusionTechnique(context) {
    ...
    const available = Object.values(DEFUSION_TECHNIQUES).filter((t) => !previousTechniques.includes(t.id));
 ...
 */
export function getAllDefusionTechniques() {
    return Object.values(DEFUSION_TECHNIQUES);
}
/**
 * Get a defusion technique by ID.
 */
export function getDefusionTechnique(id) {
...
const userDefusionHistory = new Map();
/**
 * Record a defusion technique use.
 */
export function recordDefusionUse(userId, techniqueId, options) {
 ...
 */
export function getMostEffectiveDefusion(userId) {
    const history = userDefusionHistory.get(userId) || [];
 ...
 */
export function getRecentDefusionTechniques(userId, limit = 5) {
    const history = userDefusionHistory.get(userId) || [];
    return history
 ...
 */
export function buildDefusionContext(userId, detectedThought) {
    if (!detectedThought) {
        return null;
    }
...
//# sourceMappingURL=act-defusion.js.map