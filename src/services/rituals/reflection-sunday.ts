...
const REFLECTION_PROMPTS: ReflectionPrompt[] = [
  // SELF (Weeks 1-12)
  {
    id: 'self-1',
    category: 'self',
    prompt: 'What surprised you about yourself this week?',
    weekNumber: 1,
  },
  {
    id: 'self-2',
    category: 'self',
    prompt: 'When did you feel most like yourself?',
    weekNumber: 2,
  },
  {
    id: 'self-3',
    category: 'self',
    prompt: "What did you learn that you didn't expect?",
    weekNumber: 3,
  },
  {
    id: 'self-4',
    category: 'self',
    prompt: 'What are you avoiding? What would happen if you faced it?',
    weekNumber: 4,
  },
  { id: 'self-5', category: 'self', prompt: 'What pattern do you keep repeating?', weekNumber: 5 },
  {
    id: 'self-6',
    category: 'self',
    prompt: "What would your 10-year-old self think of who you've become?",
    weekNumber: 6,
  },
  {
    id: 'self-7',
  ...
  },
  {
    id: 'self-10',
    category: 'self',
    prompt: 'What does your body need right now?',
    weekNumber: 10,
  },
  {
    id: 'self-11',
    category: 'self',
    prompt: 'What story are you telling yourself that might not be true?',
    weekNumber: 11,
  },
  {
    id: 'self-12',
  ...
  // RELATIONSHIPS (Weeks 13-22)
  {
    ...
    prompt: 'Who showed up for you this week?',
    weekNumber: 13,
  },
  {
    id: 'rel-2',
    category: 'relationships',
    prompt: 'Where did you show up for someone else?',
    weekNumber: 14,
  },
  {
    id: 'rel-3',
  ...
  },
  {
    id: 'rel-4',
    category: 'relationships',
    prompt: 'Who in your life deserves more of your attention?',
    weekNumber: 16,
  },
  {
    id: 'rel-5',
    category: 'relationships',
    prompt: 'What relationship needs repair?',
    weekNumber: 17,
  },
  {
    id: 'rel-6',
    category: 'relationships',
    prompt: 'Who has surprised you recently?',
    weekNumber: 18,
  },
  {
    id: 'rel-7',
    category: 'relationships',
    prompt: 'What do you wish someone understood about you?',
    weekNumber: 19,
  },
  {
    id: 'rel-8',
    category: 'relationships',
    prompt: 'Who do you need to forgive? (Maybe yourself?)',
    weekNumber: 20,
  },
  {
    id: 'rel-9',
    category: 'relationships',
    prompt: 'What connection are you neglecting?',
    weekNumber: 21,
  },
  {
    id: 'rel-10',
    category: 'relationships',
    prompt: "Who has been your teacher lately—even if they don't know it?",
    weekNumber: 22,
  },
  ...
  // GROWTH (Weeks 23-34)
  {
    id: 'growth-1',
    category: 'growth',
    prompt: 'What progress did you make, even if small?',
    weekNumber: 23,
  },
  {
    id: 'growth-2',
    category: 'growth',
    prompt: "What did you try that didn't work? What did you learn?",
    weekNumber: 24,
  },
  {
    id: 'growth-3',
    category: 'growth',
    prompt: 'What are you proud of that no one else knows?',
    weekNumber: 25,
  },
  {
    id: 'growth-4',
    category: 'growth',
    prompt: 'What skill are you avoiding developing? Why?',
    weekNumber: 26,
  },
  {
    id: 'growth-5',
    category: 'growth',
    prompt: 'What would make next week better than this one?',
    weekNumber: 27,
  },
  {
    id: 'growth-6',
    category: 'growth',
    prompt: 'What habit is ready to become automatic?',
    weekNumber: 28,
  },
  {
    id: 'growth-7',
    category: 'growth',
    prompt: 'Where are you settling? Where could you stretch?',
    weekNumber: 29,
  },
  { id: 'growth-8', category: 'growth', prompt: "What's the next right step?", weekNumber: 30 },
  {
    id: 'growth-9',
    category: 'growth',
    prompt: 'What challenge are you grateful for in hindsight?',
    weekNumber: 31,
  },
  {
    id: 'growth-10',
    category: 'growth',
    prompt: "What would 'leveling up' look like for you right now?",
    weekNumber: 32,
  },
  { id: 'growth-11', category: 'growth', prompt: 'What are you becoming?', weekNumber: 33 },
  {
    id: 'growth-12',
    category: 'growth',
    prompt: "What's the difference between who you are and who you want to be?",
    weekNumber: 34,
  },
  ...
  { id: 'meaning-2', category: 'meaning', prompt: 'What drained you? Why?', weekNumber: 36 },
  {
    id: 'meaning-3',
    category: 'meaning',
    prompt: 'What matters more than it used to?',
    weekNumber: 37,
  },
  {
    id: 'meaning-4',
    category: 'meaning',
    prompt: 'If you had to give a TED talk tomorrow, what would it be about?',
    weekNumber: 38,
  },
  {
    id: 'meaning-5',
    category: 'meaning',
    prompt: 'What would you regret not doing?',
    weekNumber: 39,
  },
  {
    id: 'meaning-6',
    category: 'meaning',
    prompt: 'What does success actually look like for you?',
    weekNumber: 40,
  },
  ...
  { id: 'meaning-8', category: 'meaning', prompt: 'What are you building?', weekNumber: 42 },
  {
    id: 'meaning-9',
    category: 'meaning',
    prompt: 'What legacy are you creating—even in small ways?',
    weekNumber: 43,
  },
  {
    id: 'meaning-10',
  ...
  // GRATITUDE (Weeks 45-52)
  {
    id: 'grat-1',
    category: 'gratitude',
    prompt: 'What are you grateful for that you usually take for granted?',
    weekNumber: 45,
  },
  {
    id: 'grat-2',
    category: 'gratitude',
    prompt: 'What small moment brought you joy this week?',
    weekNumber: 46,
  },
  {
    id: 'grat-3',
    category: 'gratitude',
    prompt: 'What struggle are you grateful for?',
    weekNumber: 47,
  },
  { id: 'grat-4', category: 'gratitude', prompt: 'Who deserves your thanks?', weekNumber: 48 },
  {
    id: 'grat-5',
    category: 'gratitude',
    prompt: 'What about this season of life will you miss someday?',
    weekNumber: 49,
  },
  {
    id: 'grat-6',
    category: 'gratitude',
    prompt: 'What simple pleasure did you enjoy this week?',
    weekNumber: 50,
  },
  {
    id: 'grat-7',
    category: 'gratitude',
    prompt: "What's right in your life right now?",
    weekNumber: 51,
  },
...
export function recordParticipation(
  ...
  log.info(
    { userId, promptId, streak: state.currentStreak },
    '🌿 Reflection Sunday participation recorded'
  );
}
...
export function getUserStats(userId: string): {
  ...
  const weeksSinceStart =
    state.reflectionsSundays.length > 0
      ? Math.ceil(
          (Date.now() - state.reflectionsSundays[0].date.getTime()) / (7 * 24 * 60 * 60 * 1000)
        )
      : 0;

  const participationRate = weeksSinceStart > 0 ? state.totalParticipations / weeksSinceStart : 0;
