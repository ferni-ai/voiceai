 ...
 */
async function batchDeleteDocs(docs, operationName) {
 ...
 */
export async function saveOutreachProfile(userId, data) {
 ...
 */
export async function loadOutreachProfile(userId) {
    if (!isFirestoreAvailable()) {
        return null;
    }
    try {
 ...
 */
export async function deleteOutreachProfile(userId) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 */
export async function saveTrigger(trigger, scheduledFor) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 */
export async function updateTriggerStatus(triggerId, status, scheduledFor) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 */
export async function loadPendingTriggers(userId) {
    if (!isFirestoreAvailable()) {
        return [];
    }
    try {
        const snapshot = await firestoreClient
            ...
            .get();
        return snapshot.docs.map((doc) => doc.data().trigger);
    }
    catch (error) {
 ...
 */
export async function loadAllPendingTriggers() {
    if (!isFirestoreAvailable()) {
        return [];
    }
    try {
 ...
 */
export async function loadPendingTriggersWithLimit(limit) {
    if (!isFirestoreAvailable()) {
        return [];
    }
    try {
 ...
 */
export async function cleanupOldTriggers(maxAgeDays = 7) {
    if (!isFirestoreAvailable()) {
        return 0;
    }
    try {
 ...
 */
export async function saveToHistory(userId, decision) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 */
export async function loadHistory(userId, limit = 50) {
    if (!isFirestoreAvailable()) {
        return [];
    }
    try {
        const snapshot = await firestoreClient
            ...
            .limit(limit)
            .get();
        return snapshot.docs.map((doc) => doc.data().decision);
    }
    catch (error) {
 ...
 */
export async function saveContext(userId, context) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 */
export async function deleteUserContext(userId) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 */
export async function deleteAllUserOutreachData(userId) {
 ...
 */
export async function getOutreachStats(userId, days = 30) {
    const defaultStats = {
        totalSent: 0,
        byChannel: {},
        byTrigger: {},
 ...
 */
export async function updateDeliveryStatus(userId, deliveryId, status, details) {
    if (!isFirestoreAvailable())
        return;
    try {
        const ref = firestoreClient
 ...
 */
export async function loadDeliveryRecords(userId, limit = 50) {
    if (!isFirestoreAvailable())
        return [];
    try {
        const ref = firestoreClient
 ...
 * Update A/B test
 */
export async function updateABTest(testId, updates) {
    if (!isFirestoreAvailable())
        return;
    try {
 ...
 */
export async function loadActiveABTests() {
    if (!isFirestoreAvailable())
        return [];
    try {
        const snapshot = await firestoreClient
 ...
 */
export async function saveTestAssignment(assignment) {
    if (!isFirestoreAvailable())
        return;
    try {
        const ref = firestoreClient
 ...
 */
export async function loadTestAssignment(testId, userId) {
    if (!isFirestoreAvailable())
        return null;
    try {
        const ref = firestoreClient
 ...
 */
export async function recordTestConversion(testId, userId) {
    if (!isFirestoreAvailable())
        return;
    try {
        const ref = firestoreClient
 ...
 */
export async function savePendingInAppMessage(userId, message, type, options) {
    if (!isFirestoreAvailable()) {
 ...
 */
export async function loadPendingInAppMessages(userId) {
    if (!isFirestoreAvailable()) {
        return [];
    }
    try {
 ...
 */
export async function deletePendingInAppMessage(messageId) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 */
export async function deleteUserPendingMessages(userId) {
    if (!isFirestoreAvailable()) {
        return;
    }
    try {
 ...
 * FIX: Now handles batch limit properly and supports larger cleanups
 */
export async function cleanupExpiredPendingMessages() {
    if (!isFirestoreAvailable()) {
        return 0;
    }
    try {
