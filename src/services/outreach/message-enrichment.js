...
import { classifyIntent, generateSemanticMessage, getTimeContext, inferRelationshipStage as inferRelationshipStageFromSemantic, } from './semantic-message-system.js';
 ...
 */
function inferRelationshipStage(relationship) {
 ...
 */
function buildVoicemailComponentsPrompt(context) {
 ...
 */
export async function enrichMessage(context) {
 ...
 */
function generateFromSemantic(context, intent, startTime) {
    const stage = context.relationship.stage ||
 ...
 */
async function generateFromLLM(context, startTime) {
 ...
 */
export async function enrichVoicemailMessage(context) {
    const startTime = Date.now();
    log.info({
        originalMessage: context.originalMessage,
        contactName: context.relationship.contactName,
 ...
 */
function isAlreadyRich(message) {
...
function fallbackEnrichment(context) {
    ...
    else if (originalMessage.toLowerCase().includes('hi') ||
...
//# sourceMappingURL=message-enrichment.js.map