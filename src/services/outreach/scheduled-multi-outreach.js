 ...
 */
export async function scheduleOutreach(userId, personaId, target, scheduledFor, batchId) {
 ...
 */
export async function getPendingOutreach(userId) {
    const firestore = await getFirestore();
    if (!firestore)
        return [];
    try {
 ...
 */
export async function getScheduledOutreach(userId, options = {}) {
    const firestore = await getFirestore();
    if (!firestore)
        return [];
    try {
 ...
 */
export async function updateOutreachStatus(userId, outreachId, status, result) {
    const firestore = await getFirestore();
    if (!firestore) {
 ...
 */
export async function incrementRetry(userId, outreachId) {
    const firestore = await getFirestore();
    if (!firestore) {
 ...
 */
export async function cancelScheduledOutreach(userId, outreachId) {
    const firestore = await getFirestore();
    if (!firestore)
        return false;
    try {
 ...
 */
export async function cleanupOldOutreach(userId, olderThanDays = 30) {
    const firestore = await getFirestore();
    if (!firestore)
        return 0;
    try {
...
//# sourceMappingURL=scheduled-multi-outreach.js.map