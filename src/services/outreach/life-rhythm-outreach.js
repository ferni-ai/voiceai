...
import { predictUserState, } from '../../intelligence/life-rhythm-prediction.js';
...
const lastOutreachTimes = new Map();
const dailyOutreachCounts = new Map();
// ============================================================================
// MAIN FUNCTIONS
// ============================================================================
/**
 ...
 */
export function evaluateLifeRhythmOutreach(userId, config = {}) {
    ...
    const hasStressFactors = prediction.reasons.some((r) => r.toLowerCase().includes('stress') ||
 ...
 */
export async function triggerLifeRhythmOutreach(userId, prediction, personaId = 'ferni') {
    try {
 ...
 */
export function generateLifeRhythmMessage(prediction) {
    ...
    if (primaryReason.toLowerCase().includes('end of month') ||
    ...
    if (primaryReason.toLowerCase().includes('winter') ||
 ...
 */
export async function runDailyLifeRhythmOutreach(getUserIds) {
...
//# sourceMappingURL=life-rhythm-outreach.js.map