...
export type ActionStatus =
  | 'pending_confirmation' // Prepared, waiting for user confirmation
...
export interface UberRidePayload {
  ...
  endLongitude: number;
  endAddress?: string;
  productId?: string; // UberX, UberXL, etc.
  fareId?: string; // From estimate
...
export interface LyftRidePayload {
  ...
  primetime?: number; // Surge pricing percentage
}
...
export interface CalendarEventPayload {
  ...
  calendarId?: string;
  eventId?: string; // For updates/cancels
}
 ...
 */
export type ActionExecutor<T extends ActionPayload = ActionPayload> = (
  action: Action<T>,
