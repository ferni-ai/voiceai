 ...
 */
export const FIVE_SENSES_GROUNDING = {
    id: 'five_senses',
 ...
 */
export const PHYSICAL_GROUNDING = {
 ...
 */
export const PHYSIOLOGICAL_SIGH = {
 ...
 */
export function generateVoiceGuidance(exercise, options) {
 ...
 */
export function getStateInterventions(state) {
    switch (state) {
        case 'sympathetic':
 ...
 */
export function recordExerciseStart(userId, exerciseId, stateBefore) {
    const result = {
        exerciseId,
        userId,
        startedAt: new Date(),
 ...
 */
export function recordExerciseComplete(userId, exerciseId, helpfulnessRating, stateAfter) {
    const userResults = exerciseResults.get(userId) || [];
 ...
 */
export function getExerciseHistory(userId) {
    return exerciseResults.get(userId) || [];
}
/**
 * Get most effective exercises for a user.
 */
export function getMostEffectiveExercises(userId) {
