...
// GOAL TRACKING
// ============================================================================
export { abandonGoal, addMilestone, buildGoalContext, completeMilestone, createGoal, detectGoalStatement, exportGoalProfile, generateGoalCheckIn, getActiveGoals, getGoal, getGoalsNeedingCheckIn, getGoalStats, getGoalToCheckIn, getRecentProgress, importGoalProfile, pauseGoal, resumeGoal, updateProgress, } from './goal-tracking.js';
// ============================================================================
// ACTION PLANNING
// ============================================================================
export { buildActionContext, completeAction, createAction, deferAction, detectActionOpportunity, exportActionProfile, generateActionFollowUp, generateActionSuggestions, getActionsNeedingFollowUp, getActionStats, getActionToFollowUp, getPendingActions, importActionProfile, skipAction, } from './action-planning.js';
// ============================================================================
// OBSTACLE DETECTION
// ============================================================================
export { buildObstacleContext, detectObstacle, exportObstacleProfile, generateObstacleResponse, getActiveObstacles, getMostCommonObstacle, getObstaclePatterns, getObstacleSupport, importObstacleProfile, markObstacleAddressed, markObstacleResolved, } from './obstacle-detection.js';
// ============================================================================
// COACHING STYLE ADAPTATION
// ============================================================================
export { buildStyleContext, detectStyleSignals, exportStyleProfile, getPreferredStyle, getStyleGuidance, getStyleProfile, importStyleProfile, setExplicitStylePreference, } from './style-adaptation.js';
// ============================================================================
// EMOTIONAL GRANULARITY
// ============================================================================
export { buildGranularityContext, detectVagueExpression, exportGranularityProfile, getEmotionTeaching, getGranularityScore, getTopEmotionWords, getVocabularySuggestions, importGranularityProfile, recordExpansionAccepted, recordExpansionOffered, } from './emotional-granularity.js';
// ============================================================================
// JOURNEY TRACKING
// ============================================================================
export { buildJourneyContext, exportJourneyProfile, generateJourneyReflection, getJourneySummary, importJourneyProfile, markMilestoneCelebrated, recordBreakthrough, recordGoalCompletion, recordSession, } from './journey-tracking.js';
// ============================================================================
// HANDOFF INTELLIGENCE
// ============================================================================
export { buildHandoffContext, detectHandoffOpportunity, exportTeamExperience, generateTeamIntroduction, getBestPersonaForTopic, getUnmetTeamMembers, importTeamExperience, recordHandoff, } from './handoff-intelligence.js';
// ============================================================================
// SOCRATIC ENGINE
// ============================================================================
export { buildSocraticContext, generateQuestionSequence, generateSocraticQuestion, generateSocraticResponse, selectQuestionType, } from './socratic-engine.js';
// ============================================================================
// COGNITIVE REFRAMES
// ============================================================================
export { buildReframeContext, detectDistortions, generateReframes, getCommonDistortions, recordReframeFeedback, } from './cognitive-reframes.js';
// ============================================================================
// SEASONAL AWARENESS
// ============================================================================
export { buildSeasonalContext, exportSeasonalProfile, getCurrentSeason, getDayLength, getSeasonalContext, getUpcomingHolidays, importSeasonalProfile, isCurrentlyDifficultTime, recordDifficultTime, setHolidayPreferences, } from './seasonal-awareness.js';
// ============================================================================
// RE-ENGAGEMENT
// ============================================================================
export { exportEngagementProfile, generateNudge, getUsersNeedingNudges, importEngagementProfile, optInToReengagement, optOutOfReengagement, recordSession as recordEngagementSession, shouldSendNudge, } from './reengagement.js';
// ============================================================================
// VALUES COACHING
// ============================================================================
export { buildValuesContext, exportValuesProfile, generateValuesCheck, getValuesExplorationPrompt, identifyValue, importValuesProfile, recordValueAlignment, recordValuesExplorationResponse, suggestValuesFromConversation, } from './values-coaching.js';
// ============================================================================
// PROGRESS METRICS
// ============================================================================
export { buildProgressContext, exportProgressProfile, generateProgressReflection, generateProgressSummary, getStreakInfo, importProgressProfile, recordHighlight, recordProgressSession, resetStreak, } from './progress-metrics.js';
// ============================================================================
// CROSS-PERSONA CONTEXT
// ============================================================================
export { addCrossPersonaItem, buildCrossPersonaContext, exportTeamContext, getContextForPersona, getHandoffSummary, importTeamContext, recordPersonaInteraction, shareContext, updateCurrentSituation, } from './cross-persona-context.js';
// ============================================================================
// PERSISTENCE
// ============================================================================
export { exportAllCoachingProfiles, importAllCoachingProfiles, initializeCoachingForSession, persistCoachingForSession, } from './persistence.js';
// ============================================================================
// UNIFIED API
// ============================================================================
import { createLogger } from '../../utils/safe-logger.js';
import { buildActionContext, detectActionOpportunity, getActionToFollowUp, } from './action-planning.js';
...
import { buildGoalContext, detectGoalStatement, getActiveGoals, getGoalToCheckIn, } from './goal-tracking.js';
import { buildHandoffContext, detectHandoffOpportunity, } from './handoff-intelligence.js';
 ...
 */
export function getCoachingContextForLLM(userId, options) {
    const parts = [];
 ...
 */
export function analyzeForCoaching(userId, userMessage, options) {
    ...
    const handoffOpportunity = detectHandoffOpportunity(userId, userMessage, options?.currentPersona || 'ferni');
