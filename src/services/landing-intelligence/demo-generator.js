...
const PREBUILT_DEMOS = {
    'reading-between-lines': {
        ...
        messages: [
            ...
            {
                role: 'ferni',
                message: 'You said "fine" but I noticed something. You\'ve mentioned being tired from work three times this week. Is there something bigger going on?',
            ...
            {
                role: 'ferni',
                message: "That's why I'm here. Sometimes patterns are easier to see from the outside. Want to talk about what's really happening at work?",
            },
        ],
    ...
    'quote-callback': {
        ...
        messages: [
            ...
            {
                role: 'ferni',
                message: 'Remember when you said "I just want to feel like myself again"? That was four months ago. Look at you now—setting boundaries, asking for what you need. This IS you coming back to yourself.',
    ...
    'emotional-forecasting': {
        ...
        messages: [
            ...
            {
                role: 'ferni',
                message: "That took courage. Hey—tomorrow you might wake up second-guessing this. That's normal. It doesn't mean you were wrong.",
            ...
            {
                role: 'ferni',
                message: "I think decision fatigue is real, and doubt is part of the process. Want to write down why you made this choice while it's fresh? Future-you might need the reminder.",
            },
        ],
        generatedAt: new Date(),
    },
    'gentle-challenge': {
        ...
        messages: [
            ...
            {
                role: 'ferni',
                message: "I hear your frustration. And I'm in your corner, always. But can I gently ask—is there any part of this where you might have contributed? I'm not blaming you. I'm asking because growth sometimes hides in uncomfortable places.",
...
export async function generateDemoConversation(concern, superpower) {
...
// ============================================================================
export function getDemoForSection(section) {
    const sectionDemoMap = {
...
// ============================================================================
export async function generateUseCaseDemo(useCase) {
...
Make it feel REAL—messy human emotions, not scripted perfection.`;
    const result = await generateJSON(prompt.replace('{context}', useCase), {
        timeout: 6000,
