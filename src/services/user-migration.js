 ...
 */
export function isAlreadyMigrated(deviceId) {
 ...
 */
export function getMigratedUid(deviceId) {
 ...
 */
export async function migrateUserData(request) {
    ...
    try {
        ...
        if (existingFirebaseProfile) {
            ...
            const mergedProfile = {
                ...
                totalConversations: existingFirebaseProfile.totalConversations + sourceProfile.totalConversations,
 ...
 */
export function validateMigrationRequest(request) {
    if (!request.deviceId) {
