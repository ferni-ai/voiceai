 ...
 */
export function generateAppleJWT(service, expirationHours = 12) {
    // Check cache first
    ...
    if (!isAppleConfigured()) {
        throw new Error('Apple credentials not configured. Set APPLE_TEAM_ID, APPLE_KEY_ID, and APPLE_PRIVATE_KEY');
    }
 ...
 */
export function getMusicKitToken() {
    return generateAppleJWT('musickit');
}
/**
 * Get WeatherKit token
 */
export function getWeatherKitToken() {
...
//# sourceMappingURL=apple-jwt.js.map