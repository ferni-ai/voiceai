...
export class WorkflowEngine extends EventEmitter {
    ...
    markDirty;
    taskQueue;
    constructor(getUserData, markDirty, taskQueue) {
        super();
     ...
     */
    getWorkflowFromData(allData, workflowId) {
     ...
     */
    async runWorkflow(allData, workflowId) {
     ...
     */
    pauseWorkflow(allData, workflowId, reason, requiresInput) {
        const workflow = this.getWorkflowFromData(allData, workflowId);
        if (!workflow)
            return;
     ...
     */
    async resumeWorkflow(allData, workflowId, userInput) {
        const workflow = this.getWorkflowFromData(allData, workflowId);
