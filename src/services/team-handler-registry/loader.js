 ...
 */
export async function loadLegacyHandlers() {
    const errors = [];
    let loaded = 0;
    const legacyModules = [
        { agentId: 'maya', module: '../../tools/maya-team-handlers.js' },
        { agentId: 'alex', module: '../../tools/alex-team-handlers.js' },
        { agentId: 'jordan', module: '../../tools/jordan-team-handlers.js' },
        { agentId: 'peter-john', module: '../../tools/peter-team-handlers.js' },
        { agentId: 'ferni', module: '../../tools/ferni-team-handlers.js' },
    ];
 ...
 */
export async function loadHandlersFromManifests() {
    const errors = [];
    let loaded = 0;
    try {
        ...
        for (const bundle of bundles) {
            ...
            const agentId = manifest.identity.id;
...
export async function initializeTeamHandlerRegistry(options = {}) {
    ...
    const results = {
        legacy: { loaded: 0, errors: [] },
        manifests: { loaded: 0, errors: [] },
    };
 ...
 */
export function wrapLegacyHandler(id, name, description, capability, execute, options) {
    return {
        id,
        name,
        description,
