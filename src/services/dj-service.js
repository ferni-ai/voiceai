...
export const DJ_PERSONA_STYLES = {
    ferni: {
        style: 'warm',
...
export function getDJStyle(personaId) {
 ...
 */
export function getSpontaneousMusicOffer(personaId, context) {
...
function getMoodBasedOffer(personaId, mood, style) {
    const moodOffers = {
        hype: {
            happy: [
    ...
    const moodKey = mood === 'sad' || mood === 'anxious' || mood === 'stressed'
        ? 'stressed'
...
function getTimeBasedOffer(personaId, timeOfDay, style) {
    const timeOffers = {
        morning: {
            hype: [
...
function getGenericMusicOffer(personaId, style) {
    const genericOffers = {
        hype: [
 ...
 */
export function getQueueTeaser(personaId, hasQueue) {
    const style = getDJStyle(personaId);
    if (!hasQueue) {
...
function getContinuityOffer(personaId, style) {
    const offers = {
        hype: [
 ...
 */
export function getMusicAppreciationComment(personaId, _track) {
    const style = getDJStyle(personaId);
 ...
 */
export function getMusicElementAppreciation(personaId) {
    const style = getDJStyle(personaId);
 ...
 */
export function getMusicConversationStarter(personaId, context) {
    const style = getDJStyle(personaId);
...
function getTrackConversation(personaId, track, style) {
    const questions = {
        hype: [
...
function getTasteConversation(personaId, history, style) {
...
function getGeneralMusicConversation(personaId, style) {
    const questions = {
 ...
 */
export function getReadTheRoomAction(context, personaId) {
    const style = getDJStyle(personaId);
 ...
 */
export function getContextualMusicSuggestion(conversationContext, personaId) {
    const style = getDJStyle(personaId);
...
function getSuggestionPhrase(style, type) {
    const suggestions = {
        calming: {
 ...
 */
export function getMusicDiscoveryOffer(personaId) {
    const style = getDJStyle(personaId);
    const offers = {
        hype: [
 ...
 */
export function getCrossSessionMusicCallback(personaId, musicMemory) {
