 ...
 */
export async function controlLights(userId, options) {
 ...
 */
export async function setThermostat(userId, options) {
 ...
 */
export async function activateScene(userId, sceneName) {
    ...
    try {
        ...
        if (await hk.isHomeKitConnected(userId)) {
            ...
            const match = scenes.find((s) => s.name.toLowerCase().includes(sceneName.toLowerCase()) ||
...
//# sourceMappingURL=unified-smart-home.js.map