...
export class SmsSender {
     ...
     */
    generateMessage(target, domain, type, requirements) {
    ...
    buildRestaurantSms(requirements) {
        const parts = [];
    ...
    buildGenericSms(type, requirements) {
        const typeMessages = {
     ...
     */
    async simulateSms(target, message) {
     ...
     */
    async handleIncomingResponse(from, body, requestId) {
