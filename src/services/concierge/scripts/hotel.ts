...
export const hotelScripts: OutreachScript[] = [
  // Quote request script
  {
    ...
    introduction:
      "I'm Alex, calling on behalf of {{userName}}. I'm helping them find hotel accommodations.",
...
Could you tell me your best available rate? And are there any promotions or discounts I should know about - like AAA, AARP, or corporate rates?`,
    ...
    thankYou:
      "That's very helpful, thank you so much! I'll share this with {{userName}} and they may call back to book.",
  ...
  // Booking script
  {
    ...
    introduction:
      "I'm Alex, calling on behalf of {{userName}}. They spoke with your hotel earlier and would like to proceed with a booking.",
...
Can we proceed with that reservation?`,
  ...
  // Inquiry script
  {
    ...
    introduction:
      "I'm Alex, calling on behalf of {{userName}}. They have a few questions about your hotel.",
