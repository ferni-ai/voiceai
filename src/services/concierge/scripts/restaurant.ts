...
export const restaurantScripts: OutreachScript[] = [
  // Reservation request
  {
    domain: 'restaurant',
    type: 'booking',
    ...
    introduction:
      "I'm Alex, calling on behalf of {{userName}}. I'm helping them make a dinner reservation.",
...
Do you have availability?`,
  ...
  // Quote/inquiry for large events
  {
    ...
    introduction:
      "I'm Alex, calling on behalf of {{userName}}. They're interested in hosting an event at your restaurant.",
