...
export const localServiceScripts: OutreachScript[] = [
  // Quote request
  {
    ...
    introduction:
      "I'm Alex, calling on behalf of {{userName}}. They're looking for help with a home project.",
...
Would you be able to provide an estimate?`,
  ...
  // Scheduling
  {
    ...
    introduction:
      "I'm Alex, calling back for {{userName}}. They spoke with you about {{serviceType}} and would like to schedule.",
