 ...
 */
function getSamplesPath(userId) {
...
export async function saveVoiceProfile(profile) {
    ...
    try {
        ...
        // "We know your voice"
        void onVoiceRecognitionChange(profile.userId, `voice_profile_${profile.userId}`, {
 ...
 */
export async function loadVoiceProfile(userId) {
 ...
 */
export async function recordVerification(userId, success) {
    const db = getFirestoreInstance();
    if (!db) {
 ...
 */
export async function loadAllVoiceProfiles(options) {
    const db = getFirestoreInstance();
    if (!db) {
        return [];
    }
 ...
 */
export async function getVoiceProfileStats(userId) {
    // Check memory cache first
    const cached = memoryCache.get(userId);
    if (cached) {
        return {
 ...
 */
export async function updateVoiceProfileIndex(profile) {
 ...
 */
export async function loadVoiceProfileIndex() {
    const db = getFirestoreInstance();
    if (!db) {
 ...
 */
export async function removeFromVoiceProfileIndex(userId) {
    const db = getFirestoreInstance();
    if (!db) {
        return;
    }
...
//# sourceMappingURL=voice-profile-store.js.map