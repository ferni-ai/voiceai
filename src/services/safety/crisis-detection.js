 ...
 */
export function detectCrisis(text, context) {
    const signals = [];
...
export function getHighestSeverityCrisis(signals) {
    ...
    return signals.reduce((highest, current) => severityOrder[current.severity] > severityOrder[highest.severity] ? current : highest);
}
// ============================================================================
// EXPORTS
// ============================================================================
