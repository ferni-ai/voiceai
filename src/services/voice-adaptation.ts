...
export interface VoiceModifiers {
  ...
  pauseMultiplier: number; // Multiplier for pauses
 ...
 */
export function getPersonaVoiceProfile(personaId: string): VoiceModifiers {
 ...
 */
export function applyPauseMultiplier(content: string, multiplier: number): string {
 ...
 */
export async function addMicroExpressions(
  content: string,
  personaId: string,
