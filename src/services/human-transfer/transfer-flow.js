 ...
 */
export function evaluateTransferNeed(transcript) {
 ...
 */
export function getAvailableServices(escalationType) {
 ...
 */
export async function initiateWarmTransfer(request) {
...
// ============================================================================
async function initiateEmergencyTransfer(userId, decision, summary) {
...
async function initiateCrisisTransfer(userId, decision, summary) {
    const service = CRISIS_SERVICES['988'];
...
async function initiateTherapyTransfer(userId, decision, consent, summary) {
...
async function initiateLegalTransfer(userId, decision, summary) {
    return {
        success: true,
        channel: 'referral_link',
...
async function initiateFinancialTransfer(userId, decision, summary) {
...
async function initiateMedicalTransfer(userId, decision, summary) {
    return {
        success: true,
        channel: 'referral_link',
...
// MESSAGE GENERATORS
// ============================================================================
function generateEmergencyMessage(service) {
...
function generateCrisisSupportMessage(main, text) {
...
function generateTherapyMessage(summary) {
...
function generateDeclinedMessage(decision) {
...
function getResourcesList(escalationType) {
 ...
 */
export function generateConsentRequest(decision) {
