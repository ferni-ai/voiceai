 ...
 */
export async function generateTransferSummary(escalationType, userProfile, conversations, crisisContext) {
...
// SECTION GENERATORS
// ============================================================================
function generateOpeningSection(profile, escalationType) {
...
function generateReasonSection(escalationType, crisisContext) {
...
function generateContextSection(profile, conversations) {
...
function generatePreferencesSection(profile) {
    const preferences = [];
    if (profile.pronouns) {
...
function generateAlreadyTriedSection(profile) {
    if (!profile.alreadyTried || profile.alreadyTried.length === 0)
        return null;
...
function extractKeyTopics(conversations, profile) {
 ...
 */
export function generateMinimalSummary(escalationType, urgency) {
    let summary = '';
    switch (escalationType) {
        case 'crisis_immediate':
        case 'crisis_support':
 ...
 */
export function generateTopicsOnlySummary(escalationType, urgency, topics) {
...
//# sourceMappingURL=context-summary.js.map