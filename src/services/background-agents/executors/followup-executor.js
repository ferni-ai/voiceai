 ...
 */
export async function executeFollowup(request) {
    log.info({ userId: request.userId, recipient: request.recipientName, channel: request.channel }, 'Executing follow-up');
    ...
    try {
        ...
        log.info({ userId: request.userId, recipient: request.recipientName, sent: result.sent }, 'Follow-up completed');
        return result;
    }
    catch (error) {
 ...
 */
export async function queueFollowup(request) {
...
// ============================================================================
async function sendFollowupMessage(request) {
...
function buildDetails(request, result) {
    const lines = [
...
//# sourceMappingURL=followup-executor.js.map