 ...
 */
export async function executeReservationTask(request) {
    log.info({
    ...
    try {
        ...
        const status = result.success ? 'success' : 'partial_success';
 ...
 */
async function performReservation(request) {
    switch (request.type) {
        case 'restaurant':
 ...
 */
async function performRestaurantReservation(request) {
 ...
 * Hotel reservation
 */
async function performHotelReservation(request) {
 ...
 */
async function performVenueReservation(request) {
 ...
 */
async function performActivityReservation(request) {
 ...
 */
async function performServiceReservation(request) {
 ...
 */
async function performGenericReservation(request) {
 ...
 */
async function simulateReservationDelay() {
    await new Promise((resolve) => setTimeout(resolve, 1000));
}
/**
 * Generate a confirmation number
 */
function generateConfirmationNumber(prefix) {
 ...
 */
function buildReservationSummary(request, result) {
 ...
 */
function buildDetailedDescription(request, result) {
    const lines = [];
    if (result.success) {
 ...
 */
export async function queueReservationTask(request) {
...
//# sourceMappingURL=reservation-executor.js.map