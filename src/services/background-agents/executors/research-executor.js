 ...
 */
export async function executeResearchTask(request) {
    log.info({ userId: request.userId, query: request.query, type: request.type }, 'Starting background research task');
 ...
 */
async function performResearch(request) {
    switch (request.type) {
        case 'stock_analysis':
 ...
 */
async function performStockResearch(query, depth) {
 ...
 * Market research
 */
async function performMarketResearch(query, depth) {
 ...
 * Deep dive research
 */
async function performDeepDive(query, context) {
 ...
 * General research
 */
async function performGeneralResearch(query) {
 ...
 */
async function simulateResearchDelay(depth) {
    const delays = {
        quick: 500,
        standard: 1000,
        comprehensive: 2000,
 ...
 */
function buildResearchSummary(query, findings, type) {
 ...
 */
function getMethodologyDescription(type, depth) {
    const methodologies = {
 ...
 */
export async function queueResearchTask(request) {
...
//# sourceMappingURL=research-executor.js.map