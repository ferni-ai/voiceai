 ...
 */
export async function executeCall(request) {
 ...
 */
export async function queueCall(request) {
...
// CALL IMPLEMENTATION
// ============================================================================
async function makeConversationalCall(request, callId) {
    try {
        // Try to use the existing conversational call service
        const { makeConversationalCall: makeCall, isConversationalCallingConfigured } = await import('../../voice/conversational-call.service.js');
...
//# sourceMappingURL=call-executor.js.map