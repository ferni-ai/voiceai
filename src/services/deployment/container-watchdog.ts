 ...
 *
 * Integration:
 *   import { startWatchdog } from './services/deployment/container-watchdog.js';
...
import { SlackNotificationService, type NotificationType } from '../integrations/slack-notifications.js';
import {
  quickDiagnose,
  analyzeFailure,
