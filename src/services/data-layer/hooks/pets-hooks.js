 ...
 */
export const onPetChange = createDomainHook({
    entityType: 'pet',
    storeType: 'contacts',
 ...
 */
export const onPetHealthChange = createDomainHook({
 ...
 */
export const onPetMilestoneChange = createDomainHook({
...
//# sourceMappingURL=pets-hooks.js.map