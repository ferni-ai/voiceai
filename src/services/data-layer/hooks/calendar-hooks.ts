 ...
 */
export const onCalendarEventChange = createDomainHook<CalendarEventEntity>({
  storeType: 'calendar',
 ...
 */
export const onMeetingMemoryChange = createDomainHook<MeetingMemoryEntity>({
  storeType: 'calendar',
 ...
 */
export const onRecurringCommitmentChange = createDomainHook<RecurringCommitmentEntity>({
  storeType: 'calendar',
 ...
 */
export const onCalendarConflictChange = createDomainHook<CalendarConflictEntity>({
  storeType: 'calendar',
 ...
 */
export const onMeetingPrepChange = createDomainHook<MeetingPrepEntity>({
  storeType: 'calendar',
 ...
 */
export const onAvailabilityPatternChange = createDomainHook<AvailabilityPatternEntity>({
  storeType: 'calendar',
 ...
 */
export const onTimeBlockChange = createDomainHook<TimeBlockEntity>({
  storeType: 'calendar',
 ...
 */
export const onDeadlineChange = createDomainHook<DeadlineEntity>({
  storeType: 'calendar',
  entityType: 'deadline',
  contentBuilder: (d) =>
    joinNonEmpty([
