 ...
 */
export const onPersonaAffinityChange = createDomainHook<PersonaAffinityEntity>({
  entityType: 'persona_affinity',
  storeType: 'conversation',
  contentBuilder: (entity: PersonaAffinityEntity) =>
    joinNonEmpty([
 ...
 */
export const onHandoffPreferenceChange = createDomainHook<HandoffPreferenceEntity>({
  entityType: 'handoff_preference',
  storeType: 'conversation',
  contentBuilder: (entity: HandoffPreferenceEntity) =>
    joinNonEmpty([
 ...
 */
export const onPersonaInteractionHistoryChange = createDomainHook<PersonaInteractionHistoryEntity>({
  entityType: 'persona_interaction_history',
  storeType: 'conversation',
  contentBuilder: (entity: PersonaInteractionHistoryEntity) =>
    joinNonEmpty([
  ...
  shouldSkip: (entity: PersonaInteractionHistoryEntity) => {
