...
import type {
  VoiceBiomarkerEntity,
  SessionSummaryEntity,
  PatternInsightEntity,
  BehavioralPatternEntity,
  CrossSessionThreadEntity,
  CorrelationInsightEntity,
  ProtectiveMomentEntity,
...
export const onVoiceBiomarkerChange = createDomainHook<VoiceBiomarkerEntity>({
...
export function deindexVoiceBiomarker(userId: string, biomarkerId: string): void {
...
export const onSessionSummaryChange = createDomainHook<SessionSummaryEntity>({
...
export function deindexSessionSummary(userId: string, sessionId: string): void {
...
export const onPatternInsightChange = createDomainHook<PatternInsightEntity>({
...
export function deindexPatternInsight(userId: string, patternId: string): void {
...
export const onBehavioralPatternChange = createDomainHook<BehavioralPatternEntity>({
...
export function deindexBehavioralPattern(userId: string, patternId: string): void {
...
export const onCrossSessionThreadChange = createDomainHook<CrossSessionThreadEntity>({
...
export function deindexCrossSessionThread(userId: string, threadId: string): void {
...
export const onCorrelationInsightChange = createDomainHook<CorrelationInsightEntity>({
...
export function deindexCorrelationInsight(userId: string, correlationId: string): void {
...
export const onProtectiveMomentChange = createDomainHook<ProtectiveMomentEntity>({
...
export function deindexProtectiveMoment(userId: string, momentId: string): void {
...
export const onVoiceRecognitionChange = createDomainHook<VoiceRecognitionEntity>({
...
export function deindexVoiceRecognition(userId: string, profileId: string): void {
