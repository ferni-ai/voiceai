...
onVoiceBiomarkerChange, deindexVoiceBiomarker, 
// Session summaries - "We remember your whole story"
onSessionSummaryChange, deindexSessionSummary, 
// Pattern insights - "We see patterns you can't see yourself"
onPatternInsightChange, deindexPatternInsight, 
...
onCrossSessionThreadChange, deindexCrossSessionThread, 
// Correlation insights - "We find connections you'd never notice"
onCorrelationInsightChange, deindexCorrelationInsight, 
// Protective moments - "We know when NOT to say something"
onProtectiveMomentChange, deindexProtectiveMoment, 
// Voice recognition - "We know your voice"
onVoiceRecognitionChange, deindexVoiceRecognition, betterThanHumanHooks, } from './better-than-human-hooks.js';
// ============================================================================
// ALL HOOKS OBJECT
// ============================================================================
...
import { onFavoritePlaceChange, onLocationMemoryChange, onGeographicPreferenceChange, } from './location-hooks.js';
import { onPetChange, onPetHealthChange, onPetMilestoneChange } from './pets-hooks.js';
import { onVehicleChange, onHomeMaintenanceChange, onPropertyAssetChange, } from './property-hooks.js';
...
import { onOutreachAttemptChange, onOutreachResponseChange, onOutreachPreferenceChange, } from './outreach-history-hooks.js';
import { onPersonaAffinityChange, onHandoffPreferenceChange, onPersonaInteractionHistoryChange, } from './persona-hooks.js';
 ...
 */
export function getDomainHooks(domain) {
    const hooks = {
        trust: trustHooks,
        superhuman: superhumanHooks,
        calendar: calendarHooks,
        contacts: contactsHooks,
        coaching: coachingHooks,
        health: healthHooks,
        media: mediaHooks,
        career: careerHooks,
        wisdom: wisdomHooks,
        misc: miscHooks,
        'better-than-human': betterThanHumanHooks,
        'life-stage': lifeStageHooks,
        ...
        'outreach-history': outreachHistoryHooks,
