 ...
 */
export const onHealthGoalChange = createDomainHook({
    storeType: 'health',
    entityType: 'health_goal',
    contentBuilder: (h) => joinNonEmpty([
        `Health goal: ${h.goal}.`,
        `Category: ${h.category}.`,
 ...
 */
export const onWellnessCheckinChange = createDomainHook({
    storeType: 'health',
 ...
 */
export const onSleepPatternChange = createDomainHook({
    storeType: 'health',
 ...
 */
export const onEnergyLevelChange = createDomainHook({
    storeType: 'health',
 ...
 */
export const onWorkoutChange = createDomainHook({
    storeType: 'health',
    entityType: 'workout',
    contentBuilder: (w) => joinNonEmpty([
        `Workout: ${w.activity}.`,
 ...
 */
export const onMentalHealthNoteChange = createDomainHook({
    storeType: 'health',
 ...
 */
export const onNutritionGoalChange = createDomainHook({
    storeType: 'health',
    entityType: 'nutrition_goal',
    contentBuilder: (n) => joinNonEmpty([
 ...
 */
export const onBodyAwarenessChange = createDomainHook({
    storeType: 'health',
 ...
 */
export const onStressTriggerChange = createDomainHook({
    storeType: 'health',
 ...
 */
export const onRecoveryPracticeChange = createDomainHook({
    storeType: 'health',
 ...
 */
export const onHealthSummaryChange = createDomainHook({
    storeType: 'health',
...
//# sourceMappingURL=health-hooks.js.map