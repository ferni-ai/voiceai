 ...
 */
export const onConversationThreadChange = createDomainHook({
 ...
 */
export const onVisualMemoryChange = createDomainHook({
    storeType: 'memory',
 ...
 */
export const onReminderChange = createDomainHook({
 ...
 */
export const onCallResultChange = createDomainHook({
    storeType: 'outreach',
 ...
 */
export const onFollowUpActionChange = createDomainHook({
    storeType: 'outreach',
 ...
 */
export const onScheduledOutreachChange = createDomainHook({
    storeType: 'outreach',
...
//# sourceMappingURL=misc-hooks.js.map