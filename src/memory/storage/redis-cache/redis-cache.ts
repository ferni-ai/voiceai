/**
 * Redis Cache Layer — main class.
 * @module memory/storage/redis-cache/redis-cache
 */

import { gzip, gunzip } from 'zlib';
import { promisify } from 'util';
import { getLogger } from '../../../utils/safe-logger.js';
import type { RedisConfig, RedisClient, SessionCacheData } from './types.js';

export type { RedisConfig, RedisClient, SessionCacheData };
