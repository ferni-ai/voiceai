...
export class NativeRustAcceleratorUnavailableError extends Error {
    constructor(reason) {
        super(`Native Rust accelerator module not available: ${reason}\n` +
            'Solutions:\n' +
 ...
 */
export function getRustLoadError() {
 ...
 */
export function requireRustAccelerator() {
    loadRustPerf();
}
/**
 ...
 */
export function batchCosineSimilarity(query, candidates) {
 ...
 */
export function batchEuclideanDistance(query, candidates) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function euclideanDistanceF32(a, b) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchEuclideanDistanceF32(query, candidates, candidateCount) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function normalizeVectorF32(v) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchNormalizeVectorsF32(embeddings, embeddingCount) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function vectorNormF32(v) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function computeCentroidF32(embeddings, embeddingCount) {
    const perf = loadRustPerf();
 ...
 */
export function textSimilarity(text1, text2, shingleSize = 3) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchTextSimilarity(query, candidates, shingleSize = 3) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function findDuplicatesLsh(texts, threshold, numHashes = 100, numBands = 20) {
    const perf = loadRustPerf();
 ...
 */
export function toFlatFloat32Array(embeddings) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchCosineSimilarityOptimized(query, candidates) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function findSimilarPairs(embeddings, threshold, dim = OPENAI_EMBEDDING_DIM) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function topKSimilar(query, candidates, k, minSimilarity = 0) {
    if (candidates.length === 0) {
 ...
 */
export function isF32SimdAvailable() {
    const perf = tryLoadRustPerf();
 ...
 */
export function resetAcceleratorMetrics() {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function findSimilarPairsOptimized(embeddings, threshold, dim = OPENAI_EMBEDDING_DIM) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchSearchOptimized(query, candidates, k = 10, minSimilarity = 0) {
    const start = performance.now();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchCosineSimilarityWithMetrics(query, candidates) {
    const start = performance.now();
 ...
 */
function convertToRustProfile(profile, embeddingIndex) {
    const keywordsFlat = [];
    const keywordWeightsFlat = [];
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchScoreToolsOptimized(query, profiles, queryEmbedding = null, config = {}) {
    const start = performance.now();
    const fullConfig = {
    ...
    const rustProfiles = profiles.map((p, i) => {
    ...
    const queryEmbF32 = queryEmbedding
        ...
        : null;
    const rustResults = perf.batchScoreTools(query, rustProfiles, queryEmbF32, toolEmbeddings, embeddingDim, fullConfig);
    const elapsed = performance.now() - start;
    metrics.nativeCalls++;
    metrics.totalTimeMs += elapsed;
 ...
 */
export function isBatchToolScoringNativeAvailable() {
    const perf = tryLoadRustPerf();
 ...
 */
export function shouldUseNativePath(operation, itemCount) {
    if (!isRustAvailable())
        return false;
 ...
 */
export function logAcceleratorStatus() {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function deduplicateInjectionsOptimized(injections, similarityThreshold = 0.7) {
 ...
 */
export function isInjectionDeduplicationNativeAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function analyzeMessageOptimized(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchAnalyzeMessagesOptimized(messages) {
    const perf = loadRustPerf();
 ...
 */
export function isMessageAnalysisNativeAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function detectEmotionalStateOptimized(text, voice) {
    const perf = loadRustPerf();
 ...
 */
export function isEmotionalStateNativeAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function analyzeConversationDynamicsOptimized(turns) {
    if (turns.length === 0) {
        return {
            avgUserWords: 0,
            avgAgentWords: 0,
    ...
    if (!perf.analyzeConversationDynamics) {
        throw new NativeRustAcceleratorUnavailableError('analyzeConversationDynamics function not found');
    }
 ...
 */
export function isConversationDynamicsNativeAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function calculateStatisticsF32(values) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function calculateLinearTrendF32(values) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function exponentialSmoothingF32(values, alpha, beta) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function calculateSeasonalityF32(values, maxPeriod) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchCalculateStatisticsF32(seriesFlat, seriesLengths) {
    const perf = loadRustPerf();
    if (!perf.batchCalculateStatisticsF32) {
        throw new NativeRustAcceleratorUnavailableError('batchCalculateStatisticsF32 function not found');
    }
 ...
 */
export function isTimeSeriesForecastingAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function buildGuidanceAutomaton() {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function stripGuidanceBlocks(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function containsGuidanceBlocks(text) {
    const perf = loadRustPerf();
 ...
 */
export function clearGuidanceAutomaton() {
    const perf = tryLoadRustPerf();
 ...
 */
export function isGuidanceStrippingAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function analyzeFluency(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function hasDisfluencies(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function countInterjections(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchAnalyzeFluency(texts) {
    const perf = loadRustPerf();
 ...
 */
export function isFluencyAnalysisAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function analyzeTurnBoundary(text) {
    const perf = loadRustPerf();
    if (!perf.analyzeTurn) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function hasTurnFinalPhrase(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function hasContinuationPhrase(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function getTurnCompleteProbability(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchAnalyzeTurnBoundary(texts) {
    const perf = loadRustPerf();
 ...
 */
export function isTurnAnalysisAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function extractMemorySignals(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function extractHighValueSignals(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function hasMemorableSignals(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchExtractMemorySignals(texts) {
    const perf = loadRustPerf();
 ...
 */
export function isSignalExtractionAvailable() {
    const perf = tryLoadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function countWordsRust(text) {
    const perf = loadRustPerf();
    if (!perf.countWords) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function countTokensApproxRust(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function countCharsRust(text) {
    const perf = loadRustPerf();
    if (!perf.countChars) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function countBytesRust(text) {
    const perf = loadRustPerf();
    if (!perf.countBytes) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function countSentencesRust(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function countLinesRust(text) {
    const perf = loadRustPerf();
    if (!perf.countLines) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function getTextStatsRust(text) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function exceedsTokenLimitRust(text, limit) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function truncateToTokensRust(text, maxTokens) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchCountWordsRust(texts) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchCountTokensRust(texts) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchGetStatsRust(texts) {
    const perf = loadRustPerf();
 ...
 */
export function isTokenCountingAvailable() {
    const perf = tryLoadRustPerf();
...
export class FftProcessor {
    ...
    getSpectralRolloff(threshold = 0.95) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function createFftProcessor(fftSize) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function getRmsEnergyRust(samples) {
    const perf = loadRustPerf();
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function getZeroCrossingRateRust(samples) {
    const perf = loadRustPerf();
 ...
 */
export function isFftAnalysisAvailable() {
    const perf = tryLoadRustPerf();
...
export class NativeEmbeddingCache {
    ...
    pruneExpired(currentTimeMs = Date.now()) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function createEmbeddingCache(maxSize, defaultTtlMs) {
 ...
 * @throws NativeRustAcceleratorUnavailableError if native module not available
 */
export function batchHashTextsSha256(texts) {
    const perf = loadRustPerf();
 ...
 */
export function isEmbeddingCacheAvailable() {
    const perf = tryLoadRustPerf();
...
//# sourceMappingURL=rust-accelerator.js.map