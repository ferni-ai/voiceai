 ...
 */
export async function indexKeyMoments(
  userId: string,
  moments: KeyMoment[],
 ...
 */
export async function indexOpenThreads(
  userId: string,
 ...
 */
export async function indexFollowUps(
  userId: string,
 ...
 */
export async function indexLifeEvents(
  userId: string,
  events: LifeEvent[],
  store: AnyVectorStore
): Promise<number> {
 ...
 */
export async function indexGoals(
  userId: string,
  goals: FinancialGoal[],
  store: AnyVectorStore
): Promise<number> {
 ...
 */
export async function indexPersonaMemories(
  userId: string,
 ...
 */
export async function indexSharedContent(
  userId: string,
 ...
 */
export async function indexPreferences(
  userId: string,
  profile: UserProfile,
  store: AnyVectorStore
): Promise<number> {
 ...
 */
export async function indexEntertainment(
  userId: string,
