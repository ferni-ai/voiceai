        ...
        return llm.tool({
            ...
            execute: async ({ decision, category, timeline, stakeholders }) => {
                ...
                if (stakeholders?.length)
                    response += `**Stakeholders:** ${stakeholders.join(', ')}\n`;
                response += `\n---\n\n`;
...
const walkThroughDecisionFrameworkDef = {
...
// SUPPORT TOOLS
// ============================================================================
const prepareSecondOpinionQuestionsDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ decision, whoToAsk, whatTheyNeed }) => {
                ...
                response += `**Decision:** ${decision}\n`;
                if (whoToAsk?.length)
                    response += `**Planning to ask:** ${whoToAsk.join(', ')}\n`;
                response += `\n---\n\n`;
...
const reflectOnPastDecisionsDef = {
        ...
        return llm.tool({
            ...
            execute: async ({ currentDecision, pastDecision, outcome }) => {
                ...
                if (pastDecision) {
                    ...
                    if (outcome)
                        response += `**How it turned out:** ${outcome}\n`;
                    response += `\n`;
                }
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('decisions', decisionsTools);
