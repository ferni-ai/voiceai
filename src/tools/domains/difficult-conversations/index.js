...
// PREPARATION TOOLS
// ============================================================================
const prepareHardConversationDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ conversationType, withWhom, whatAbout, whatTheyFear, whatTheyHope }, { ctx: toolCtx }) => {
                ...
                const typeInfo = CONVERSATION_TYPES[conversationType] ||
        ...
        return llm.tool({
            ...
            execute: async ({ situation, framework }) => {
                ...
                if (!framework || framework === 'custom') {
                    ...
                    const fw = CONVERSATION_FRAMEWORKS[framework];
...
// BOUNDARY TOOLS
// ============================================================================
const setBoundaryConversationDef = {
...
// REPAIR TOOLS
// ============================================================================
const repairRelationshipRuptureDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ whatHappened, relationship, theirPart, yourPart, whatTheyWant }, { ctx: toolCtx }) => {
                ...
                response += `Relationship: ${relationship}\n`;
                if (theirPart)
                    response += `Their part: ${theirPart}\n`;
                if (yourPart)
                    response += `Your part: ${yourPart}\n`;
                if (whatTheyWant)
                    response += `What repair looks like: ${whatTheyWant}\n`;
                response += `\n---\n\n`;
...
// ============================================================================
const endOfLifeConversationDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ withWhom, whatToDiscuss, urgency, whatHoldsBack }, { ctx: toolCtx }) => {
                getLogger().info({ agentId: ctx.agentId, whatToDiscuss }, 'Preparing end-of-life conversation');
...
// WISDOM TOOL
// ============================================================================
const shareConversationWisdomDef = {
...
// ============================================================================
const difficultConversationTools = [
    // Preparation
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('difficult-conversations', difficultConversationTools);
