...
const motivationCoachingDef: ToolDefinition = {
...
const disciplineStrategyDef: ToolDefinition = {
...
const procrastinationSupportDef: ToolDefinition = {
...
const boundaryCoachingDef: ToolDefinition = {
  id: 'boundaryCoaching',
...
const conflictResolutionDef: ToolDefinition = {
...
const selfCompassionCoachingDef: ToolDefinition = {
...
const affirmWorthDef: ToolDefinition = {
  id: 'affirmWorth',
  name: 'Affirm Worth',
...
const addressPerfectionismDef: ToolDefinition = {
...
const burnoutCoachingDef: ToolDefinition = {
  id: 'burnoutCoaching',
...
const restoreEnergyDef: ToolDefinition = {
  id: 'restoreEnergy',
  name: 'Restore Energy',
...
const parentingSupportDef: ToolDefinition = {
  id: 'parentingSupport',
...
const elderCareSupportDef: ToolDefinition = {
  id: 'elderCareSupport',
...
const habitCoachingDef: ToolDefinition = {
  id: 'habitCoaching',
  name: 'Habit Coaching',
...
const sleepSupportDef: ToolDefinition = {
  id: 'sleepSupport',
  name: 'Sleep Support',
...
const angerCoachingDef: ToolDefinition = {
  id: 'angerCoaching',
  name: 'Anger Coaching',
...
const breakupSupportDef: ToolDefinition = {
  id: 'breakupSupport',
...
const datingAdviceDef: ToolDefinition = {
  id: 'datingAdvice',
  name: 'Dating Advice',
...
const datingAppStrategyDef: ToolDefinition = {
...
const buildSupportSystemDef: ToolDefinition = {
...
const authenticLivingDef: ToolDefinition = {
  id: 'authenticLiving',
...
const wellnessCheckinDef: ToolDefinition = {
  id: 'wellnessCheckin',
...
const coachingSupportTools: ToolDefinition[] = [
