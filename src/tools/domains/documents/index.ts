...
const saveDocumentDef: ToolDefinition = {
  id: 'saveDocument',
  name: 'Save Document',
...
const findDocumentDef: ToolDefinition = {
  id: 'findDocument',
  name: 'Find Document',
...
const trackExpirationDef: ToolDefinition = {
  id: 'trackExpiration',
...
const getWarrantyStatusDef: ToolDefinition = {
  ...
  create: (ctx: ToolContext): Tool => {
    return llm.tool({
      ...
      execute: async (params: { productName: string }) => {
        const userId = ctx.userId;
        if (!userId) {
...
const organizeReceiptsDef: ToolDefinition = {
  id: 'organizeReceipts',
...
export const { getToolDefinitions, domain, definitions } = createDomainExport('documents', [
  saveDocumentDef,
  findDocumentDef,
  trackExpirationDef,
  getWarrantyStatusDef,
  organizeReceiptsDef,
]);
