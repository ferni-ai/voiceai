...
const processBreakupDef: ToolDefinition = {
  id: 'processBreakup',
  ...
  create: (ctx: ToolContext): Tool => {
    return llm.tool({
      ...
      execute: async ({ howRecent, whoEnded, currentFeeling }) => {
        ...
        const initiatorContext: Record<string, string> = {
          ...
          mutual:
            "Even mutual endings hurt. The sadness of two people who loved each other acknowledging they can't make it work is its own kind of grief.",
        };
...
const grievingRelationshipDef: ToolDefinition = {
...
const noContactDef: ToolDefinition = {
  id: 'noContact',
  name: 'No Contact',
...
const rebuildIdentityDef: ToolDefinition = {
  id: 'rebuildIdentity',
...
const rediscoverSelfDef: ToolDefinition = {
  id: 'rediscoverSelf',
...
const breakupRecoveryTools: ToolDefinition[] = [
  processBreakupDef,
