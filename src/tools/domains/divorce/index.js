...
// ============================================================================
const coParentingAfterDivorceDef = {
...
${challenge && challenge !== 'general' && challengeGuidance[challenge] ? challengeGuidance[challenge] : ''}
...
export const { getToolDefinitions, domain, definitions } = createDomainExport('divorce', divorceTools);
