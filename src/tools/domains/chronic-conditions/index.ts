...
const energyBudgetingDef: ToolDefinition = {
  id: 'energyBudgeting',
...
const pacingPlanDef: ToolDefinition = {
  id: 'pacingPlan',
  name: 'Pacing Plan',
...
const griefChronicDef: ToolDefinition = {
...
const advocatingForSelfDef: ToolDefinition = {
...
const symptomTrackingDef: ToolDefinition = {
  id: 'symptomTracking',
...
const chronicConditionsTools: ToolDefinition[] = [
  energyBudgetingDef,
  pacingPlanDef,
  griefChronicDef,
