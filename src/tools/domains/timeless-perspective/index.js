...
// ============================================================================
const timelessPerspectiveTools = [
    decadeViewDef,
    thisTooPasses,
    ancientParallelDef,
    zoomOutDef,
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('timeless-perspective', timelessPerspectiveTools);
