...
const jobLossGriefDef: ToolDefinition = {
  id: 'jobLossGrief',
  name: 'Job Loss Grief',
...
const identityAfterLayoffDef: ToolDefinition = {
...
const jobSearchMentalHealthDef: ToolDefinition = {
...
const rebuildingConfidenceDef: ToolDefinition = {
