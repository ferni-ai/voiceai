 ...
 *
 * @module tools/domains/pattern-analytics
 */
...
import {
  ...
  recordInsight,
  getInsights,
} from '../../../services/superhuman/pattern-analytics-services.js';

const log = createLogger({ module: 'tools:pattern-analytics' });
...
const simulateCounterfactualDef: ToolDefinition = {
  ...
  domain: 'pattern-analytics',
  tags: ['decisions', 'counterfactual', 'learning', 'superhuman-analytics'],
...
const predictPatternDef: ToolDefinition = {
  ...
  domain: 'pattern-analytics',
  tags: ['patterns', 'prediction', 'trajectory', 'superhuman-analytics'],
...
const scoreDecisionDef: ToolDefinition = {
  ...
  domain: 'pattern-analytics',
  tags: ['decisions', 'quality', 'learning', 'superhuman-analytics'],
...
const findCorrelationDef: ToolDefinition = {
  ...
  domain: 'pattern-analytics',
  tags: ['patterns', 'correlation', 'cross-domain', 'superhuman-analytics'],
...
const detectAnomalyDef: ToolDefinition = {
  ...
  domain: 'pattern-analytics',
  tags: ['patterns', 'anomaly', 'alert', 'superhuman-analytics'],
...
const archiveInsightDef: ToolDefinition = {
  ...
  domain: 'pattern-analytics',
  tags: ['insights', 'archive', 'learning', 'superhuman-analytics'],
...
const patternAnalyticsTools: ToolDefinition[] = [
  revealBlindSpotDef,
