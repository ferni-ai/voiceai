 ...
 */
const recordCommitmentDef: ToolDefinition = {
  id: 'recordCommitment',
    ...
    return llm.tool({
      ...
      parameters: z.object({
        ...
        targetDate: z
          ...
          .optional()
          .describe(
            'When they said they would do it (natural language like "tomorrow", "this week")'
          ),
        emotionalWeight: z
          .number()
          .min(0)
 ...
 */
const completeCommitmentDef: ToolDefinition = {
    ...
    return llm.tool({
      ...
      execute: async (params) => {
        ...
        if (!isNaN(num) && num > 0 && num <= commitments.length) {
          ...
          targetCommitment = commitments.find(
            (c) =>
 ...
 */
const deferCommitmentDef: ToolDefinition = {
  id: 'deferCommitment',
    ...
    return llm.tool({
      ...
      execute: async (params) => {
        ...
        if (!isNaN(num) && num > 0 && num <= activeCommitments.length) {
          ...
          targetCommitment = activeCommitments.find(
            (c) =>
              c.summary.toLowerCase().includes(queryLower) ||
              c.statement.toLowerCase().includes(queryLower)
          );
 ...
 */
const getFollowUpsDef: ToolDefinition = {
...
export const commitmentTools: ToolDefinition[] = [
  recordCommitmentDef,
  getCommitmentsDef,
...
export function createCommitmentTools(): ToolDefinition[] {
