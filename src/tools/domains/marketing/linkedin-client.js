...
export class LinkedInClient {
    ...
    async post(params) {
        ...
        try {
            ...
            const payload = {
                ...
                visibility: {
                    'com.linkedin.ugc.MemberNetworkVisibility': params.visibility === 'public' ? 'PUBLIC' : 'CONNECTIONS',
                },
            };
    ...
    static getAuthorizationUrl(state) {
        ...
        const redirectUri = process.env.LINKEDIN_CALLBACK_URL || 'https://app.ferni.ai/api/marketing/linkedin/callback';
