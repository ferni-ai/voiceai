...
const generateSocialContentDef: ToolDefinition = {
  id: 'generateSocialContent',
  name: 'Generate Social Content',
  description:
    'Generate platform-specific social media content from a blog post, topic, or announcement. Creates ready-to-post content for Twitter threads, LinkedIn posts, and Instagram carousels.',
  domain: 'marketing',
...
const postToTwitterDef: ToolDefinition = {
  id: 'postToTwitter',
  name: 'Post to Twitter',
  description:
    'Post content directly to Twitter/X. Can post single tweets or full threads. Always confirm with user before posting.',
  domain: 'marketing',
...
const listScheduledPostsDef: ToolDefinition = {
...
const getMarketingAnalyticsDef: ToolDefinition = {
