...
import { z } from 'zod';
import { getMayaNotificationService, } from '../../../services/engagement/engagement-notification-service.js';
        ...
        getNotifications: llm.tool({
            ...
            execute: async (_, { ctx }) => {
                ...
                try {
                    ...
                    const typeSummary = enabledTypes.length > 0
                        ? enabledTypes
                            .slice(0, 3)
                            .map((t) => t.replace(/_/g, ' '))
                            .join(', ')
                        : 'none';
                    const quietHours = prefs.quietHoursStart !== undefined
