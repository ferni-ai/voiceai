...
import { getUnreadMessages, getImportantUnread, searchEmails, getInboxStats, getEmailThread, triageUnreadEmails, formatEmailForSpeech, formatInboxSummaryForSpeech, isGmailConfigured, } from '../../../services/gmail/gmail-service.js';
 ...
 */
export function getGmailToolDefinitions() {
    return [
        // =========================================================================
            ...
            create: (ctx) => {
                return llm.tool({
                    ...
                    parameters: z.object({
                        query: z
                            .string()
                            .describe('Search query (e.g., "from:boss@company.com", "subject:urgent", "is:unread")'),
            ...
            create: (ctx) => {
                return llm.tool({
                    ...
                    execute: async () => {
                        ...
                        const total = triage.urgent.length +
