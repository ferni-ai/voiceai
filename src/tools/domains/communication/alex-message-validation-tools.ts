/**
 * Alex Message Validation Tools ("Sleep on It")
 *
...
/**
 * Get Alex Message Validation tool definitions
 */
export function getAlexMessageValidationToolDefinitions(): ToolDefinition[] {
  return [
    // =========================================================================
