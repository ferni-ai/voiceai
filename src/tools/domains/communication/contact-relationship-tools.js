...
import { upsertContact, recordInteraction, setFollowUp, completeFollowUp, getRelationshipInsights, getContactsNeedingAttention, searchContacts, getContactContext, getInteractionHistory, getInteractionStats, } from '../../../services/contacts/contact-relationship-service.js';
 ...
 */
export function getContactRelationshipToolDefinitions() {
    return [
        // =========================================================================
                ...
                return llm.tool({
                    ...
                    execute: async (params) => {
                        ...
                        contacts.forEach((contact, i) => {
                            const daysSince = Math.floor((now.getTime() - contact.lastInteraction.getTime()) / (1000 * 60 * 60 * 24));
        ...
        // =========================================================================
        {
            ...
            - Other: photo_shared, recommendation, introduction, favor_done, favor_received, other`,
                    ...
                    execute: async (params) => {
                        ...
                        return (typeMessages[params.type] ||
...
//# sourceMappingURL=contact-relationship-tools.js.map