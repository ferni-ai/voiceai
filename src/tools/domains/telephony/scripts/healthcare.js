 ...
 */
export const healthcareScript = {
    type: 'healthcare',
    // -------------------------------------------------------------------------
    // Introduction
    // -------------------------------------------------------------------------
    greeting: "Hi, my name is {agentName} and I'm calling on behalf of {userName}.",
    identityDisclosure: "I'm an AI assistant. {userName} has authorized me to call regarding their appointment.",
    recordingConsentScript: 'This call may be recorded for quality purposes. Is that okay with you?',
    hipaaNote: 'I understand you may have privacy requirements. {userName} has authorized me to ' +
    ...
    // -------------------------------------------------------------------------
    objectives: {
        reschedule: "I need to reschedule {userName}'s upcoming appointment. {details}. " +
            'Could you help me find a new time that works?',
        new_appointment: "I'd like to schedule a new appointment for {userName}. {details}. " +
            'What availability do you have?',
        cancel: "I need to cancel {userName}'s upcoming appointment. {details}. " +
            'Could you confirm the cancellation for me?',
        inquiry: "I'm calling on behalf of {userName} with a question. {details}. " +
            'Would you be able to help with that?',
        refill: "I'm calling to request a prescription refill for {userName}. {details}. " +
