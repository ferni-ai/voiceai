...
export const businessScript = {
    ...
    identityDisclosure: "I'm an AI assistant authorized by {userName} to make this call. " +
    ...
    objectives: {
        ...
        reschedule: 'I need to reschedule an appointment for {userName}. {details}. ' +
            'What options do you have available?',
        cancel: 'I need to cancel something for {userName}. {details}. ' + 'Could you process that for me?',
        new_appointment: "I'd like to schedule an appointment for {userName}. {details}. " +
