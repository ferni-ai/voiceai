    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ currentGoal, whyDating }) => {
                ...
                // Goal context
                const goalResponses = {
                    casual: 'Casual dating is valid. What matters is being honest about it - with yourself and others. No one should be misled about where you stand.',
                    serious: 'Looking for something serious means being ready to invest, be vulnerable, and potentially get hurt. It also means being selective and patient.',
                    unsure: "It's okay to be unsure. Many people date to figure out what they want. Just be honest about this uncertainty.",
                    exploring: "Exploration is healthy. You're learning about yourself and what you need. This is valuable data, not wasted time.",
                };
        ...
        return llm.tool({
            ...
            execute: async ({ currentState }) => {
                ...
                const stateResponses = {
                    exhausted: "Exhaustion means you've been giving too much to apps. They should be a small part of your dating life, not all of it. Take a real break.",
                    frustrated: "Frustration is valid. Apps are not well-designed for finding genuine connection. They're designed to keep you swiping.",
                    cynical: 'Cynicism protects you but can also close you off. There are real people on apps - but the system makes connection hard.',
                    discouraged: "Discouragement after effort makes sense. But your value isn't determined by app results. The app environment is abnormal, not you.",
                    overwhelmed: 'Overwhelm comes from too many options and too little meaning. Fewer, more intentional interactions help.',
                };
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('dating', datingTools);
