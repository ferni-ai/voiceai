...
// MAINTENANCE TOOLS
// ============================================================================
const remindHomeMaintenanceDef = {
...
// ============================================================================
const assessEmergencyPreparednessDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ focus, householdSize }) => {
                ...
                if (householdSize)
                    response += `**Household size:** ${householdSize} people\n\n`;
