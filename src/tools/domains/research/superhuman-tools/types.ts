...
export interface DecisionQualityAnalysis {
  ...
  patterns: {
    bestTimeOfDay: { hour: number; quality: number };
    worstTimeOfDay: { hour: number; quality: number };
    bestDayOfWeek: { day: string; quality: number };
    worstDayOfWeek: { day: string; quality: number };
    sleepImpact: { correlation: number; threshold: number };
    stressImpact: { correlation: number; threshold: number };
  };
  insights: string[];
...
export interface SleepBehaviorCorrelation {
  ...
  correlations: {
    spendingCorrelation: number; // -1 to 1
...
export interface EnergyPrediction {
  ...
  lowHours: { start: number; end: number }[];
}
...
// ============================================================================
// ADVANCED FINANCIAL RESEARCH TYPES
// ============================================================================
...
// ============================================================================
// PERSONAL EXPERIMENTATION TYPES
// ============================================================================
...
// ============================================================================
// PERSISTENCE TYPES (for Firestore storage)
// ============================================================================
