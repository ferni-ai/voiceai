 ...
 *
 * @module tools/domains/event-intelligence
 */
...
} from '../../../services/superhuman/event-intelligence-services.js';

const log = createLogger({ module: 'tools:event-intelligence' });
...
const recallEventPatternsDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['events', 'patterns', 'memory', 'superhuman-events'],
...
const getGuestInsightsDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['events', 'guests', 'memory', 'superhuman-events'],
...
const detectMilestonesDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['milestones', 'detection', 'proactive', 'superhuman-events'],
...
const captureEventMeaningDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['events', 'meaning', 'stories', 'superhuman-events'],
...
const checkCelebrationHealthDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['celebration', 'balance', 'wellness', 'superhuman-events'],
...
const anticipateTransitionDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['transitions', 'anticipation', 'proactive', 'superhuman-events'],
...
const checkPlanningReadinessDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['planning', 'readiness', 'cross-team', 'superhuman-events'],
...
const backgroundReservationDef: ToolDefinition = {
  ...
  domain: 'event-intelligence',
  tags: ['background', 'async', 'reservations', 'while-you-were-away', 'superhuman-events'],
...
const eventIntelligenceTools: ToolDefinition[] = [
