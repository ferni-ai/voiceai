...
Alex (communication/organization), Jordan (milestones/planning), Nayan (wisdom/philosophy)`,
            parameters: z.object({
                personas: z
                    ...
                    .min(1)
                    .max(5)
                    .describe('Array of persona IDs to invite. Options: peter-john, maya-habits, alex-chen, jordan-taylor, nayan-sharma'),
            ...
            execute: async (params) => {
                try {
                    ...
                    const modeIntro = params.collaborationMode === 'debate'
...
The person will receive a phone call and be connected to our conversation.`,
            ...
            execute: async (params) => {
                try {
                    log.info({ agentId: ctx.agentId, name: params.name, relationship: params.relationship }, 'Inviting external participant');
...
// DOMAIN EXPORT
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('group-conversation', [startRoundtableDef, inviteParticipantDef, endGroupConversationDef]);
