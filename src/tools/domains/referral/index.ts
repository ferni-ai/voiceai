...
const inviteFriendByCallDef: ToolDefinition = {
  id: 'inviteFriendByCall',
  name: 'Invite Friend by Call',
  description:
    'Have Ferni personally call a friend to introduce herself. Creates a warm, memorable first impression.',
  domain: 'referral',
...
const sendSupportCallDef: ToolDefinition = {
  id: 'sendSupportCall',
  name: 'Send Support Call',
  description:
    'Send a gentle, supportive introduction call to someone going through a difficult time.',
  domain: 'referral',
...
const referralTools: ToolDefinition[] = [inviteFriendByCallDef, sendSupportCallDef];
