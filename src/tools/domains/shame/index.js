...
// ============================================================================
const distinguishShameFromGuiltDef = {
...
// ============================================================================
const processShameExperienceDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ experience, shameCategory, intensity }) => {
                ...
                const categoryInfo = shameCategory && shameCategory !== 'other' ? SHAME_CATEGORIES[shameCategory] : null;
...
// ============================================================================
const identifyShamesTriggersDef = {
