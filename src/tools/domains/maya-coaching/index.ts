...
import {
  ...
  recordHabitAutopsy,
  getHabitAutopsies,
} from '../../../services/superhuman/maya-coaching-services.js';
      ...
      execute: async ({ habitName, reminderType, currentStreak, context, scheduledTime }) => {
        ...
        try {
          const { queueHabitReminder } = await import(
            '../../../services/background-agents/executors/habit-reminder-executor.js'
          );
...
const mayaCoachingTools: ToolDefinition[] = [
  trackHabitDNADef,
  mapFrictionDef,
  assessTendencyDef,
  detectKeystoneDef,
