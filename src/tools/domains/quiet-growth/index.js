    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ currentEnergy, whatFeelsTrue, whatTheyrePushing }) => {
                ...
                const season = SEASONAL_WISDOM[seasonMap[currentEnergy]];
...
export const { getToolDefinitions, domain, definitions } = createDomainExport('quiet-growth', quietGrowthTools);
