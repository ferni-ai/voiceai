/**
 * Quiet Growth Domain Tools Tests
 * Run with: npx vitest run src/tools/domains/quiet-growth/__tests__/quiet-growth.test.ts
 */
...
describe('Quiet Growth Domain Tools', () => {
