    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ currentAngerLevel, pattern }) => {
                ...
                const enhancedContext = await getEnhancedToolContext(ctx.agentId, 'anger', undefined, ctx.userId);
...
// ============================================================================
const expressAngerHealthilyDef = {
...
// ============================================================================
const flagAngerPatternForMayaDef = {
...
const shareAngerInsightWithNayanDef = {
