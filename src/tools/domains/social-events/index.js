...
const socialEventsStore = new Map();
...
// TOOL DEFINITIONS
// ============================================================================
export function getSocialEventsToolDefinitions() {
    return [
        // =========================================================================
        // setBirthday - Add birthday to contact
        // =========================================================================
        {
            id: 'setBirthday',
            name: 'Set Birthday',
            ...
            create: (ctx) => {
                return llm.tool({
                    ...
                    execute: async (params) => {
                        ...
                        // Check for existing
                        const existing = events.findIndex((e) => e.contactName.toLowerCase() === params.name.toLowerCase() && e.eventType === 'birthday');
                        if (existing >= 0) {
        ...
        // =========================================================================
        // getUpcomingBirthdays - Next 30 days
        // =========================================================================
        {
        ...
        // =========================================================================
        // suggestGift - Based on relationship and history
        // =========================================================================
        {
            id: 'suggestGift',
            name: 'Suggest Gift',
            ...
            create: (ctx) => {
                return llm.tool({
                    ...
                    execute: async (params) => {
                        ...
                        const events = getUserEvents(userId);
                        const event = events.find((e) => e.contactName.toLowerCase().includes(params.name.toLowerCase()));
        ...
        // =========================================================================
        // trackGift - Record what you gave
        // =========================================================================
        {
            id: 'trackGift',
            name: 'Track Gift',
        ...
        // =========================================================================
        // setAnniversary - Track anniversary
        // =========================================================================
        {
            id: 'setAnniversary',
...
export function getToolDefinitions() {
    return getSocialEventsToolDefinitions();
}
export const definitions = getSocialEventsToolDefinitions();
