...
import { recordBlindSpot, getBlindSpots, recordCounterfactual, getCounterfactuals, recordPatternPrediction, getPatternPredictions, recordDecisionScore, getDecisionScores, recordCorrelation, getCorrelations, recordAnomaly, getAnomalies, recordInsight, getInsights, } from '../../../services/superhuman/peter-analytics-services.js';
const log = createLogger({ module: 'tools:peter-analytics' });
// ============================================================================
// BLIND SPOT MIRROR - Show patterns they're avoiding
// ============================================================================
const revealBlindSpotDef = {
    id: 'revealBlindSpot',
    name: 'Reveal Blind Spot',
    description: 'Surface patterns they may be avoiding or not seeing. Hold up a mirror to what they can\'t see themselves.',
    domain: 'peter-analytics',
...
// ============================================================================
const simulateCounterfactualDef = {
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('peter-analytics', peterAnalyticsTools);
