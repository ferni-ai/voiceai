...
const ANXIETY_RESPONSES = {
    market_fear: {
        validation: 'I understand. Watching the market drop is nerve-wracking, even for people who know better.',
        perspective: 'Let me put this in perspective: Since 1926, the S&P 500 has had positive returns in about 73% of years. The market has recovered from every single crash in history.',
        actionable: "The best thing you can do right now is... nothing. Don't look at your portfolio. Go for a walk. Call a friend. Let the market do what markets do.",
        jackWisdom: 'Time in the market beats timing the market. The investors who do best are the ones who do nothing during volatility. Sometimes doing nothing is the hardest thing to do.',
    },
    not_enough: {
        validation: "That feeling of 'not enough' is so common. You're not alone in this.",
        perspective: "Here's the thing: there's always someone with more. And there's always someone with less. Comparison is the thief of joy.",
        actionable: "Let's focus on YOUR progress. Where were you financially 5 years ago? A year ago? That trajectory matters more than any snapshot.",
        jackWisdom: "The goal isn't to have the most. It's to have enough. And 'enough' is a number that actually exists - we can figure it out together.",
    },
    behind_peers: {
        validation: "It's hard not to compare ourselves to others. That's human nature.",
        perspective: "Here's what I've learned: The people who look like they're ahead? Many of them are drowning in debt. Appearance isn't reality.",
        actionable: 'Focus on your own race. The only competition that matters is with your past self. Are you better off than you were?',
        jackWisdom: "Someone's always going to be richer. Someone's always going to retire earlier. Run your own race. That's the only one you can win.",
    },
    decision_paralysis: {
        validation: 'Analysis paralysis is real. Sometimes having too many options is worse than having too few.',
        perspective: "Here's a secret: most financial decisions aren't as high-stakes as they feel. A 'good enough' decision made today beats a 'perfect' decision made never.",
        actionable: "Let's simplify. What's the ONE decision that would move you forward? Let's just focus on that.",
        jackWisdom: 'The greatest enemy of a good plan is the dream of a perfect plan. Done is better than perfect.',
    },
    past_mistakes: {
        validation: "We all have financial regrets. I certainly do. That's part of being human.",
        perspective: 'Every financial expert you admire has made mistakes. Warren Buffett talks openly about his. What matters is learning, not dwelling.',
        actionable: "The past is sunk cost. You can't change it. But you CAN change every decision from this moment forward.",
        jackWisdom: "Learn every day, but especially from the experiences of others. It's cheaper! But when you do pay for a lesson yourself, make sure you actually learn it.",
    },
    uncertain_future: {
        validation: "The future is uncertain. That's not pessimism - that's just reality. And it's okay to feel anxious about it.",
        perspective: "Here's what history teaches us: The future has always been uncertain. Every generation thought they lived in uniquely troubled times. Yet progress continued.",
        actionable: "We can't control the future, but we can prepare for it. Emergency fund, diversification, insurance - these are your shields against uncertainty.",
        jackWisdom: "You can't predict. You can prepare. Focus on what you can control, and let go of what you can't.",
    },
};
// ============================================================================
...
const REFRAMING_PERSPECTIVES = {
    spending_guilt: {
        ...
        reframed: "Money is a tool for building the life you want. Mindful spending on what truly matters to you is not guilt-worthy - it's the point.",
        jackWisdom: "The goal of saving isn't to die with the most money. It's to have enough to live the life you want. That includes some enjoyment now.",
    },
    investment_losses: {
        unhealthy: "I lost money in the market. I'm a failure.",
        reframed: "You experienced volatility, not loss. Loss only happens when you sell. Your shares haven't changed - only their temporary price tag.",
        jackWisdom: 'The stock market is a giant distraction to the business of investing. Daily prices are noise. Long-term growth is signal.',
    },
    late_start: {
        unhealthy: "I started too late. There's no point anymore.",
        reframed: "The math doesn't care when you started. Every dollar you save today still compounds. And you have more earning power and wisdom than a 22-year-old.",
        jackWisdom: "I founded Vanguard when I was 45. Some of my best work came after 60. It's never too late to start doing the right thing.",
    },
    small_amounts: {
        unhealthy: "I can only save $50 a month. What's the point?",
        reframed: "$50 a month at 7% becomes $59,000 in 30 years. That's not nothing. And as your income grows, so will that $50.",
        jackWisdom: 'Little amounts work big miracles. The habit matters more than the amount. Start where you are.',
    },
    risk_aversion: {
        unhealthy: "I'm too scared to invest. I might lose everything.",
        reframed: "The biggest risk isn't market volatility - it's inflation slowly eroding your purchasing power. Cash feels safe but loses value every year.",
        jackWisdom: 'The biggest risk is not putting your money to work at all. Invest you must. The only question is how.',
    },
};
// ============================================================================
 ...
 */
export function respondToAnxiety(anxietyType) {
 ...
 */
export function provideEncouragement(stage) {
 ...
 */
export function reframeBelief(beliefType) {
...
export function createWellnessTools() {
    return {
        ...
        checkInOnWellbeing: llm.tool({
            description: "Do a holistic check-in on financial wellbeing. Use proactively to understand how they're feeling.",
            parameters: z.object({
                focus: z
                    .enum([
            ...
            execute: async ({ focus = 'overall' }) => {
                ...
                const checkIns = {
                    overall: 'How are you feeling about your financial life lately? Not the numbers - the feelings.',
                    ...
                    progress: 'When you think about where you were a year ago financially, how do you feel about the progress?',
                };
...
//# sourceMappingURL=wellness-tools.js.map