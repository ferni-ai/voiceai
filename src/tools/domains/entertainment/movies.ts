 ...
 */
export async function getMovieInfo(title: string): Promise<string> {
  const log = getLogger();
 ...
 */
export async function getMoviesNowPlaying(): Promise<string> {
  const log = getLogger();
 ...
 * Get upcoming movies
 */
export async function getUpcomingMoviesList(): Promise<string> {
  const log = getLogger();
