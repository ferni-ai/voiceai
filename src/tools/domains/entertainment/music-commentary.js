 ...
 */
export function getMusicCommentary(trackName, artistName, personaId) {
 ...
 */
export function getMusicTrivia(artistName) {
 ...
 */
export function getMusicInvestingWisdom(artistName) {
    const artist = artistName ? findArtist(artistName) : randomItem(ARTIST_DATABASE);
 ...
 */
export function hasArtistInfo(artistName) {
...
//# sourceMappingURL=music-commentary.js.map