...
const crossDomainConnectionDef = {
...
const counterIntuitiveInsightDef = {
...
const surfacePatternMirrorInsightDef = {
...
const requestMayaHabitInterventionDef = {
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('pattern-mastery', patternMasteryTools);
