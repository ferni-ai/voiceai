...
import { searchVideos, getVideoDetails, getTrendingVideos, getVideoRecommendations, getApiKeyConfigured, } from '../../../services/video/index.js';
const log = getLogger();
// ============================================================================
// HELPER FUNCTIONS
// ============================================================================
...
function formatVideoForSpeech(video) {
...
function formatVideoList(videos, limit = 5) {
...
const searchYouTubeTool = {
    ...
    create: (_ctx) => {
        return llm.tool({
            description: 'Search for videos on YouTube by topic, title, or keyword. Can filter by duration (short: <4min, medium: 4-20min, long: >20min).',
            parameters: z.object({
...
const getVideoRecommendationsTool = {
    ...
    create: (_ctx) => {
        return llm.tool({
            description: 'Get YouTube video recommendations based on user interests. Great for discovering new content.',
            parameters: z.object({
                interests: z
                    .array(z.string())
...
const getTrendingVideosTool = {
    ...
    create: (_ctx) => {
        return llm.tool({
            description: 'Get trending and popular videos on YouTube. Can filter by category like music, gaming, entertainment, news, howto, education, science, sports, film, or comedy.',
            parameters: z.object({
                category: z
                    .string()
                    .optional()
                    .describe('Category filter (music, gaming, entertainment, news, howto, education, science, sports, film, comedy)'),
                limit: z
                    .number()
                    .min(1)
                    .max(10)
...
const getVideoDetailsTool = {
    ...
    create: (_ctx) => {
        return llm.tool({
            description: 'Get detailed information about a specific YouTube video including duration, view count, and description.',
            parameters: z.object({
