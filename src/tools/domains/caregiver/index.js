...
const CAREGIVER_CHALLENGES = {
    ...
    guilt: {
        description: 'Pervasive guilt about not doing enough, needing breaks, or having negative feelings',
        commonFeelings: [
            'Never enough',
...
// ============================================================================
const anticipatoryGriefDef = {
    id: 'anticipatoryGrief',
    name: 'Anticipatory Grief',
    description: "Process grief that begins before death - grieving what's already lost and what's coming",
    domain: 'caregiver',
...
// ============================================================================
const caregiverIdentityLossDef = {
...
export const { getToolDefinitions, domain, definitions } = createDomainExport('caregiver', caregiverTools);
