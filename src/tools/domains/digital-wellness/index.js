...
// ============================================================================
const socialMediaRelationshipDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ platform, impact }) => {
                log.info({ agentId: ctx.agentId, platform, impact }, 'Addressing social media relationship');
                let response = '';
                ...
                const impactGuides = {
                    comparison: "You're comparing your behind-the-scenes to everyone's highlight reel. Nobody posts their boring Tuesday or mental breakdown. What you see is curated, filtered, and often fake.",
                    'time-sink': "The average person loses 2.5 hours daily to social media. That's over 900 hours a year. What could you do with that time?",
                    ...
                    anxiety: "Social media overloads your nervous system - constant stimulation, bad news, comparison. Your brain wasn't designed for this.",
                    addiction: "Social media addiction is real and by design. Variable rewards (maybe something interesting will pop up) are the most addictive type. Recognize you're fighting an engineered system.",
                    mixed: 'Mixed feelings are common - it has benefits AND costs. The question is: Is your relationship with it intentional?',
                };
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ resistanceReason }) => {
                ...
                // Address resistance
                const resistanceResponses = {
                    'miss-something': 'What would you actually miss? Probably nothing urgent. Humans survived thousands of years without knowing things instantly. The world will still be there. Your anxiety about missing something is manufactured by tech companies.',
                    bored: 'Boredom is not an emergency. Boredom is actually the birthplace of creativity and self-knowledge. When did we decide that every moment must be filled with stimulation? What if boredom is valuable?',
                    emergency: 'Real emergencies are rare. If something truly urgent happens, people will find a way to reach you. The "what if there\'s an emergency" is mostly anxiety talking. You can set up emergency bypass if needed.',
                    habit: "Reaching for your phone is automatic - that's the problem. You've been conditioned. Breaking the habit requires creating space between impulse and action. This discomfort is temporary.",
                    uncomfortable: "Discomfort without your phone tells you something important - you've become dependent. That's worth paying attention to. The discomfort fades with practice.",
                };
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('digital-wellness', digitalWellnessTools);
