...
import { getEmailIntelligence, } from '../../../services/email/email-intelligence.js';
import { getFollowUpTracker, } from '../../../services/email/follow-up-tracker.js';
import { getUnsubscribeDetector, } from '../../../services/email/unsubscribe-detector.js';
import { getUnreadMessages, searchEmails, isGmailConfigured, } from '../../../services/gmail/gmail-service.js';
const log = getLogger();
// ============================================================================
// TOOL DEFINITIONS
// ============================================================================
 ...
 */
export function getEmailIntelligenceToolDefinitions() {
    return [
        // =========================================================================
        ...
        // =========================================================================
        {
            ...
            description: 'Analyze your inbox and show which emails need attention first, scored by importance and urgency.',
            domain: 'email-intelligence',
                ...
                return llm.tool({
                    ...
                    execute: async (params) => {
                        ...
                        for (const fu of toShow) {
                            const daysWaiting = Math.round((Date.now() - fu.sentAt.getTime()) / (1000 * 60 * 60 * 24));
        ...
        // =========================================================================
        {
            ...
            description: 'Find newsletters you might want to unsubscribe from and help you clean up your inbox.',
            domain: 'email-intelligence',
            ...
            create: (ctx) => {
                return llm.tool({
                    ...
                    execute: async (params) => {
                        ...
                        const pending = followUps.filter((f) => f.status === 'awaiting' || f.status === 'reminded');
                        if (pending.length === 0) {
