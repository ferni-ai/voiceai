...
const analyzeInboxPriorityDef: ToolDefinition = {
...
const getFollowUpNeededDef: ToolDefinition = {
...
const bulkUnsubscribeDef: ToolDefinition = {
  id: 'bulkUnsubscribe',
...
const summarizeThreadDef: ToolDefinition = {
  id: 'summarizeThread',
...
const markVipSenderDef: ToolDefinition = {
  id: 'markVipSender',
...
const blockSenderDef: ToolDefinition = {
  id: 'blockSender',
  name: 'Block Sender',
...
const trackFollowUpDef: ToolDefinition = {
  id: 'trackFollowUp',
...
const closeFollowUpDef: ToolDefinition = {
  id: 'closeFollowUp',
...
export const { getToolDefinitions, domain, definitions } = createDomainExport('email-intelligence', [
  analyzeInboxPriorityDef,
  getFollowUpNeededDef,
  bulkUnsubscribeDef,
  summarizeThreadDef,
  markVipSenderDef,
  blockSenderDef,
