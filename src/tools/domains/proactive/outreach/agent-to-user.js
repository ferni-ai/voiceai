...
// Services
import { createReminder, } from '../../../../services/scheduling/reminder-scheduler.js';
 ...
 */
export async function setUserContactInfo(userId, contactInfo) {
...
export async function getUserContactInfo(userId) {
    ...
    try {
        ...
        const contactInfo = prefs?.proactiveContact;
        if (contactInfo) {
            userContactCache.set(userId, contactInfo);
            return contactInfo;
        }
 ...
 */
export const saveContactInfoDef = {
    id: 'saveContactInfo',
 ...
 */
export const scheduleReminderDef = {
...
Use for: follow-ups, accountability check-ins, celebrations, and scheduled reminders.`,
            ...
            execute: async ({ message, when, method, type = 'reminder' }) => {
                ...
                const deliveryMethod = method === 'voice' ? 'call' : method || (contactInfo.phone ? 'sms' : 'email');
                // Parse the time
                const now = new Date();
                let scheduledFor;
                try {
 ...
 */
export const sendImmediateOutreachDef = {
...
// EXPORTS
// ============================================================================
export function getAgentToUserOutreachDefinitions() {
...
//# sourceMappingURL=agent-to-user.js.map