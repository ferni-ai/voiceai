 ...
 */
export const TENDENCY_FRAMINGS = {
    upholder: {
 ...
 */
export function adaptForTendency(message, tendency) {
    if (!tendency)
        return message;
 ...
 */
export const EMOTIONAL_VALIDATIONS = {
 ...
 */
export function getEmotionalValidation(state) {
 ...
 */
export function generateAdaptiveResponse(baseContent, context, options = {}) {
    let response = '';
 ...
 */
function getContextualClosing(context) {
 ...
 */
export function detectPeoplePleasing(text) {
 ...
 */
export function recognizeProgress(profile, domain) {
...
//# sourceMappingURL=adaptive-response.js.map