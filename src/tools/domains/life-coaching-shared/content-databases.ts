...
export const BOUNDARY_SCRIPTS: ScriptTemplate[] = [
  {
...
export const ANGER_FRAMEWORKS: Framework[] = [
  {
...
export const SOCIAL_FRAMEWORKS: Framework[] = [
  {
...
export const BODY_FRAMEWORKS: Framework[] = [
  {
 ...
 */
export function getScriptForCategory(
  category: string,
  firmness: 'soft' | 'firm' | 'assertive'
): string[] {
 ...
 */
export function getAdaptedScript(category: string, tendency?: FourTendency): string | null {
  const scripts = BOUNDARY_SCRIPTS.filter((s) => s.category === category);
 ...
 */
export function getCopingTechnique(situation: string): CopingTechnique | null {
