 ...
 */
export async function getAllDomainToolDefinitions() {
...
export const DOMAIN_METADATA = {
    ...
    'human-transfer': {
        name: 'Human Transfer',
        description: "Evaluate and connect to human professionals when AI coaching isn't enough - therapy, crisis support, legal, financial",
        icon: '🤝',
        status: 'active',
    },
    cameo: {
    ...
    'second-chances': {
        name: 'Second Chances',
        description: 'Fresh starts, reinvention, rebuilding after setbacks - because second chances are sacred',
        icon: '🌅',
        status: 'active',
    },
    connection: {
    ...
    'reflection-games': {
        ...
        description: 'Deep coaching games for self-discovery - Letters to Future Self, Values Auction, Rose/Thorn/Bud',
        icon: '🎯',
        status: 'active',
    },
    'quiet-growth': {
    ...
    'pattern-mastery': {
        ...
        description: "Peter John's specialty: superhuman pattern recognition, cross-domain connections, and data insights",
        icon: '🔬',
        status: 'active',
    },
    'workflow-mastery': {
        name: 'Workflow Mastery',
        description: "Alex Chen's specialty: superhuman organization, communication clarity, and calendar optimization",
        icon: '📋',
        status: 'active',
    },
    'milestone-mastery': {
        name: 'Milestone Mastery',
        description: "Jordan Taylor's specialty: superhuman celebration, event anticipation, and life milestone navigation",
        icon: '🎉',
        status: 'active',
    },
    'habit-persistence': {
        name: 'Habit Persistence',
        description: "Maya Santos's specialty: superhuman patience for behavior change, compassionate coaching, and gentle accountability",
        icon: '🌿',
        status: 'active',
    },
    'timeless-perspective': {
        name: 'Timeless Perspective',
        description: "Nayan Patel's specialty: superhuman patience, wisdom across decades, and the long view that transcends current struggles",
        icon: '🏔️',
        status: 'active',
    },
    // Developer Tools Domain
    ...
    marketing: {
        ...
        description: "Alex's marketing tools: social content generation, Twitter/X posting, LinkedIn publishing, analytics",
        icon: '📣',
        status: 'active',
    },
    referral: {
        name: 'Voice Referrals',
        description: 'Viral growth via voice calls - Ferni personally calls friends to introduce herself',
        icon: '📞',
        status: 'active',
    },
    // Media Discovery Domains
    ...
    concierge: {
        name: 'AI Concierge',
        description: 'AI-powered outreach: hotel quotes, restaurant reservations, healthcare appointments, service provider quotes',
        icon: '🛎️',
        status: 'active',
    },
    'local-search': {
        name: 'Local Search',
        description: 'Yelp-powered local business discovery: restaurants, reviews, ratings, hours, phone lookup',
        icon: '📍',
        status: 'active',
    },
    // "Better Than Human" Core Domains
