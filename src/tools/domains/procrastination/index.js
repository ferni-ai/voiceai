...
// ============================================================================
const procrastinationRootCauseDef = {
...
// ============================================================================
const emotionalProcrastinationDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ task, feeling }) => {
                ...
                const feelingApproaches = {
                    anxious: {
                        insight: "Anxiety about a task is usually fear of a specific outcome: failure, judgment, overwhelm. What's the worst that could actually happen?",
                        strategy: 'Start with the least anxiety-provoking piece. Build confidence through small wins.',
                    },
                    bored: {
                        insight: 'Boredom is often unfelt anxiety or a disconnection from meaning. Why does this task matter? Or does it not?',
                        strategy: 'Pair with something enjoyable (music, coffee shop). Or batch all boring tasks together.',
                    },
                    resentful: {
                        insight: "Resentment often comes from feeling controlled or that the task isn't your choice. Can you reframe it as a choice with consequences?",
                        strategy: 'Find autonomy within it. How can you do it YOUR way? Or negotiate to change/delegate it.',
                    },
                    overwhelmed: {
                        insight: 'Overwhelm means the task is too big in your mind. It needs to be broken smaller.',
                        strategy: "What's the absolute tiniest step? Don't solve the whole problem - just start.",
                    },
                    ashamed: {
                        insight: "Shame about how long you've avoided it makes starting even harder. The shame is worse than the task.",
                        strategy: 'Self-compassion first. Then one tiny step. Every minute you avoid, shame grows. Start now to stop the shame spiral.',
                    },
                    scared: {
                        insight: 'Fear usually has a specific shape. What specifically are you afraid will happen?',
                        strategy: "Name the fear specifically. Often naming it reduces its power. Then ask: 'If that happened, could I cope?'",
                    },
                    unsure: {
                        insight: 'Not knowing how to do something feels uncomfortable. The urge is to wait until you know more.',
...
// ============================================================================
const procrastinationPatternsDef = {
...
// ============================================================================
const flagProcrastinationPatternForMayaDef = {
...
const requestAlexProductivitySupportDef = {
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('procrastination', procrastinationTools);
