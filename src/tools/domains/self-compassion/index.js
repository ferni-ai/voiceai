...
const speakToYourselfAsAFriendDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ whatItsSaying, howItMakesYouFeel }) => {
                ...
                if (howItMakesYouFeel)
                    response += `**How it makes you feel:** ${howItMakesYouFeel}\n`;
                response += `\n`;
...
// ============================================================================
const practiceSelfAcceptanceDef = {
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('self-compassion', selfCompassionTools);
