...
const defineWordDef: ToolDefinition = {
  id: 'defineWord',
  name: 'Define Word',
...
const getSynonymsDef: ToolDefinition = {
  id: 'getSynonyms',
  name: 'Get Synonyms',
...
const wordOfDayDef: ToolDefinition = {
  id: 'wordOfDay',
...
export const dictionaryToolDefinitions: ToolDefinition[] = [
  defineWordDef,
  getSynonymsDef,
  wordOfDayDef,
];
