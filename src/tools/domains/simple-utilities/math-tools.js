    ...
    create: (_ctx) => {
        return llm.tool({
            ...
            execute: async ({ billAmount, tipPercent, splitWays }, { ctx: toolCtx }) => {
                ...
                updateTipPreferences(userId, tipPercent).catch((err) => getLogger().debug({ err }, 'Failed to persist tip preference'));
...
// EXPORTS
// ============================================================================
export const mathToolDefinitions = [
    calculateTipDef,
    splitBillDef,
