 ...
 */
export const setAppLanguageDef = {
    id: 'setAppLanguage',
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            parameters: z.object({
                language: z
                    .string()
                    .describe('The language to switch to. Can be a language name (e.g., "Spanish", "French") or locale code (e.g., "es", "fr")'),
            }),
 ...
 */
export const appSettingsToolDefinitions = [setAppLanguageDef];
export default appSettingsToolDefinitions;
//# sourceMappingURL=app-settings-tools.js.map