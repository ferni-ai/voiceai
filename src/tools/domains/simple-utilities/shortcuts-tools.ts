...
async function persistAnalytics(userId: string): Promise<void> {
  try {
...
const quickAlarmDef: ToolDefinition = {
  id: 'quickAlarm',
  name: 'Quick Alarm',
...
const quickTimerDef: ToolDefinition = {
  id: 'quickTimer',
  name: 'Quick Timer',
...
const quickWeatherDef: ToolDefinition = {
  id: 'quickWeather',
  name: 'Quick Weather',
...
const quickMusicDef: ToolDefinition = {
  id: 'quickMusic',
  name: 'Quick Music',
...
const quickCalendarDef: ToolDefinition = {
  id: 'quickCalendar',
  name: 'Quick Calendar',
...
const quickSmartHomeDef: ToolDefinition = {
  id: 'quickSmartHome',
...
const quickCallDef: ToolDefinition = {
  id: 'quickCall',
  name: 'Quick Call',
...
const quickTextDef: ToolDefinition = {
  id: 'quickText',
  name: 'Quick Text',
...
const quickEmailDef: ToolDefinition = {
  id: 'quickEmail',
  name: 'Quick Email',
...
function parseDuration(duration: string): { minutes: number; seconds: number } | null {
...
export const shortcutsToolDefinitions: ToolDefinition[] = [
  quickAlarmDef,
  quickTimerDef,
  quickWeatherDef,
  quickMusicDef,
