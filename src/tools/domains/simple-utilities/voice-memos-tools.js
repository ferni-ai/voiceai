 ...
 * List voice memos
 */
export const listVoiceMemosDef = {
    id: 'listVoiceMemos',
 ...
 */
export const recallVoiceMemoDef = {
    id: 'recallVoiceMemo',
 ...
 * Delete a voice memo
 */
export const deleteVoiceMemoDef = {
    id: 'deleteVoiceMemo',
 ...
 * Search voice memos
 */
export const searchVoiceMemosDef = {
    id: 'searchVoiceMemos',
        ...
        return llm.tool({
            ...
            execute: async ({ query, limit = 5 }) => {
                ...
                try {
                    const memos = await getMemos(userId);
                    const queryLower = query.toLowerCase();
                    const matches = memos.filter((m) => m.title.toLowerCase().includes(queryLower) ||
                        m.transcript?.toLowerCase().includes(queryLower) ||
                        m.tags?.some((t) => t.toLowerCase().includes(queryLower)));
                    if (matches.length === 0) {
...
// EXPORTS
// ============================================================================
export const voiceMemosToolDefinitions = [
    saveVoiceMemoDef,
    listVoiceMemosDef,
    recallVoiceMemoDef,
    deleteVoiceMemoDef,
...
//# sourceMappingURL=voice-memos-tools.js.map