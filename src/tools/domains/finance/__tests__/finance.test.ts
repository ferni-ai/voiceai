/**
 * Finance Domain Tools Tests
 *
 * Tests for banking, calculators, and personal finance tools.
 *
 * Run with: npx vitest run src/tools/domains/finance/__tests__/finance.test.ts
 */
  ...
  describe('Tool Loading', () => {
    ...
    it('should have correct domain', () => {
      for (const tool of toolDefinitions) {
        expect(tool.domain).toBe('finance');
      }
    });
  });
