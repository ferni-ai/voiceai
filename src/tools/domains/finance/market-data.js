...
const ALPHA_VANTAGE_KEY = process.env.ALPHA_VANTAGE_API_KEY || (process.env.NODE_ENV !== 'production' ? 'demo' : '');
// ============================================================================
...
export async function getStockQuote(symbol) {
    ...
    const upperSymbol = symbolValidation.sanitized;
    ...
    const rangeInfo = quote.high && quote.low
...
export async function getMarketOverview() {
    ...
    const quotes = await Promise.all(indices.map(async ({ symbol, name }) => {
