 ...
 */
export function calculateHomeAffordability(annualIncome, monthlyDebts, downPayment, interestRate) {
    ...
    const maxLoan = (availableForHousing * (Math.pow(1 + monthlyRate, numPayments) - 1)) /
 ...
 */
export function calculateBudgetAllocation(monthlyIncome) {
    return {
 ...
 */
export function calculateCDLadder(totalAmount, rates // Array of rates for each rung (1yr, 2yr, 3yr, etc.)
) {
 ...
 */
export function calculateFIRENumber(annualExpenses, withdrawalRate = 4) {
    ...
    return {
        ...
        calculateHomeAffordability: llm.tool({
            ...
            execute: async ({ annualIncome, monthlyDebts, downPayment, interestRate }) => {
                ...
                const result = calculateHomeAffordability(annualIncome, monthlyDebts, downPayment, interestRate);
        ...
        explainBankingConcepts: llm.tool({
            ...
            execute: async ({ concept }) => {
                ...
                return (explanations[concept] || "Let me know which banking concept you'd like me to explain.");
            },
        }),
        explainMortgageConcepts: llm.tool({
            ...
            execute: async ({ concept }) => {
                ...
                return (explanations[concept] || "Let me know which mortgage concept you'd like me to explain.");
            },
        }),
        explainRetirementAccounts: llm.tool({
            ...
            execute: async ({ accountType }) => {
                ...
                return (explanations[accountType] ||
...
//# sourceMappingURL=personal-finance.js.map