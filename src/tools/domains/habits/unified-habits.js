...
import { getUserId, generateId, progressBar, } from '../../utils/tool-helpers.js';
...
function getCompletionRate(habitId, logs, days = 30) {
...
export const getTendencyAdviceDef = {
...
export const getLifeDomainsDef = {
    id: 'getLifeDomains',
...
//# sourceMappingURL=unified-habits.js.map