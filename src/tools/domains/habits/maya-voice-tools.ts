/**
 * Maya's Voice-First Habit Tools
 *
 ...
 *
 * @module habits/maya-voice-tools
 */
...
export const quickHabitCheckDefinition: ToolDefinition = {
  ...
  domain: 'habits',
  tags: ['habits', 'voice', 'checkin', 'quick', 'maya'],
...
export const microCommitNowDefinition: ToolDefinition = {
  ...
  domain: 'habits',
  tags: ['habits', 'voice', 'action', 'micro', 'tiny', 'maya'],
...
export const implementationIntentionDefinition: ToolDefinition = {
  ...
  domain: 'habits',
  tags: ['habits', 'voice', 'planning', 'intention', 'science', 'maya'],
...
export const mayaVoiceTools: ToolDefinition[] = [
