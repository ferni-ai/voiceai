 ...
 */
export const DEFAULT_BIRTHDAY_REMINDER = {
...
export const DEFAULT_CONTACT_FREQUENCIES = [
    {
 ...
 */
export const INTEREST_GIFT_MAPPINGS = {
    reading: [
        {
            category: 'Books',
 ...
 */
export const GENERIC_GIFT_SUGGESTIONS = [
    {
        category: 'Experience',
