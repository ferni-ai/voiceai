 ...
 */
async function getUSDANutrition(food: string): Promise<NutritionData | null> {
  const log = getLogger();
 ...
 */
const COMMON_FOODS: Record<string, NutritionData> = {
  'banana': { name: 'Banana', calories: 105, protein: 1.3, carbs: 27, fat: 0.4, fiber: 3.1, sugar: 14, servingSize: '1 medium (118g)' },
  'apple': { name: 'Apple', calories: 95, protein: 0.5, carbs: 25, fat: 0.3, fiber: 4.4, sugar: 19, servingSize: '1 medium (182g)' },
  'egg': { name: 'Egg', calories: 78, protein: 6.3, carbs: 0.6, fat: 5.3, fiber: 0, sugar: 0.6, servingSize: '1 large (50g)' },
  'chicken breast': { name: 'Chicken Breast', calories: 165, protein: 31, carbs: 0, fat: 3.6, fiber: 0, sugar: 0, servingSize: '100g cooked' },
  'rice': { name: 'White Rice', calories: 206, protein: 4.3, carbs: 45, fat: 0.4, fiber: 0.6, sugar: 0, servingSize: '1 cup cooked (158g)' },
  'salmon': { name: 'Salmon', calories: 208, protein: 20, carbs: 0, fat: 13, fiber: 0, sugar: 0, servingSize: '100g cooked' },
  'avocado': { name: 'Avocado', calories: 322, protein: 4, carbs: 17, fat: 29, fiber: 13, sugar: 1.3, servingSize: '1 whole (201g)' },
  'bread': { name: 'Whole Wheat Bread', calories: 81, protein: 4, carbs: 14, fat: 1.1, fiber: 1.9, sugar: 1.4, servingSize: '1 slice (28g)' },
  'milk': { name: 'Whole Milk', calories: 149, protein: 8, carbs: 12, fat: 8, fiber: 0, sugar: 12, servingSize: '1 cup (244ml)' },
  'coffee': { name: 'Black Coffee', calories: 2, protein: 0.3, carbs: 0, fat: 0, fiber: 0, sugar: 0, servingSize: '1 cup (240ml)' },
  'pizza': { name: 'Pizza (Cheese)', calories: 285, protein: 12, carbs: 36, fat: 10, fiber: 2.5, sugar: 4, servingSize: '1 slice (107g)' },
  'hamburger': { name: 'Hamburger', calories: 540, protein: 34, carbs: 40, fat: 27, fiber: 3, sugar: 11, servingSize: '1 burger (226g)' },
  'salad': { name: 'Garden Salad', calories: 35, protein: 2.6, carbs: 7, fat: 0.4, fiber: 3.1, sugar: 4, servingSize: '1 cup (85g)' },
  'orange': { name: 'Orange', calories: 62, protein: 1.2, carbs: 15, fat: 0.2, fiber: 3.1, sugar: 12, servingSize: '1 medium (131g)' },
  'yogurt': { name: 'Greek Yogurt', calories: 100, protein: 17, carbs: 6, fat: 0.7, fiber: 0, sugar: 4, servingSize: '1 cup (245g)' },
};

function findCommonFood(query: string): NutritionData | null {
 ...
 */
export async function getNutritionInfo(food: string): Promise<string> {
  const log = getLogger();
 ...
 */
export async function compareNutrition(food1: string, food2: string): Promise<string> {
  const log = getLogger();
