...
import { getTodaysTasks, getOverdueTasks, getUpcomingTasks, } from '../productivity/tasks.js';
import { getUpcomingBills, calculateMonthlyTotal } from '../finance/bills.js';
import { getDueHabits, calculateStreak } from '../habits/habits.js';
import { getTodayJournal, getJournalStreak } from '../productivity/notes.js';
import { getToolDescription } from '../../utils/tool-descriptions.js';
import { getDueDoses, getUpcomingDoses, getMedsNeedingRefill, } from '../wellness/medications.js';
// ============================================================================
// MOTIVATIONAL QUOTES
// ============================================================================
            ...
            execute: async ({ userName }, { ctx }) => {
                ...
                try {
                    ...
                    if (needsRefill.length > 0) {
                        response += `⚠️ **Refill needed:** ${needsRefill.map((m) => m.name).join(', ')}\n\n`;
                    }
                }
                catch (error) {
