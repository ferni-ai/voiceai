 ...
 */
function createSelfRegisterTool(_ctx) {
    return {
...
- claimedSponsorName (string, optional): Name of person they claim to know`,
        ...
        execute: async (args) => {
            ...
            try {
                const { createSelfRegisteredIdentity, lookupByPhone } = await import('../../../services/identity/sponsored-identity.js');
                ...
                const identity = await createSelfRegisteredIdentity(callerPhone, callerName, claimedRelationship, claimedSponsorName);
                log.info({
                ...
                return {
                    success: false,
                    message: "I had some trouble remembering you this time. Let's try again another time, okay?",
                };
            }
        },
    };
 ...
 */
function createCheckPendingIdentifiesTool(_ctx) {
    return {
...
- sponsorUserId (string, optional): Check for identities claiming to know this user`,
        ...
        execute: async (args) => {
            try {
                const { getPendingIdentities } = await import('../../../services/identity/sponsored-identity.js');
...
//# sourceMappingURL=self-registration-tool.js.map