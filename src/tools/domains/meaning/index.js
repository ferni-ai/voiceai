...
const alignActionsWithPurposeDef = {
...
const valueConflictResolutionDef = {
...
const findMeaningInSufferingDef = {
...
// ============================================================================
const spiritualPracticeSupportDef = {
...
// PHILOSOPHY TOOLS
// ============================================================================
const exploreLifePhilosophyDef = {
...
// ============================================================================
const createPersonalMissionDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ workSituation, jobDescription }) => {
                ...
                if (jobDescription)
                    response += `Your work: ${jobDescription}\n`;
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('meaning', meaningTools);
