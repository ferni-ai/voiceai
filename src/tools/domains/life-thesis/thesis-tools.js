...
import { saveHabitThesis, saveGoalThesis, saveCareerThesis, saveRelationshipThesis, saveHealthThesis, saveDecisionThesis, saveBoundaryThesis, saveCommitmentThesis, generateReminder, getThesesByDomain, getAllTheses, updateThesis, invalidateThesis, } from '../../../services/life-thesis/index.js';
// ============================================
// SAVE HABIT THESIS (Maya's domain)
// ============================================
export const saveHabitThesisDef = {
    id: 'saveHabitThesis',
...
// ============================================
export const saveGoalThesisDef = {
    id: 'saveGoalThesis',
...
// SAVE CAREER THESIS
// ============================================
export const saveCareerThesisDef = {
    id: 'saveCareerThesis',
...
// ============================================
export const saveRelationshipThesisDef = {
...
// SAVE HEALTH THESIS
// ============================================
export const saveHealthThesisDef = {
    id: 'saveHealthThesis',
...
// ============================================
export const saveDecisionThesisDef = {
...
// ============================================
export const saveBoundaryThesisDef = {
...
// ============================================
export const saveCommitmentThesisDef = {
...
Returns: Their original motivation, reflective questions, encouragement.`,
            ...
            execute: async (params) => {
                ...
                try {
                    const reminder = await generateReminder(ctx.userId, params.domain, params.currentSituation, params.emotionalState);
                    if (!reminder) {
            ...
            execute: async (params) => {
                ...
                try {
                    const theses = params.domain
                        ? await getThesesByDomain(ctx.userId, params.domain)
...
export function createThesisTools() {
    return thesisTools;
}
//# sourceMappingURL=thesis-tools.js.map