 ...
 * These tools represent Nayan's supernatural patience, memory, and perspective.
 *
 * DOMAIN: nayan-wisdom
 * TOOLS:
...
import { recordParadox, getParadoxes, recordEnoughStatement, getEnoughStatements, recordIncubatingWisdom, getIncubatingWisdom, } from '../../../services/superhuman/nayan-wisdom-services.js';
const log = createLogger({ module: 'tools:nayan-wisdom' });
// ============================================================================
// PARADOX KEEPER - Hold contradictions without resolution
// ============================================================================
const holdParadoxDef = {
    id: 'holdParadox',
    name: 'Hold Paradox',
    description: 'Track contradictory desires/values without trying to resolve them. Nayan can hold both truths indefinitely.',
    domain: 'nayan-wisdom',
    tags: ['wisdom', 'paradox', 'acceptance', 'nayan-specialty'],
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ desire1, desire2, context, howLongHeld }) => {
                ...
                const similar = existingParadoxes.find((p) => (p.desire1.toLowerCase().includes(desire1.toLowerCase()) ||
...
// ============================================================================
const mortalityPerspectiveDef = {
    id: 'mortalityPerspective',
    name: 'Mortality Perspective',
    description: 'Provide concrete mortality awareness for clarity. Not morbid—clarifying. The Stoic memento mori made personal.',
    domain: 'nayan-wisdom',
    tags: ['wisdom', 'mortality', 'perspective', 'nayan-specialty'],
    create: (ctx) => {
        return llm.tool({
...
// ============================================================================
const generatePersonalKoanDef = {
    id: 'generatePersonalKoan',
    name: 'Generate Personal Koan',
    description: 'Generate a personalized paradox/koan designed to break specific thinking patterns. Questions that dissolve problems.',
    domain: 'nayan-wisdom',
    tags: ['wisdom', 'koan', 'paradox', 'pattern-breaking', 'nayan-specialty'],
    create: (ctx) => {
        return llm.tool({
...
// ============================================================================
const trackEnoughDef = {
    id: 'trackEnough',
    name: 'Track Enough',
    description: 'Record when someone declares something is "enough" and remind them when goalposts move. Hold the mirror to striving.',
    domain: 'nayan-wisdom',
    tags: ['wisdom', 'enough', 'sufficiency', 'contentment', 'nayan-specialty'],
    create: (ctx) => {
        return llm.tool({
...
// ============================================================================
const ancestralWisdomDef = {
    id: 'ancestralWisdom',
    name: 'Ancestral Wisdom',
    description: 'Help connect to the wisdom of ancestors and lineage. What did they know that we have forgotten?',
    domain: 'nayan-wisdom',
    tags: ['wisdom', 'ancestors', 'lineage', 'heritage', 'nayan-specialty'],
    create: (ctx) => {
        return llm.tool({
...
// ============================================================================
const trackWisdomIncubationDef = {
    id: 'trackWisdomIncubation',
    name: 'Track Wisdom Incubation',
    description: 'Track things the user needs to "sit with" and return to them at the right moment. Perfect patience for things that need time.',
    domain: 'nayan-wisdom',
    tags: ['wisdom', 'patience', 'incubation', 'timing', 'nayan-specialty'],
    create: (ctx) => {
        return llm.tool({
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('nayan-wisdom', nayanWisdomTools);
