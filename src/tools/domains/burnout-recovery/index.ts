...
const restAsSkillDef: ToolDefinition = {
  id: 'restAsSkill',
  name: 'Rest as Skill',
    ...
    return llm.tool({
      ...
      execute: async ({ restStuggle }) => {
        ...
        const struggleResponses: Record<string, string> = {
          'cant-relax':
            "If you can't relax, your nervous system is stuck in 'on.' This requires rewiring. Start with body-based rest: gentle movement, warm baths, nature. Your mind won't settle until your body does.",
          'feel-guilty':
            "Guilt about resting is productivity culture damage. Rest isn't earned or deserved - it's required for function. You wouldn't guilt-trip your phone for needing to charge.",
          'still-exhausted':
            "If rest isn't restoring you, you may be doing the wrong type. Not all rest is equal. You need rest that matches your depletion type.",
          'dont-know-how':
            "If you don't know how to rest, you've been running on fumes so long you forgot what it feels like. Let's rebuild your rest repertoire.",
          'no-time':
            "'No time' for rest means you're already in deficit. Small pockets of rest prevent the collapse that steals all your time. This isn't optional - it's urgent.",
        };
...
const recoveryPlanDef: ToolDefinition = {
...
const burnoutWarningSignsDef: ToolDefinition = {
...
const boundariesForRecoveryDef: ToolDefinition = {
...
const burnoutRecoveryTools: ToolDefinition[] = [
  assessBurnoutDef,
  restAsSkillDef,
  recoveryPlanDef,
