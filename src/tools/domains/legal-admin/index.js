    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ lifeSituation, currentDocuments }) => {
                ...
                if (lifeSituation)
                    response += `_Life situation: ${lifeSituation}_\n\n`;
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ lastReview, lifeChange }) => {
                ...
                if (lastReview)
                    response += `_Last reviewed: ${lastReview}_\n`;
                if (lifeChange)
                    response += `_Recent change: ${lifeChange}_\n`;
                response += `\n---\n\n`;
...
// INSURANCE TOOLS
// ============================================================================
const reviewInsuranceCoverageDef = {
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ insuranceType, lifeChange }) => {
                ...
                if (lifeChange)
                    response += `_Life change: ${lifeChange}_\n\n`;
                response += `---\n\n`;
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('legal-admin', legalAdminTools);
