...
// MORNING SKY CHECK
// ============================================================================
export const morningSkyCheckDef = {
    id: 'morningSkyCheck',
...
// KINTSUGI MOMENTS
// ============================================================================
export const kintsugiMomentsDef = {
    id: 'kintsugiMoments',
...
// ============================================================================
export const questionOfTheWeekDef = {
    ...
    create: (_ctx) => {
        return llm.tool({
            ...
            execute: async ({ mode, answer }) => {
                const weekOfYear = Math.floor((Date.now() - new Date(new Date().getFullYear(), 0, 0).getTime()) /
                    (7 * 24 * 60 * 60 * 1000));
                const questions = [
...
// EXPORTS
// ============================================================================
export const emotionalGameDefinitions = [
    morningSkyCheckDef,
    kintsugiMomentsDef,
    questionOfTheWeekDef,
];
//# sourceMappingURL=emotional-games.js.map