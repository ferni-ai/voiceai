...
// QUICK CHALLENGES
// ============================================================================
export const quickChallengesDef = {
    id: 'quickChallenges',
    ...
    create: (_ctx) => {
        return llm.tool({
            ...
            execute: async ({ category }) => {
                ...
                const categoryList = category === 'random' ? Object.values(challenges).flat() : challenges[category];
...
// REFLECTION PROMPTS
// ============================================================================
export const reflectionPromptsDef = {
...
// CELEBRATION MOMENT
// ============================================================================
export const celebrationMomentDef = {
...
// EXPORTS
// ============================================================================
export const teamChallengeDefinitions = [
    teamHuddleDef,
    quickChallengesDef,
...
//# sourceMappingURL=team-challenges.js.map