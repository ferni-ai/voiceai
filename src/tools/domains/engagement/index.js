...
morningSkyCheckDef, kintsugiMomentsDef, questionOfTheWeekDef, 
// Financial games (Maya)
compoundInterestGameDef, tinyBetsDef, 
// Life planning games (Jordan)
futureSelfLetterDef, lifePorfolioReviewDef, predictionMarketDef, 
// Wisdom games (Nayan)
paradoxOfTheDayDef, questionBeneathDef, 
// Analytics games (Peter)
patternDetectiveDef, weeklyPredictionDef, 
// Productivity games (Alex)
inboxZeroChallengeDef, sundayPrepGameDef, 
// Team challenges
teamHuddleDef, quickChallengesDef, reflectionPromptsDef, streakTrackerDef, celebrationMomentDef, };
...
export const { getToolDefinitions, domain, definitions } = createDomainExport('engagement', engagementTools);
