...
registerActionType({
    ...
    prepare: async (payload, context) => {
        ...
        // Get cost estimate
        const estimate = await client.getCostEstimates(p.startLatitude, p.startLongitude, p.endLatitude, p.endLongitude, p.rideType);
...
// TOOL DEFINITIONS
// ============================================================================
export function getTransportationToolDefinitions() {
    return [
        // =========================================================================
