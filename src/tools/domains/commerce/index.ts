...
export function getCommerceToolDefinitions(): ToolDefinition[] {
  return [
    ...
    // =========================================================================
    {
      ...
      description:
        'Order groceries from your shopping list via Instacart.',
      domain: 'commerce',
    ...
    // =========================================================================
    {
      ...
      description:
        'Analyze your bank transactions to find recurring subscriptions.',
      domain: 'commerce',
    ...
    // =========================================================================
    {
      ...
      description:
        'Get a breakdown of your monthly subscription costs by category.',
      domain: 'commerce',
    ...
    // =========================================================================
    {
      ...
      description:
        'Help you cancel a subscription.',
      domain: 'commerce',
