    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ dream, whyUnfulfilled }) => {
                ...
                if (whyUnfulfilled)
                    response += `Why it won't happen: ${whyUnfulfilled}\n`;
                response += `\n`;
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ alternativePath, turningPoint }) => {
                ...
                if (turningPoint)
                    response += `The turning point: ${turningPoint}\n`;
                response += `\n`;
...
// EXPORTS
// ============================================================================
export const { getToolDefinitions, domain, definitions } = createDomainExport('dreams', dreamsTools);
