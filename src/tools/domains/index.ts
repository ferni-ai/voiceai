...
export async function getAllDomainToolDefinitions(): Promise<ToolDefinition[]> {
  const results = await Promise.allSettled([
    // Functional domains
    import('./memory/index.js').then((m) => m.getToolDefinitions()),
    import('./productivity/index.js').then((m) => m.getToolDefinitions()),
    import('./information/index.js').then((m) => m.getToolDefinitions()),
    import('./handoff/index.js').then((m) => m.getToolDefinitions()),
    import('./calendar/index.js').then((m) => m.getToolDefinitions()),
    import('./habits/index.js').then((m) => m.getToolDefinitions()),
    import('./proactive/index.js').then((m) => m.getToolDefinitions()),
    import('./finance/index.js').then((m) => m.getToolDefinitions()),
    import('./wellness/index.js').then((m) => m.getToolDefinitions()),
    import('./wisdom/index.js').then((m) => m.getToolDefinitions()),
    import('./communication/index.js').then((m) => m.getToolDefinitions()),
    import('./research/index.js').then((m) => m.getToolDefinitions()),
    import('./life-planning/index.js').then((m) => m.getToolDefinitions()),
    import('./entertainment/index.js').then((m) => m.getToolDefinitions()),
    import('./telephony/index.js').then((m) => m.getToolDefinitions()),
    // Deep human engagement domains
    import('./relationships/index.js').then((m) => m.getToolDefinitions()),
    import('./meaning/index.js').then((m) => m.getToolDefinitions()),
    import('./grief/index.js').then((m) => m.getToolDefinitions()),
    import('./stories/index.js').then((m) => m.getToolDefinitions()),
    import('./vulnerability/index.js').then((m) => m.getToolDefinitions()),
    import('./curiosity/index.js').then((m) => m.getToolDefinitions()),
    import('./dreams/index.js').then((m) => m.getToolDefinitions()),
