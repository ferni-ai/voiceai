    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ resentmentTarget, howLong, resentmentType }) => {
                ...
                const typeInfo = resentmentType && resentmentType !== 'other' ? RESENTMENT_SOURCES[resentmentType] : null;
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ familyMember, specificResentment, relationshipStatus }) => {
                ...
                const parentalContent = familyMember === 'parent'
                    ? `
...
export const { getToolDefinitions, domain, definitions } = createDomainExport('resentment', resentmentTools);
