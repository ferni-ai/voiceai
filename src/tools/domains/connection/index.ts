...
const acknowledgeLonelinessDef: ToolDefinition = {
  ...
  create: (ctx: ToolContext): Tool => {
    return llm.tool({
      ...
      execute: async ({ howLonelyFeels, howLong, whatTheyveTriед }) => {
        getLogger().info(
          { agentId: ctx.agentId, hasHowLong: !!howLong },
...
const exploreLonelinessTypeDef: ToolDefinition = {
...
const sitWithLonelinessDef: ToolDefinition = {
...
const makeAdultFriendsDef: ToolDefinition = {
  id: 'makeAdultFriends',
...
const recognizeToxicFriendshipDef: ToolDefinition = {
...
const findYourPeopleDef: ToolDefinition = {
  id: 'findYourPeople',
...
const createBelongingDef: ToolDefinition = {
  id: 'createBelonging',
...
const balanceAloneAndTogetherDef: ToolDefinition = {
...
const smallActsOfConnectionDef: ToolDefinition = {
  ...
  create: (ctx: ToolContext): Tool => {
    return llm.tool({
      ...
      execute: async ({ timeAvailable, energyLevel, preference }) => {
        getLogger().info(
          { agentId: ctx.agentId, timeAvailable, energyLevel },
          'Suggesting small acts of connection'
        );
...
const shareConnectionWisdomDef: ToolDefinition = {
