/**
 * Wisdom Intelligence Tools (Nayan Patel's Specialty)
 *
 ...
 *
 * DOMAIN: wisdom (intelligence sub-module, merged from wisdom-intelligence)
 * TOOLS:
  ...
  create: (ctx: ToolContext): Tool => {
    return llm.tool({
      ...
      execute: async ({ stuckPattern, whatTheyveTrieds, emotionalTone }) => {
        ...
        if (
          stuckLower.includes('control') ||
          stuckLower.includes('grip') ||
          stuckLower.includes('manage')
        )
          patternType = 'control';
        else if (
          stuckLower.includes('perfect') ||
          stuckLower.includes('ready') ||
          stuckLower.includes('right')
        )
          patternType = 'perfectionism';
        else if (
          stuckLower.includes('afraid') ||
          stuckLower.includes('fear') ||
          stuckLower.includes('scared')
        )
          patternType = 'fear';
        else if (
          stuckLower.includes('think') ||
          stuckLower.includes('decide') ||
          stuckLower.includes('analyze')
        )
          patternType = 'overthinking';
        else if (
          stuckLower.includes('worth') ||
          stuckLower.includes('enough') ||
          stuckLower.includes('deserve')
        )
          patternType = 'worthiness';
        else if (
          stuckLower.includes('change') ||
          stuckLower.includes('different') ||
          stuckLower.includes('stuck')
        )
          patternType = 'change';
...
export const wisdomIntelligenceTools: ToolDefinition[] = [
  holdParadoxDef,
