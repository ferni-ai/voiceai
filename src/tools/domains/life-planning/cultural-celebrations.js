...
export const CULTURAL_CELEBRATIONS = {
    quinceanera: {
        name: 'Quinceañera',
        culture: 'Latin American',
        description: "A celebration of a girl's 15th birthday marking her transition from childhood to young womanhood",
        typicalAge: 15,
        traditions: [
    ...
    'bar-mitzvah': {
        name: 'Bar Mitzvah',
        culture: 'Jewish',
        description: 'A coming-of-age ceremony for Jewish boys at age 13, marking their responsibility for their actions under Jewish law',
        typicalAge: 13,
        traditions: [
    ...
    'bat-mitzvah': {
        name: 'Bat Mitzvah',
        culture: 'Jewish',
        description: 'A coming-of-age ceremony for Jewish girls at age 12 or 13, marking their responsibility under Jewish law',
        typicalAge: '12 or 13',
        traditions: [
    ...
    'sweet-sixteen': {
        name: 'Sweet Sixteen',
        culture: 'American',
        description: "A celebration of a teenager's 16th birthday, particularly significant in American culture",
        typicalAge: 16,
        traditions: [
    ...
    debutante: {
        ...
        description: 'A formal presentation of young women to society, traditionally marking their eligibility for adulthood',
        typicalAge: '16-21',
        traditions: [
    ...
    'first-communion': {
        ...
        culture: 'Catholic',
        description: "A religious ceremony marking a child's first reception of the Eucharist in the Catholic Church",
        typicalAge: '7-8',
        traditions: [
            ...
            execute: async ({ age, culture, budget }) => {
                ...
                for (const [key, celebration] of Object.entries(CULTURAL_CELEBRATIONS)) {
                    ...
                    if (typeof typicalAge === 'number' && Math.abs(typicalAge - age) <= 2) {
                        suggestions.push(`**${celebration.name}** (${celebration.culture}) - typically age ${typicalAge}`);
                    }
...
//# sourceMappingURL=cultural-celebrations.js.map