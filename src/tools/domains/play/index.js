    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ whatNeedsPermission, whyTheyHesitate }) => {
                ...
                if (whyTheyHesitate)
                    response += `But you hesitate because: ${whyTheyHesitate}\n`;
                response += `\n`;
    ...
    create: (ctx) => {
        return llm.tool({
            ...
            execute: async ({ whatWasFun, whatMadeItFun }) => {
                ...
                if (whatMadeItFun)
                    response += `What made it fun: ${whatMadeItFun}\n`;
                response += `\n`;
