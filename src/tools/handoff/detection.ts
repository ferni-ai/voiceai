 ...
 */
export function shouldHandoffToNayan(userInput: string): boolean {
  const lowerInput = userInput.toLowerCase();
 ...
 */
export function shouldHandoffToAlex(userInput: string): boolean {
  const lowerInput = userInput.toLowerCase();
 ...
 */
export function shouldHandoffToMaya(userInput: string): boolean {
  const lowerInput = userInput.toLowerCase();
 ...
 */
export function shouldHandoffToJordan(userInput: string): boolean {
  const lowerInput = userInput.toLowerCase();
 ...
 */
export function shouldHandoffToFerni(userInput: string): boolean {
  const lowerInput = userInput.toLowerCase();
