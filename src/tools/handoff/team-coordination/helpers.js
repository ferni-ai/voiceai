...
import { TEAM_CAPABILITIES, MAX_NAME_LENGTH, MAX_NOTES_LENGTH, MAX_AMOUNT, } from './types.js';
// ============================================================================
// VALIDATION HELPERS
// ============================================================================
...
export function validateAmountField(amount, fieldName = 'amount') {
 ...
 */
export async function getOrCreateTeamContext(userId) {
 ...
 */
export function findBestTeamMember(need) {
 ...
 */
export function getTeamMemberInfo(member) {
