 ...
 */
export function interpretToolResult(personaId, context) {
 ...
 */
export function getDomainInterpretation(personaId, domain) {
    const profile = getCognitiveProfile(personaId);
    if (!profile)
        return null;
 ...
 */
export function formatToolResultWithCognition(personaId, context, rawResultText) {
 ...
 */
export function getToolProcessingSound(personaId) {
    const profile = getCognitiveProfile(personaId);
    if (!profile)
        return 'Hmm';
    const sounds = {
...
// HELPERS
// ============================================================================
function shouldShowUncertainty(profile, context) {
...
//# sourceMappingURL=cognitive-tool-interpretation.js.map