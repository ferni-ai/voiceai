 ...
 *
 * ARCHITECTURE:
 * - Types defined in ./scheduling/types.ts
 * - Core functions in ./scheduling/appointment-core.ts
 * - Tool definitions remain here
 */
...
// ============================================================================
// TYPES & CORE FUNCTIONS (from ./scheduling/ modules)
// ============================================================================
...
// Import core functions for use in tool definitions
import {
  ...
  getAppointment,
  getUserAppointments,
} from './scheduling/appointment-core.js';

// ============================================================================
// TOOL DEFINITIONS
// ============================================================================
// Note: Types and core functions have been moved to ./scheduling/ directory
// The tool definitions below use the imported functions from appointment-core.ts

// Placeholder to mark where old code was removed (lines 61-383)
// The following tool definitions remain here as they define the LLM tools

// REMOVED: Duplicate type definitions (now in ./scheduling/types.ts)
// REMOVED: appointments Map (now in ./scheduling/appointment-core.ts)
// REMOVED: createAppointmentRequest (now in ./scheduling/appointment-core.ts)
// REMOVED: updateAppointmentStatus (now in ./scheduling/appointment-core.ts)
// REMOVED: generateCallScript (now in ./scheduling/appointment-core.ts)
// REMOVED: makeAppointmentCall (now in ./scheduling/appointment-core.ts)

// NOTE: ~275 lines of duplicate code removed (types, appointments Map, and core functions)
// These are now in ./scheduling/types.ts and ./scheduling/appointment-core.ts

// ============================================================================
// TOOL DEFINITIONS - Using imported functions from appointment-core.ts
// ============================================================================

// Helper to get appointments for this module's tools (uses core module)
const getAppointmentsForUser = getUserAppointments;
const getAppointmentById = getAppointment;
