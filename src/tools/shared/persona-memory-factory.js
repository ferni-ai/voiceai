 ...
 */
export function formatResponse(message, options = {}) {
...
// ============================================================================
export const PERSONA_MEMORY_CONFIGS = {
    ferni: {
        personaId: 'ferni',
        displayName: 'Ferni',
        emoji: '🌟',
 ...
 */
export function createRememberTool(config) {
    return llm.tool({
        description: config.description,
        parameters: config.parameters,
        execute: async (params, { ctx }) => {
            const userId = getUserId({ ctx });
            return config.execute(params, userId);
        },
    });
}
/**
 ...
 */
export function createRecallTool(config) {
    return llm.tool({
        description: config.description,
        parameters: config.parameters,
        execute: async (params, { ctx }) => {
 ...
 */
export async function getMemoryToolsForPersona(personaId) {
 ...
 */
export async function getAllPersonaMemoryTools() {
    const creators = await getToolCreators();
    const allTools = {};
 ...
 */
export function getMemoryConfig(personaId) {
...
//# sourceMappingURL=persona-memory-factory.js.map