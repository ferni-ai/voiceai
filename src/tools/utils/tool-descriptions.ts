...
// ============================================================================
// ENHANCED DESCRIPTIONS TYPE
// ============================================================================

interface EnhancedToolEntry {
  description: string;
  parameters?: Record<string, string>;
}

interface EnhancedDescriptionsConfig {
  enhanced: Record<string, EnhancedToolEntry>;
}
...
let cachedConfig: ToolDescriptionsConfig | null = null;
let cachedEnhanced: EnhancedDescriptionsConfig | null = null;

function loadEnhancedConfig(): EnhancedDescriptionsConfig {
  ...
  try {
    ...
    cachedEnhanced = JSON.parse(content) as EnhancedDescriptionsConfig;

    log.debug(
      { enhancedCount: Object.keys(cachedEnhanced.enhanced).length },
      'Enhanced tool descriptions loaded (Vertex AI best practices)'
    );
...
function loadConfig(): ToolDescriptionsConfig {
  ...
  try {
    ...
    cachedConfig = JSON.parse(content) as ToolDescriptionsConfig;
 ...
 */
export function getParameterDescription(toolId: string, paramName: string): string {
 ...
 */
export function hasEnhancedDescription(toolId: string): boolean {
  const enhanced = loadEnhancedConfig();
 ...
 */
export function getEnhancedToolIds(): string[] {
  const enhanced = loadEnhancedConfig();
 ...
 */
export function setToolDescription(toolId: string, description: string): void {
  const config = loadConfig();
 ...
 */
export function reloadToolDescriptions(): void {
  cachedConfig = null;
  loadConfig();
 ...
 */
export function extractInlineDescription(description: string, toolId: string): void {
