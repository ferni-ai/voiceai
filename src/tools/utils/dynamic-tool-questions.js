 ...
 */
function adaptToPersonaVoice(questions, cognitiveDiff, emotionalTone) {
    if (!cognitiveDiff) {
        return questions;
    }
 ...
 */
function generateIntro(domain, focus, specificContext, cognitiveDiff) {
 ...
 */
function generateClosingPrompt(domain, cognitiveDiff) {
    const baseClosings = {
        stories: [
 ...
 */
export function generateToolQuestions(context) {
    ...
    log.debug({ personaId, domain, focus, questionCount: adaptedQuestions.length }, 'Generated tool questions');
    return {
        intro,
 ...
 */
export function formatQuestionsForResponse(generated, options) {
 ...
 */
export function getQuestions(personaId, domain, focus, specificContext) {
...
//# sourceMappingURL=dynamic-tool-questions.js.map