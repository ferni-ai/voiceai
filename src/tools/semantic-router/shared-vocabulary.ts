...
export const RELATIONSHIP_VOCABULARY = {
  // Family - Immediate
  family_immediate: {
    terms: ['mom', 'mother', 'dad', 'father', 'parents', 'son', 'daughter', 'child', 'children', 'kids'],
    weight: 0.9,
    context: 'family',
    sentiment: 'personal',
  },
  ...
  romantic: {
    terms: [
      ...
      'fiance', 'fiancee', 'significant other', 'SO', 'bae', 'love',
    ],
    weight: 0.9,
    context: 'romantic',
    sentiment: 'personal',
  ...
  friends: {
    terms: [
      'friend', 'friends', 'best friend', 'bestie', 'bff', 'buddy', 'pal',
      'roommate', 'housemate', 'neighbor',
    ],
    weight: 0.8,
    context: 'social',
    sentiment: 'personal',
  ...
  professional: {
    terms: [
      'boss', 'manager', 'supervisor', 'coworker', 'colleague', 'employee',
      'team', 'team member', 'client', 'customer', 'mentor', 'mentee',
    ],
    weight: 0.7,
    context: 'work',
  ...
  services: {
    terms: [
      'doctor', 'dentist', 'therapist', 'counselor', 'lawyer', 'accountant',
      'plumber', 'electrician', 'mechanic', 'contractor',
      'bank', 'pharmacy', 'hospital', 'clinic', 'office',
    ],
    weight: 0.6,
    context: 'service',
  ...
  group_team: {
    terms: [
      'team', 'our team', 'the team', 'group', 'our group', 'committee',
      'board', 'department', 'squad', 'crew', 'staff', 'organization',
    ],
    weight: 0.7,
    context: 'group',
  ...
  community: {
    terms: [
      'community', 'neighborhood', 'neighbors', 'congregation', 'church',
      'temple', 'mosque', 'synagogue', 'parish', 'local', 'town',
    ],
    weight: 0.65,
    context: 'community',
    sentiment: 'collective',
  ...
  social_group: {
    terms: [
      'book club', 'support group', 'meetup', 'club', 'class', 'classmates',
      'alumni', 'members', 'fellow', 'peers', 'cohort', 'circle of friends',
    ],
    weight: 0.7,
    context: 'social',
    sentiment: 'collective',
...
export const EMOTIONAL_VOCABULARY = {
  ...
  positive: {
    terms: [
      'happy', 'excited', 'grateful', 'thankful', 'joyful', 'content',
      'proud', 'confident', 'hopeful', 'optimistic', 'calm', 'peaceful',
      'energized', 'motivated', 'inspired', 'accomplished',
    ],
    weight: 0.7,
    valence: 'positive',
    urgency: 'low',
  ...
  stressed: {
    terms: [
      'stressed', 'anxious', 'worried', 'nervous', 'overwhelmed', 'panicked',
      'tense', 'on edge', 'freaking out', 'cant cope', "can't cope",
    ],
    weight: 0.85,
    valence: 'negative',
    urgency: 'medium',
  ...
  sad: {
    terms: [
      ...
      'lonely', 'isolated', 'empty', 'numb', 'hopeless', 'despair',
    ],
    weight: 0.85,
    valence: 'negative',
    urgency: 'medium',
  ...
  angry: {
    terms: [
      ...
      'pissed', 'enraged', 'resentful', 'bitter',
    ],
    weight: 0.8,
    valence: 'negative',
    urgency: 'medium',
  ...
  crisis: {
    terms: [
      'suicidal', 'kill myself', 'end it', 'cant go on', "can't go on",
      'no reason to live', 'want to die', 'hurt myself', 'self-harm',
      'emergency', 'crisis', 'urgent', 'help me now',
    ],
    weight: 1.0,
    valence: 'crisis',
    urgency: 'critical',
  ...
  confused: {
    terms: [
      'confused', 'lost', 'stuck', 'dont know', "don't know", 'uncertain',
      'unsure', 'torn', 'conflicted', 'indecisive',
    ],
    weight: 0.7,
    valence: 'neutral',
    urgency: 'low',
  ...
  exhausted: {
    terms: [
      'exhausted', 'burnt out', 'burnout', 'drained', 'tired',
      'fatigued', 'wiped out', 'running on empty', 'overwhelmed',
    ],
    weight: 0.85,
    valence: 'negative',
    urgency: 'medium',
  ...
  scared: {
    terms: [
      ...
      'dreading', 'spooked', 'alarmed', 'petrified', 'panicking',
    ],
    weight: 0.85,
    valence: 'negative',
    urgency: 'medium',
  ...
  ashamed: {
    terms: [
      'ashamed', 'embarrassed', 'guilty', 'regret', 'mortified',
      'humiliated', 'self-conscious', 'disgraceful', 'blaming myself',
    ],
    weight: 0.8,
    valence: 'negative',
    urgency: 'medium',
  ...
  disgusted: {
    terms: [
      'disgusted', 'repulsed', 'grossed out', 'revolted', 'sickened',
      'appalled', 'offended', 'turned off',
    ],
    weight: 0.7,
    valence: 'negative',
    urgency: 'low',
  ...
  surprised: {
    terms: [
      ...
      'blown away', 'caught off guard', 'unexpected',
    ],
    weight: 0.6,
    valence: 'neutral',
    urgency: 'low',
  ...
  curious: {
    terms: [
      'curious', 'interested', 'fascinated', 'intrigued', 'wondering',
      'want to know', 'want to learn', 'exploring',
    ],
    weight: 0.65,
    valence: 'positive',
    urgency: 'low',
  ...
  bored: {
    terms: [
      'bored', 'boring', 'unstimulated', 'uninterested', 'disengaged',
      'nothing to do', 'monotonous', 'dull', 'tedious',
    ],
    weight: 0.6,
    valence: 'neutral',
    urgency: 'low',
  ...
  loving: {
    terms: [
      'love', 'loving', 'affection', 'adore', 'cherish',
      'care deeply', 'devoted', 'fond', 'smitten',
    ],
    weight: 0.75,
    valence: 'positive',
    urgency: 'low',
  ...
  grieving: {
    terms: [
      'grieving', 'mourning', 'loss', 'lost someone', 'passed away',
      'died', 'death', 'bereaved', 'missing them',
    ],
    weight: 0.9,
    valence: 'negative',
    urgency: 'medium',
  ...
  jealous: {
    terms: [
      'jealous', 'envious', 'envy', 'resentful', 'covetous',
      'comparing myself', 'feeling left out', 'fomo',
    ],
    weight: 0.7,
    valence: 'negative',
    urgency: 'low',
  ...
  anticipating: {
    terms: [
      'looking forward', 'cant wait', "can't wait", 'excited about',
      'eager', 'anticipating', 'counting down', 'pumped',
    ],
    weight: 0.7,
    valence: 'positive',
    urgency: 'low',
...
export const TIME_VOCABULARY = {
  ...
  emergency: {
    terms: [
      'emergency', 'critical', 'life or death', 'cant wait',
      "can't wait", 'need it now', 'this instant', 'right away',
    ],
    weight: 1.0,
    period: 'immediate',
    urgency: 'critical',
  ...
  deadline: {
    terms: [
      'deadline', 'due', 'due date', 'by tomorrow', 'by tonight',
      'end of day', 'eod', 'before', 'must be done', 'running out of time',
    ],
    weight: 0.75,
    period: 'deadline',
    urgency: 'high',
  ...
  soon: {
    terms: [
      'soon', 'shortly', 'in a bit', 'in a few minutes', 'in an hour',
      'this afternoon', 'this morning', 'today',
    ],
    weight: 0.6,
    period: 'near_future',
    urgency: 'medium',
  ...
  seasonal: {
    terms: [
      'holiday', 'christmas', 'thanksgiving', 'new years', 'birthday',
      'anniversary', 'summer', 'winter', 'spring', 'fall', 'season',
    ],
    weight: 0.5,
    period: 'seasonal',
...
export const LIFE_DOMAIN_VOCABULARY = {
  work: {
    terms: [
      ...
      'project', 'boss', 'coworker', 'promotion', 'salary', 'interview',
    ],
    weight: 0.8,
    domain: 'work',
  ...
  health: {
    terms: [
      'health', 'healthy', 'doctor', 'medical', 'sick', 'illness', 'symptom',
      'medication', 'exercise', 'diet', 'nutrition', 'sleep', 'fitness',
    ],
    weight: 0.8,
    domain: 'health',
  ...
  finance: {
    terms: [
      'money', 'budget', 'finance', 'financial', 'savings', 'debt', 'investment',
      'stock', 'bank', 'credit', 'loan', 'mortgage', 'retirement', 'expense',
    ],
    weight: 0.8,
    domain: 'finance',
  ...
  relationships: {
    terms: [
      'relationship', 'dating', 'marriage', 'divorce', 'family', 'friend',
      'breakup', 'conflict', 'communication', 'trust', 'love',
    ],
    weight: 0.85,
  ...
  personal_growth: {
    terms: [
      'growth', 'self-improvement', 'learning', 'goal', 'habit', 'change',
      'purpose', 'meaning', 'values', 'mindset', 'motivation',
    ],
    weight: 0.75,
  ...
  mental_health: {
    terms: [
      'mental health', 'therapy', 'therapist', 'counseling', 'anxiety', 'depression',
      'trauma', 'healing', 'coping', 'self-care', 'mindfulness',
    ],
    weight: 0.9,
...
export const INTENT_VOCABULARY = {
  ...
  decide: {
    terms: [
      'should i', 'what should', 'help me decide', 'torn between', 'cant decide',
      "can't decide", 'which one', 'better option', 'pros and cons',
    ],
    weight: 0.8,
    intent: 'decide',
    mood: 'question',
  ...
  plan: {
    terms: [
      'plan', 'planning', 'schedule', 'organize', 'prepare', 'set up',
      'get ready', 'make a plan', 'strategy',
    ],
    weight: 0.75,
    intent: 'plan',
    mood: 'request',
  ...
  understand: {
    terms: [
      'why', 'how come', 'what does', 'explain', 'understand', 'tell me about',
      'what is', 'how does', 'learn about',
    ],
    weight: 0.6,
    intent: 'understand',
    mood: 'question',
  ...
  action: {
    terms: [
      'do', 'start', 'begin', 'make', 'create', 'send', 'call', 'text',
      'play', 'stop', 'pause', 'set', 'add', 'remove', 'delete',
    ],
    weight: 0.9,
    intent: 'action',
    mood: 'command',
  ...
  reflect: {
    terms: [
      'think about', 'reflect on', 'process', 'work through', 'figure out',
      'make sense of', 'come to terms', 'understand myself',
    ],
    weight: 0.7,
    intent: 'reflect',
    mood: 'request',
