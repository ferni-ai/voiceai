 ...
 */
export function loadGorillaDataset(): TrainingExample[] {
 ...
 */
export function loadToolBenchPatterns(): TrainingExample[] {
  const examples: TrainingExample[] = [];

  // ToolBench categories mapped to Ferni tools
  const toolbenchMappings: Array<{
    category: string;
    queries: string[];
    mapToTool: string;
  }> = [
 ...
 */
export function logRoutingDecision(entry: Omit<RoutingLogEntry, 'timestamp'>): void {
  routingLogs.push({
    ...entry,
    timestamp: new Date(),
  });
 ...
 */
export function exportRoutingLogsAsTraining(): TrainingExample[] {
  const examples: TrainingExample[] = [];
...
const MUSIC_TEMPLATE: SyntheticTemplate = {
  patterns: [
    'play {genre}',
    'play some {genre}',
    'play {genre} music',
...
const HANDOFF_TEMPLATE: SyntheticTemplate = {
  patterns: [
    'talk to {persona}',
    'I need {persona}',
...
const REMINDER_TEMPLATE: SyntheticTemplate = {
  patterns: [
    'remind me to {task}',
...
const EMOTION_TEMPLATE: SyntheticTemplate = {
...
const HABIT_TEMPLATE: SyntheticTemplate = {
...
const BOUNDARIES_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const SOCIAL_SKILLS_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const ANGER_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const PROCRASTINATION_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const PERFECTIONISM_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const DIGITAL_WELLNESS_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const BURNOUT_TEMPLATE: SyntheticTemplate = {
  patterns: [
    "I'm so burnt out",
...
const BODY_RELATIONSHIP_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const DATING_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const NEURODIVERSITY_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const TRAUMA_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const INTIMACY_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const CHRONIC_CONDITIONS_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const MIDLIFE_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
const BREAKUP_TEMPLATE: SyntheticTemplate = {
  patterns: [
...
function getSyntheticTemplates(): SyntheticTemplate[] {
  return [
    // Core templates
    MUSIC_TEMPLATE,
    HANDOFF_TEMPLATE,
...
function generateFromTemplate(template: SyntheticTemplate): TrainingExample[] {
  const examples: TrainingExample[] = [];
 ...
 */
export function generateSyntheticExamples(): TrainingExample[] {
...
function selectNegativeExample(
  byTool: Map<string, TrainingExample[]>,
  toolIds: string[],
  ...
  if (otherExamples.length === 0) return null;
 ...
 */
export function exportForSentenceTransformers(
  examples: TrainingExample[]
): Array<{ anchor: string; positive: string; negative: string }> {
  const triplets: Array<{ anchor: string; positive: string; negative: string }> = [];

  // Group examples by tool
  const byTool = new Map<string, TrainingExample[]>();
 ...
 * Format: { text, label }
 */
export function exportForClassification(
  examples: TrainingExample[]
