...
export class RecommendationEngine {
    ...
    GENERATION_COOLDOWN = 60 * 60 * 1000; // 1 hour
    // ==========================================================================
    ...
    async generateRecommendations() {
        ...
        if (this.recommendations.length > 0) {
            runBackground(import('../../services/optimization-persistence.js').then(({ optimizationPersistence }) => {
    ...
    buildDeprecationRationale(tool) {
        const issues = [];
    ...
    createExperimentFromHypothesis(hypothesis) {
        return {
