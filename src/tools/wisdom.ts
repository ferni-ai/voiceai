...
export function createWisdomTools() {
  return {
    getWisdomQuote: llm.tool({
      description:
        'Get an inspirational investing quote from Jack Bogle or other investing legends. Use for motivation or to make a point.',
      parameters: z.object({}),
      execute: async () => {
    ...
    getBogleQuote: llm.tool({
      description:
        'Get a quote specifically from Jack Bogle. Use when emphasizing low-cost investing or long-term thinking.',
      parameters: z.object({}),
      execute: async () => {
    ...
    getResearchInsight: llm.tool({
      description:
        'Get evidence-based insight from Vanguard research. Use when you need data to support advice. Topics: costs, behavior, allocation, retirement, taxes.',
      parameters: z.object({
        category: z
    ...
    getCrashPerspective: llm.tool({
      description:
        'Get historical perspective on a specific market crash. Use when someone is worried about market drops.',
      parameters: z.object({
        crash: z
    ...
    getCostImpact: llm.tool({
      description:
        'Calculate and explain the impact of investment fees over time. Shows the power of low-cost investing with specific numbers.',
      parameters: z.object({
