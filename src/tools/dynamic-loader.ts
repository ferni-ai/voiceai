...
const TOPIC_TO_DOMAINS: Record<string, ToolDomain[]> = {
  ...
  scheduling: ['calendar', 'productivity'],
  ...
  reminders: ['calendar', 'communication'],
  ...
  emails: ['communication', 'productivity'],
  call: ['communication', 'telephony'],
  calls: ['communication', 'telephony'],
  phone: ['telephony', 'communication'],
  ...
  book: ['entertainment', 'wisdom'],
  books: ['entertainment', 'wisdom'],
  read: ['entertainment', 'wisdom'],
  reading: ['entertainment', 'wisdom'],
  podcast: ['entertainment', 'information'],
