 ...
 *
 * NOTE: Data constants are now in modular files under ./habit-coaching/
 * This file contains the tool creator function (createHabitCoachingTools).
 */
...
// Data
import { THIRTY_DAY_CHALLENGES } from './habit-coaching/challenges.js';
import { HABIT_TEMPLATES } from './habit-coaching/templates.js';
import { HABIT_BUNDLES } from './habit-coaching/bundles.js';
import { LIFE_TRANSITION_SUPPORT } from './habit-coaching/transitions.js';
...
function runtimeHabitToStored(habit: EnhancedHabit): EnhancedHabitData {
  return {
    ...
    habitLoop: habit.habitLoop ?? {
      cue: { type: 'time', description: 'Not configured', specificity: '' },
      routine: { behavior: habit.name, duration: 10, difficulty: 'easy' },
      reward: { intrinsic: 'Sense of accomplishment', celebration: 'Quick fist pump' },
    },
