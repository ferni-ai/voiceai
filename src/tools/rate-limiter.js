 ...
 */
export async function withRateLimit(service, fn, fallback) {
 ...
 */
export async function withRateLimitWait(service, fn, timeoutMs = 5000) {
    const limiter = getRateLimiter(service);
 ...
 */
export function isRateLimited(service) {
    const limiter = getRateLimiter(service);
