...
import { ALL_TOOL_DOMAINS, DOMAIN_TO_CATEGORY, EnvironmentServiceRegistry, validateToolDefinition, validateToolSetSpec, } from './types.js';
// ============================================================================
// TOOL REGISTRY CLASS
// ============================================================================
export class ToolRegistry {
    ...
    indexByCategory(category, toolId) {
    ...
    query(options = {}) {
        ...
        if (options.requiresService) {
            results = results.filter((def) => def.requiredServices?.includes(options.requiresService) ?? false);
        }
        return results;
    }
    // ==========================================================================
...
// EXPORTS
// ============================================================================
export { ALL_TOOL_DOMAINS, assertTool, DOMAIN_TO_CATEGORY, EmptyServiceRegistry, EnvironmentServiceRegistry, isTool, } from './types.js';
