/**
 * Maya Habit Coach - Four Tendencies Framework
 *
 * Based on Gretchen Rubin's personality framework for habit formation.
 */

// ============================================================================
// FOUR TENDENCIES - Personality-based habit strategies
// ============================================================================
...
/**
 * Get strategies for a tendency
 */
export function getTendencyStrategies(tendency: FourTendency) {
  return FOUR_TENDENCIES_STRATEGIES[tendency];
}

/**
 * Get motivation tip for a tendency
 */
