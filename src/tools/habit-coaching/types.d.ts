 ...
 */
export type LifeDomain = 'health' | 'mind' | 'relationships' | 'career' | 'learning' | 'finance' | 'home' | 'selfCare';
export type LifeStage = 'student' | 'early_career' | 'new_parent' | 'mid_career' | 'empty_nester' | 'pre_retirement' | 'retirement' | 'transition';
