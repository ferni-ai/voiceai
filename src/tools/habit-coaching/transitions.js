...
// LIFE TRANSITION SUPPORT
// ============================================================================
export const LIFE_TRANSITION_SUPPORT = {
    new_job: {
        name: 'New Job',
        validation: 'Starting a new job is exciting AND exhausting. Your entire routine has been disrupted.',
        expectations: [
        ...
        selfCareNote: "Be gentle with yourself. You're not lazy - you're adapting. Survival mode is okay temporarily.",
    },
    job_loss: {
        name: 'Job Loss',
        validation: "Losing a job is a grief experience. Even if you're relieved, the loss of structure and identity is real.",
        expectations: [
        ...
        selfCareNote: "Job searching IS a job. Limit it to prevent burnout. You're more than your employment status.",
    },
    new_baby: {
        name: 'New Baby',
        validation: 'Having a baby changes everything. Literally everything. Your old life is gone - a new one is beginning.',
        expectations: [
        ...
        selfCareNote: 'You are doing the hardest job in the world. Showering counts as an accomplishment. Lower the bar radically.',
    },
    new_relationship: {
        name: 'New Relationship',
        validation: "New relationships are wonderful AND can disrupt routines. It's normal to want to spend all your time together.",
        expectations: [
        ...
        selfCareNote: "It's okay to be obsessed at first. Just don't lose yourself completely. You were amazing before this person too.",
    },
    breakup: {
        name: 'Breakup/Divorce',
        validation: "Ending a relationship is a loss, even if it's the right choice. Grief, relief, and everything in between are valid.",
        expectations: [
        ...
        selfCareNote: "There's no timeline for healing. Some days will feel like progress, others like setbacks. Both are part of it.",
    },
    moving: {
        name: 'Moving',
        validation: "Moving disrupts everything - your physical space, your routines, your sense of place. It's a bigger deal than people acknowledge.",
        expectations: [
    ...
    empty_nest: {
        name: 'Empty Nest',
        validation: 'When kids leave, it can feel like losing your purpose. This is a real transition, not "just" an emotion.',
        expectations: [
 ...
 */
export function getTransitionSupport(transition) {
