...
export const MENTAL_HEALTH_PRONUNCIATIONS: PronunciationEntry[] = [
  // -------------------------------------------------------------------------
  ...
  { pattern: /\bACT\b(?!\s+on|\s+like|\s+as)/gi, replacement: 'A C T therapy', description: 'Acceptance and Commitment Therapy' },
  ...
  { pattern: /\bMBCT\b/g, replacement: 'M B C T', description: 'Mindfulness-Based Cognitive Therapy' },
  { pattern: /\bMBSR\b/g, replacement: 'M B S R', description: 'Mindfulness-Based Stress Reduction' },

  // -------------------------------------------------------------------------
  // Mental Health Conditions
  // -------------------------------------------------------------------------
  { pattern: /\bADHD\b/g, replacement: 'A D H D', description: 'Attention Deficit Hyperactivity Disorder' },
