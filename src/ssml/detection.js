 ...
 */
import { CONTRASTIVE_PATTERNS, DISFLUENCY_PATTERNS, EMOTION_KEYWORDS, EMPHASIS_KEYWORDS, FAST_PACE_KEYWORDS, LAUGHTER_PATTERNS, REPETITION_PATTERNS, SARCASTIC_PATTERNS, SIGH_PATTERNS, SLOW_PACE_KEYWORDS, WHISPER_KEYWORDS, } from './constants.js';
// =============================================================================
// EMOTION DETECTION
// =============================================================================
/**
 ...
 */
export function detectPacing(text) {
    const lowerText = text.toLowerCase();
    let speed = 1.0;
    let reason = 'normal';
 ...
 */
export function detectVolume(text) {
    const lowerText = text.toLowerCase();
    let volume = 1.0;
 ...
 */
export function detectVocalCues(text) {
