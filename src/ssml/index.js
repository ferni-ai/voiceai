...
// =============================================================================
export { hasSsmlTags, sanitizeSsml, stripSsmlTags, 
// Alias for backwards compatibility
tagTextWithSsmlPersonaAware as tagTextWithSsml, tagTextWithSsmlPersonaAware, } from './core.js';
// =============================================================================
...
analyzeSsmlNative, batchAnalyzeSsmlNative, containsSsmlNative, stripSsmlNative, 
// Tag extraction
extractBreaksNative, extractEmotionsNative, extractSpeedsNative, 
// Tag insertion
insertBreakNative, insertEmotionNative, wrapWithSpeedNative, 
// Native availability check
getNativeSsmlInfo, getNativeSsmlLoadError, isNativeSsmlAvailable, 
// Metrics
getSsmlMetrics, logSsmlStatus, resetSsmlMetrics, } from './native-ssml-processor.js';
