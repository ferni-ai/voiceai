...
export { SLOW_PACE_KEYWORDS, FAST_PACE_KEYWORDS, EMPHASIS_KEYWORDS, WHISPER_KEYWORDS, DEFAULT_SPEED, SPEED_ADJUSTMENTS, DEFAULT_VOLUME, VOLUME_ADJUSTMENTS, } from './constants/index.js';
export { LAUGHTER_PATTERNS, SIGH_PATTERNS, DISFLUENCY_PATTERNS, REPETITION_PATTERNS, SARCASTIC_PATTERNS, THINKING_PATTERNS, REFLECTION_PHRASES, CONTEMPLATIVE_PATTERNS, TRANSITION_PATTERNS, BREATH_POINT_PATTERNS, CONTRASTIVE_PATTERNS, PARENTHETICAL_PATTERNS, LIST_PATTERNS, ACRONYM_PATTERNS, NUMBER_PATTERNS, } from './constants/index.js';
export { STAGE_DIRECTION_KEYWORDS, STAGE_DIRECTION_PATTERNS, LAUGHTER_CONVERSION_KEYWORDS, UNSUPPORTED_NONVERBALS, } from './constants/index.js';
export { PERSONA_PRONUNCIATIONS, MENTAL_HEALTH_PRONUNCIATIONS, WELLNESS_PRONUNCIATIONS, CALENDAR_PRONUNCIATIONS, COMMON_ABBREVIATIONS, TECH_PRONUNCIATIONS, GEOGRAPHIC_PRONUNCIATIONS, NATIVE_AMERICAN_PRONUNCIATIONS, JAPANESE_PRONUNCIATIONS, ZEN_BUDDHIST_PRONUNCIATIONS, MINDFULNESS_PRONUNCIATIONS, THOUGHT_LEADER_PRONUNCIATIONS, MISPRONOUNCED_WORDS, } from './constants/index.js';
import { ALL_PRONUNCIATIONS, FINANCIAL_PRONUNCIATIONS as FINANCIAL_ONLY_PRONUNCIATIONS } from './constants/index.js';
/**
 ...
 */
export declare const FINANCIAL_PRONUNCIATIONS: import("./constants/types.js").PronunciationEntry[];
/**
 * Combined pronunciation dictionary (all categories)
