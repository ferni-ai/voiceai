 ...
 */
export { clampSpeed, clampVolume, speedTag, volumeTag, breakTag, emotionTag, spellTag, mapToCartesiaEmotion, getContextualEmotion, detectEmotionFromKeywords, } from './tags.js';
export { CARTESIA_EMOTIONS, CARTESIA_SUPPORTED_EMOTIONS, ALL_CARTESIA_EMOTIONS, isCartesiaSupportedEmotion, type CartesiaEmotion, } from './types.js';
