...
//!
//! Deserialized from the HuggingFace config.json. Only includes fields
//! needed for TTS generation (text encoder + DualFFN + audio decoder head).
...
pub struct HiggsAudioConfig {
    ...
    #[serde(default)]
    pub use_audio_out_self_attention: usize,
...
impl TextConfig {
    /// Dimension of each attention head's key/value.
