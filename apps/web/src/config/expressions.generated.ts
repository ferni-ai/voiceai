 ...
 * Generated: 2026-01-25T08:30:23.576Z
 *
...
export const EXPRESSIONS: Record<ExpressionId, ExpressionConfig> = {
  'neutral': {
    ...
    presenceRing: { opacity: 0.2, strokeWidth: 1, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  'listening': {
    family: 'core',
    body: { transform: 'translateY(-1px)' },
    eyeWhite: { scaleY: 1.05, scaleX: 1.02 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 8 },
  ...
  'speaking': {
    family: 'core',
    body: { transform: 'none' },
    eyeWhite: { scaleY: 0.98, scaleX: 1.01 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 10 },
    lidBottom: { curve: 'voice-reactive' },
  ...
  'silly': {
    ...
    eyeWhite: { scaleY: 0.95, scaleX: 1.08 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 8 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0.9, strokeWidth: 1 },
    presenceRing: { opacity: 0.3, strokeWidth: 1.5, scale: 1 },
  ...
  'winking': {
    ...
    lidTop: { curve: 20 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0.8, strokeWidth: 1.3 },
    presenceRing: { opacity: 0.3, strokeWidth: 1.5, scale: 1 },
    animation: 'winkPop',
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  ...
  'teasing': {
    ...
    eyeWhite: { scaleY: 0.88, scaleX: 1.05 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 2, translateY: 0 },
    lidTop: { curve: 18 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0.75, strokeWidth: 1 },
    presenceRing: { opacity: 0.3, strokeWidth: 1.5, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  ...
  'shocked': {
    family: 'surprised',
    body: { transform: 'scaleY(1.05) scaleX(0.97) translateY(-4px)' },
  ...
  'amazed': {
    family: 'surprised',
    body: { transform: 'scale(1.03) translateY(-5px)' },
    eyeWhite: { scaleY: 1.18, scaleX: 1.08 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
  ...
  'intrigued': {
    family: 'surprised',
    body: { transform: 'rotate(2deg) translateY(-2px)' },
    eyeWhite: { scaleY: 1.08, scaleX: 1.04 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 1, translateY: 0 },
    lidTop: { curve: -5 },
  ...
  'astonished': {
    family: 'surprised',
    body: { transform: 'scaleY(1.04) translateY(-3px)' },
    eyeWhite: { scaleY: 1.2, scaleX: 1.06 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: -20 },
  ...
  'curious': {
    ...
    eyeWhite: { scaleY: 1.06, scaleX: 1.05 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
  ...
  'pondering': {
    family: 'thinking',
    body: { transform: 'rotate(-1deg) translateY(-1px)' },
    eyeWhite: { scaleY: 0.92, scaleX: 1.01 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -2, translateY: -2 },
  ...
  'contemplating': {
    family: 'thinking',
    body: { transform: 'scale(0.99) translateY(-1px)' },
    eyeWhite: { scaleY: 0.88, scaleX: 1 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: -3 },
    lidTop: { curve: 20 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
  ...
  'processing': {
    family: 'thinking',
    body: { transform: 'none' },
    eyeWhite: { scaleY: 0.94, scaleX: 1.01 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: -1 },
    lidTop: { curve: 14 },
  ...
  'analyzing': {
    family: 'thinking',
    body: { transform: 'translateY(-1px)' },
    eyeWhite: { scaleY: 0.82, scaleX: 1.03 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 1, translateY: 0 },
    lidTop: { curve: 22 },
  ...
  'attentive': {
    family: 'listening',
    body: { transform: 'translateY(-2px)' },
    eyeWhite: { scaleY: 1.02, scaleX: 1.03 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 6 },
  ...
  'engaged': {
    family: 'listening',
    body: { transform: 'translateY(-2px) scale(1.01)' },
    eyeWhite: { scaleY: 1, scaleX: 1.04 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -1, translateY: 0 },
    lidTop: { curve: 8 },
  ...
  'interested': {
    family: 'listening',
    body: { transform: 'translateY(-1px) rotate(1deg)' },
    eyeWhite: { scaleY: 1.04, scaleX: 1.03 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 4 },
  ...
  'absorbing': {
    family: 'listening',
    body: { transform: 'translateY(-1px)' },
    eyeWhite: { scaleY: 1.06, scaleX: 1.02 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 2 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.35, strokeWidth: 1.6, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  'receptive': {
    ...
    lidTop: { curve: 5 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0.2, strokeWidth: 1 },
    presenceRing: { opacity: 0.3, strokeWidth: 1.5, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  ...
  'grounded': {
    ...
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.45, strokeWidth: 2.2, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  ...
  'peaceful': {
    family: 'presence',
    body: { transform: 'translateY(-1px)' },
    eyeWhite: { scaleY: 0.85, scaleX: 1.01 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 20 },
  ...
  'encouraging': {
    family: 'coaching',
    body: { transform: 'translateY(-3px) scale(1.02)' },
    eyeWhite: { scaleY: 0.9, scaleX: 1.06 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 15 },
  ...
  'guiding': {
    family: 'coaching',
    body: { transform: 'rotate(1deg) translateY(-1px)' },
    eyeWhite: { scaleY: 0.94, scaleX: 1.02 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 2, translateY: 0 },
    lidTop: { curve: 12 },
  ...
  'wise': {
    ...
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0.4, strokeWidth: 1 },
    presenceRing: { opacity: 0.35, strokeWidth: 1.8, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  ...
  'drowsy': {
    family: 'tired',
    body: { transform: 'scaleY(0.98) translateY(1px)' },
    eyeWhite: { scaleY: 0.45, scaleX: 1 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 1 },
    lidTop: { curve: 60 },
    lidBottom: { curve: 35 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.12, strokeWidth: 1.5, scale: 1 },
    animation: 'drowsyBlink',
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  'exhausted': {
    family: 'tired',
    body: { transform: 'scaleY(0.97) translateY(2px) rotate(-1deg)' },
    ...
    lidBottom: { curve: 40 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.1, strokeWidth: 1.5, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  'yawning': {
    ...
    eyeWhite: { scaleY: 0.25, scaleX: 0.95 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 75 },
  ...
  'blissful': {
    family: 'tired',
    body: { transform: 'scale(0.99) translateY(-1px)' },
    eyeWhite: { scaleY: 0.55, scaleX: 1.02 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 50 },
  ...
  'concerned': {
    ...
    eyeWhite: { scaleY: 0.95, scaleX: 1.02 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -1, translateY: 0 },
    lidTop: { curve: 8 },
  ...
  'understanding': {
    family: 'concern',
    body: { transform: 'rotate(-1deg) translateY(-2px)' },
    eyeWhite: { scaleY: 0.92, scaleX: 1.01 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
  ...
  'comforting': {
    family: 'concern',
    body: { transform: 'rotate(-1.5deg) translateY(-2px) scale(1.01)' },
    eyeWhite: { scaleY: 0.88, scaleX: 1.03 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -1, translateY: 0 },
    ...
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0.5, strokeWidth: 1 },
    presenceRing: { opacity: 0.42, strokeWidth: 1.8, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  ...
  'crying': {
    family: 'sad',
    body: { transform: 'translateY(1px) scaleY(0.98)' },
    eyeWhite: { scaleY: 0.6, scaleX: 0.98 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 1 },
    lidTop: { curve: 45 },
  ...
  'melancholy': {
    family: 'sad',
    body: { transform: 'translateY(1px) rotate(-0.5deg)' },
    eyeWhite: { scaleY: 0.88, scaleX: 1 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 2, translateY: 2 },
  ...
  'disappointed': {
    family: 'sad',
    body: { transform: 'translateY(2px) scale(0.98)' },
    eyeWhite: { scaleY: 0.92, scaleX: 1 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 1 },
  ...
  'dejected': {
    family: 'sad',
    body: { transform: 'translateY(3px) scale(0.97) rotate(-2deg)' },
    eyeWhite: { scaleY: 0.85, scaleX: 0.99 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -1, translateY: 3 },
    lidTop: { curve: 22 },
    lidBottom: { curve: 8 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.15, strokeWidth: 1.5, scale: 1 },
  ...
  'annoyed': {
    family: 'frustrated',
    body: { transform: 'rotate(1deg)' },
    eyeWhite: { scaleY: 0.9, scaleX: 1.01 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 1, translateY: 0 },
    lidTop: { curve: 18 },
  ...
  'puzzled': {
    family: 'confused',
    body: { transform: 'rotate(2.5deg) translateY(-1px)' },
    eyeWhite: { scaleY: 0.98, scaleX: 1.02 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 2, translateY: -1 },
    lidTop: { curve: 6 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.26, strokeWidth: 1.5, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  'perplexed': {
    family: 'confused',
    body: { transform: 'rotate(4deg) translateY(-2px)' },
    eyeWhite: { scaleY: 1.02, scaleX: 1.04 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 3, translateY: -1 },
    lidTop: { curve: 4 },
  ...
  'bewildered': {
    family: 'confused',
    body: { transform: 'rotate(5deg) scaleX(0.99)' },
    eyeWhite: { scaleY: 1.08, scaleX: 1.06 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 4, translateY: -2 },
    lidTop: { curve: -2 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.32, strokeWidth: 1.5, scale: 1 },
  ...
  'nervous': {
    ...
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.28, strokeWidth: 1.5, scale: 1 },
    animation: 'nervousLook',
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  'anxious': {
    family: 'nervous',
    body: { transform: 'scaleY(1.01) translateY(-2px)' },
    eyeWhite: { scaleY: 1.06, scaleX: 1.05 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -2, translateY: -1 },
    ...
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.35, strokeWidth: 1.5, scale: 1 },
    animation: 'anxiousDart',
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  'scared': {
    family: 'nervous',
    body: { transform: 'scaleY(1.03) translateY(-3px)' },
    eyeWhite: { scaleY: 1.15, scaleX: 1.08 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
  ...
  'fearful': {
    family: 'nervous',
    body: { transform: 'scaleY(1.04) scaleX(0.98) translateY(-4px)' },
  ...
  'awkward': {
    family: 'embarrassed',
    body: { transform: 'rotate(2deg) translateX(-2px)' },
    eyeWhite: { scaleY: 0.9, scaleX: 1.01 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 2, translateY: 1 },
  ...
  'cringing': {
    family: 'embarrassed',
    body: { transform: 'rotate(-2deg) scaleX(0.98) translateY(-1px)' },
    eyeWhite: { scaleY: 0.7, scaleX: 0.98 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -2, translateY: 1 },
    lidTop: { curve: 35 },
  ...
  'sheepish': {
    family: 'embarrassed',
    body: { transform: 'rotate(-2deg) translateY(-1px)' },
    eyeWhite: { scaleY: 0.92, scaleX: 1.03 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: -2, translateY: 0 },
    lidTop: { curve: 16 },
  ...
  'flustered': {
    family: 'embarrassed',
    body: { transform: 'rotate(1deg) translateY(-2px)' },
    eyeWhite: { scaleY: 0.95, scaleX: 1.04 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 1, translateY: -1 },
    lidTop: { curve: 12 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.32, strokeWidth: 1.5, scale: 1 },
  ...
  'sassy': {
    family: 'cool',
    body: { transform: 'rotate(3deg) translateX(2px)' },
    eyeWhite: { scaleY: 0.85, scaleX: 1.04 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 3, translateY: 0 },
    lidTop: { curve: 22 },
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0.6, strokeWidth: 1 },
    presenceRing: { opacity: 0.3, strokeWidth: 1.5, scale: 1 },
  ...
  'smug': {
    family: 'cool',
    body: { transform: 'rotate(1.5deg) translateY(-2px) scale(1.01)' },
    eyeWhite: { scaleY: 0.85, scaleX: 1.03 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 1, translateY: 0 },
    lidTop: { curve: 22 },
  ...
  'fierce': {
    family: 'intense',
    body: { transform: 'translateY(-3px) scale(1.03)' },
    eyeWhite: { scaleY: 0.88, scaleX: 1.05 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
  ...
  'intense': {
    family: 'intense',
    body: { transform: 'translateY(-2px) scale(1.02)' },
    eyeWhite: { scaleY: 0.9, scaleX: 1.04 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    ...
    lidBottom: { curve: 0 },
    smileCrease: { opacity: 0, strokeWidth: 1 },
    presenceRing: { opacity: 0.55, strokeWidth: 2.2, scale: 1 },
    animation: null,
    sparkle: false,
    ios: { topCutoff: 0, topCurve: 0, bottomCutoff: 0, bottomCurve: 0, asymmetry: 0 },
  },
  ...
  'passionate': {
    family: 'intense',
    body: { transform: 'translateY(-4px) scale(1.03)' },
    eyeWhite: { scaleY: 0.95, scaleX: 1.06 },
    eyeLeftOverride: null,
    eyeRightOverride: null,
    eyesGroup: { translateX: 0, translateY: 0 },
    lidTop: { curve: 10 },
...
export const EXPRESSION_FAMILIES: Record<ExpressionFamily, ExpressionFamilyMeta> = {
  'core': {
    name: 'Core States',
    description: 'Fundamental expressions for conversation: neutral, listening, speaking',
    expressions: ['neutral', 'listening', 'speaking'],
  },
  'happy': {
    name: 'Happy',
    description: 'Joy spectrum from pleased to delighted - warmth, gratitude, excitement',
    expressions: ['happy', 'joyful', 'delighted', 'amused', 'pleased', 'content', 'excited', 'grateful', 'proud'],
  },
  'warmth': {
    name: 'Warmth & Care',
    description: 'Emotional warmth: caring, loving, tender, supportive, compassionate',
    expressions: ['warm', 'caring', 'loving', 'tender', 'supportive', 'compassionate', 'empathetic', 'nurturing'],
  },
  'playful': {
    name: 'Playful',
    description: 'Lighthearted expressions: mischievous, cheeky, silly, winking, teasing',
    expressions: ['playful', 'mischievous', 'cheeky', 'silly', 'winking', 'teasing'],
  },
  'surprised': {
    name: 'Surprised',
    description: 'Discovery and reaction: surprised, shocked, amazed, intrigued, curious',
    expressions: ['surprised', 'shocked', 'amazed', 'intrigued', 'astonished', 'curious'],
  },
  'thinking': {
    name: 'Thinking',
    description: 'Cognitive states: pondering, contemplating, focused, processing, analyzing',
    expressions: ['thinking', 'pondering', 'contemplating', 'focused', 'processing', 'reflecting', 'analyzing'],
  },
  'listening': {
    name: 'Listening',
    description: 'Active engagement: attentive, engaged, interested, absorbing, receptive',
    expressions: ['attentive', 'engaged', 'interested', 'absorbing', 'receptive'],
  },
  'presence': {
    name: 'Presence',
    description: 'Grounded states: present, grounded, calm, serene, peaceful',
    expressions: ['present', 'grounded', 'calm', 'serene', 'peaceful'],
  },
  'coaching': {
    name: 'Coaching',
    description: 'Supportive guidance: encouraging, cheering, guiding, wise, knowing',
    expressions: ['encouraging', 'cheering', 'guiding', 'wise', 'knowing'],
  },
  'tired': {
    name: 'Tired',
    description: 'Fatigue spectrum: sleepy, drowsy, exhausted, yawning, resting, blissful',
    expressions: ['sleepy', 'drowsy', 'exhausted', 'yawning', 'resting', 'blissful'],
  },
  'concern': {
    name: 'Concern',
    description: 'Empathetic worry: concerned, worried, sympathetic, understanding, comforting',
    expressions: ['concerned', 'worried', 'sympathetic', 'understanding', 'comforting'],
  },
  'sad': {
    name: 'Sad',
    description: 'Sadness spectrum: sad, crying, melancholy, disappointed, dejected',
    expressions: ['sad', 'crying', 'melancholy', 'disappointed', 'dejected'],
  },
  'frustrated': {
    name: 'Frustrated',
    description: 'Irritation expressions: frustrated, annoyed, irritated, exasperated, eyeroll',
    expressions: ['frustrated', 'annoyed', 'irritated', 'exasperated', 'eyeroll'],
  },
  'confused': {
    name: 'Confused',
    description: 'Uncertainty: confused, skeptical, puzzled, perplexed, bewildered',
    expressions: ['confused', 'skeptical', 'puzzled', 'perplexed', 'bewildered'],
  },
  'nervous': {
    name: 'Nervous',
    description: 'Anxiety states: nervous, anxious, scared, fearful, uneasy',
    expressions: ['nervous', 'anxious', 'scared', 'fearful', 'uneasy'],
  },
  'embarrassed': {
    name: 'Embarrassed',
    description: 'Self-conscious: embarrassed, awkward, cringing, sheepish, flustered',
    expressions: ['embarrassed', 'awkward', 'cringing', 'sheepish', 'flustered'],
  },
  'cool': {
    name: 'Cool',
    description: 'Confidence expressions: confident, smirking, cool, sassy, smug',
    expressions: ['confident', 'smirking', 'cool', 'sassy', 'smug'],
  },
  'intense': {
    name: 'Intense',
    description: 'Focused determination: determined, fierce, intense, resolute, passionate',
