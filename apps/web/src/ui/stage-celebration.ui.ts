...
// ============================================================================
// RENAMED EXPORTS (for new stage-celebration naming convention)
// ============================================================================

/** @alias initRelationshipProgressUI - new naming convention */
export const initStageCelebration = initRelationshipProgressUI;

/** @alias showCelebration - new naming convention */
export const showStageCelebration = showCelebration;

/** @alias hideProgressPanel - new naming convention */
export const hideStageCelebration = hideProgressPanel;

/** @alias relationshipProgressUI - new naming convention */
export const stageCelebration = relationshipProgressUI;
