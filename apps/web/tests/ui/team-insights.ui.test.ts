...
describe('Team Insights UI', () => {
  ...
  describe('Module exports', () => {
    it('should export initTeamInsightsUI function', async () => {
      const module = await import('../../src/ui/team-insights.ui.js');
    ...
    it('should export teamInsightsUI object with all methods', async () => {
      const { teamInsightsUI } = await import('../../src/ui/team-insights.ui.js');
  ...
  describe('showInsightNotification', () => {
    it('should add insight to state and update badge', async () => {
      const { showInsightNotification, initTeamInsightsUI } = await import('../../src/ui/team-insights.ui.js');
...
describe('TeamInsights accessibility', () => {
  beforeEach(async () => {
    const { initTeamInsightsUI } = await import('../../src/ui/team-insights.ui.js');
    initTeamInsightsUI();
  });

  afterEach(async () => {
    const { disposeTeamInsightsUI } = await import('../../src/ui/team-insights.ui.js');
  ...
  it('should have accessible close button', () => {
    ...
    if (closeBtn) {
      // In test env, i18n returns the key; in prod it returns translated string
      const label = closeBtn.getAttribute('aria-label');
      expect(label === 'Close panel' || label === 'accessibility.closePanel').toBe(true);
    }
  });
  ...
  it('should have accessible refresh button', () => {
    ...
    if (refreshBtn) {
      // In test env, i18n returns the key; in prod it returns translated string
      const label = refreshBtn.getAttribute('aria-label');
      expect(label === 'Refresh insights' || label === 'accessibility.refreshInsights').toBe(true);
    }
  });
});
