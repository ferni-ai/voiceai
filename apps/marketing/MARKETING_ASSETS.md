...
|-------|------|--------|--------|
| **App Icon** | 1024x1024 PNG | ✅ `design-system/assets/icons/png/ios-1024.png` | Done |
...
| Asset | Spec | Status | Action |
|-------|------|--------|--------|
| **App Icon** | 512x512 PNG | ✅ `design-system/assets/icons/png/android-512.png` | Done |
...
| Full logo set | `design-system/assets/logos/` |
