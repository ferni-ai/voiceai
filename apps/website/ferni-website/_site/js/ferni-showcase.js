...
(function() {
  ...
  // ═══════════════════════════════════════════════════════════════════════════════
  // EXPRESSION TRANSFORMS - Direct eye transforms (Luxo Jr. style)
  // Based on brand/characters/ferni/expressions.html
  // ═══════════════════════════════════════════════════════════════════════════════
  
  const expressionTransforms = {
    neutral: {
      avatar: '',
      eyeLeft: 'scaleY(1) scaleX(1)',
      eyeRight: 'scaleY(1) scaleX(1)',
      eyesGroup: '',
      dimpleOpacity: 0
    },
    listening: {
      avatar: 'translateY(-3px)',
      eyeLeft: 'scaleY(1.12)',
      eyeRight: 'scaleY(1.12)',
      eyesGroup: '',
      dimpleOpacity: 0
    },
    curious: {
      // DRAMATIC Luxo tilt - very noticeable!
      avatar: 'rotate(12deg) translateY(-5px)',
      eyeLeft: 'scaleY(1.3)',
      eyeRight: 'scaleY(1.0)',
      eyesGroup: 'translate(4px, -3px)',
      dimpleOpacity: 0
    },
    thinking: {
      // Deep thought - eyes narrow, gaze off to the side
      avatar: 'rotate(8deg)',
      eyeLeft: 'scaleY(0.6) scaleX(0.9)',
      eyeRight: 'scaleY(0.65) scaleX(0.9)',
      eyesGroup: 'translate(8px, -3px)',
      dimpleOpacity: 0
    },
    pondering: {
      // DEEP THOUGHT - really narrow eyes, big tilt
      avatar: 'rotate(10deg) translateY(-4px)',
      eyeLeft: 'scaleY(0.5) scaleX(0.85)',
      eyeRight: 'scaleY(0.55) scaleX(0.88)',
      eyesGroup: 'translate(10px, -4px)',
      dimpleOpacity: 0
    },
    warm: {
      // WARM SQUINT - happy eyes
      avatar: 'translateY(-2px)',
      eyeLeft: 'scaleY(0.55) scaleX(1.15)',
      eyeRight: 'scaleY(0.55) scaleX(1.15)',
      eyesGroup: '',
      dimpleOpacity: 0.8
    },
    attentive: {
      avatar: 'translateY(-4px)',
      eyeLeft: 'scaleY(1.18) scaleX(1.03)',
      eyeRight: 'scaleY(1.18) scaleX(1.03)',
      eyesGroup: '',
      dimpleOpacity: 0
    },
    interested: {
      avatar: 'translateY(-2px)',
      eyeLeft: 'scaleY(1.1) scaleX(1.02)',
      eyeRight: 'scaleY(1.1) scaleX(1.02)',
      eyesGroup: 'translate(0, -1px)',
      dimpleOpacity: 0
    },
    caring: {
      avatar: 'translateY(-2px) rotate(-3deg)',
      eyeLeft: 'scaleY(0.82) scaleX(1.04)',
      eyeRight: 'scaleY(0.85) scaleX(1.04)',
      eyesGroup: '',
      dimpleOpacity: 0.7
    },
    empathetic: {
      avatar: 'rotate(-2deg)',
      eyeLeft: 'scaleY(0.78) scaleX(1.02)',
      eyeRight: 'scaleY(0.8) scaleX(1.02)',
      eyesGroup: 'translate(0, 1px)',
      dimpleOpacity: 0.5
    },
    happy: {
      avatar: 'translateY(-2px)',
      eyeLeft: 'scaleY(0.65) scaleX(1.1)',
      eyeRight: 'scaleY(0.65) scaleX(1.1)',
      eyesGroup: '',
      dimpleOpacity: 0.9
    },
    playful: {
      avatar: 'rotate(4deg) translateY(-3px)',
      eyeLeft: 'scaleY(0.75) scaleX(1.08)',
      eyeRight: 'scaleY(0.9) scaleX(1.04)',
      eyesGroup: 'translate(2px, 0)',
      dimpleOpacity: 0.5
    },
    confident: {
      avatar: 'translateY(-1px)',
      eyeLeft: 'scaleY(0.85) scaleX(1.02)',
      eyeRight: 'scaleY(0.85) scaleX(1.02)',
      eyesGroup: '',
      dimpleOpacity: 0.4
    },
    surprised: {
      avatar: 'scaleY(1.02) scaleX(0.99)',
      eyeLeft: 'scaleY(1.25) scaleX(1.1)',
      eyeRight: 'scaleY(1.25) scaleX(1.1)',
      eyesGroup: '',
      dimpleOpacity: 0
    },
    winking: {
      avatar: 'rotate(3deg) translateY(-2px)',
      eyeLeft: 'scaleY(0.05) scaleX(1.2)',
      eyeRight: 'scaleY(1.08)',
      eyesGroup: '',
      dimpleOpacity: 0.6
    },
    sleepy: {
      avatar: 'scaleY(0.99)',
      eyeLeft: 'scaleY(0.35)',
      eyeRight: 'scaleY(0.35)',
      eyesGroup: 'translate(0, 2px)',
      dimpleOpacity: 0
    }
  };
