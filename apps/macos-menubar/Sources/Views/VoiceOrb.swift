...
struct VoiceOrb: View {
    let persona: Persona
    let isActive: Bool      // Only changes on connect/disconnect - NOT on listening/speaking!
    let size: CGFloat
...
struct StableVoiceOrb: View, Equatable {
    ...
    static func == (lhs: StableVoiceOrb, rhs: StableVoiceOrb) -> Bool {
