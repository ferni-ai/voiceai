 ...
 *
 * Usage:
 *   npx tsx scripts/cli/voice-debug.ts "How are you feeling today?"
 *   npx tsx scripts/cli/voice-debug.ts --interactive
 *   npx tsx scripts/cli/voice-debug.ts --persona maya "Tell me about habits"
 */
