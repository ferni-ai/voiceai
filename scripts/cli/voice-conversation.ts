 ...
 *
 * Usage:
 *   npx tsx scripts/cli/voice-conversation.ts
 *   npx tsx scripts/cli/voice-conversation.ts --persona maya
 *   npx tsx scripts/cli/voice-conversation.ts --debug  # Show pipeline details
 *
 * Controls:
...
${colors.bold}Usage:${colors.reset}
  npx tsx scripts/cli/voice-conversation.ts [options]
...
${colors.bold}Examples:${colors.reset}
  npx tsx scripts/cli/voice-conversation.ts
  npx tsx scripts/cli/voice-conversation.ts --persona maya
  npx tsx scripts/cli/voice-conversation.ts --debug
`);
    return;
  }
